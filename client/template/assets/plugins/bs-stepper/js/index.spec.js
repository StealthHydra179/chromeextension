...
describe('Stepper', () => {
  ...
  describe('constructor', () => {
    it('should create a stepper', () => {
      ...
      expect(document.querySelector('.step').classList.contains('active')).toBe(
        true
      )
      expect(
        document.getElementById('trigger1').getAttribute('aria-selected')
      ).toEqual('true')
      expect(
        document.getElementById('trigger2').getAttribute('aria-selected')
      ).toEqual('false')
    ...
    it('should go to the next step when user click on a step for non linear stepper', () => {
      ...
      expect(
        document.querySelector('#test1').classList.contains('active')
      ).toBe(false)
      expect(
        document.querySelector('#test2').classList.contains('active')
      ).toBe(true)
      expect(
        document.getElementById('trigger1').getAttribute('aria-selected')
      ).toEqual('false')
    ...
    it('should create a stepper with fade animation', (done) => {
      ...
      setTimeout(() => {
        ...
        expect(
          document.querySelector('#test1').classList.contains('fade')
        ).toBe(true)
        expect(
          document.querySelector('#test2').classList.contains('fade')
        ).toBe(true)
        done()
      }, 10)
    })
  ...
  describe('next', () => {
    ...
    it('should keep block class on previous steps for vertical stepper without fade', () => {
      ...
      expect(
        document.querySelector('#test2').classList.contains('dstepper-block')
      ).toBe(true)
    })
  })
