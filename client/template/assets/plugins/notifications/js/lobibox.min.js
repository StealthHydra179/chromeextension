    ...
    (Lobibox.base = {}),
        ...
        (LobiboxProgress.prototype = $.extend({}, LobiboxBase, {
            ...
            _createProgressbar: function () {
                ...
                return (
                    me.$options.showProgressLabel && outer.append('<span class="lobibox-progress-text" data-role="progress-text"></span>'),
                    outer
                );
            },
    ...
    var LobiboxNotify = function (type, options) {
        ...
        var me = this,
            ...
            _findTabToActivate = function ($li) {
                ...
                return (
                    0 === $itemToActivate.length && ($itemToActivate = $li.next()), 0 === $itemToActivate.length ? null : $itemToActivate
                );
            },
            _calculateWidth = function (width) {
