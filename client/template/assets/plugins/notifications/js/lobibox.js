...
(function () {
  ...
  const LobiboxBase = {
    ...
    _createMarkup: function () {
      ...
      const header = $('<div class="lobibox-header"></div>')
  ...
  LobiboxProgress.prototype = $.extend({}, LobiboxBase, {
    ...
    _createProgressbar: function () {
      const me = this
      const outer = $('<div class="lobibox-progress-bar-wrapper lobibox-progress-outer"></div>')
...
(function () {
  const LobiboxNotify = function (type, options) {
    ...
    const _createNotifyWrapper = function () {
      const selector = (me.$options.size === 'large' ? '.lobibox-notify-wrapper-large' : '.lobibox-notify-wrapper') +
