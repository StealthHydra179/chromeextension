    ...
    function (a, h) {
      ...
      return {
        ...
        scrollToPoint: function (e) {
          ...
          if (
            (d = null === f || void 0 === f ? void 0 : f.scrollbar) &&
            g(d.to) &&
            g(d.from)
          ) {
            b = d.to - d.from;
            if (g(f.dataMin) && g(f.dataMax)) {
              ...
              e =
                (f.toPixels(e["xAxis" === f.coll ? "x" : "y"] || 0) - c) /
                (w - c);
            } else e = 0;
    ...
    function (a, h, q, n, p, l, g) {
      ...
      n(f.prototype, {
        ...
        onHandlerTerminate: function () {
          ...
          null === (c = null === d || void 0 === d ? void 0 : d.onMouseOut) ||
          void 0 === c
            ? void 0
            : c.call(d);
    ...
    function (a) {
      function m(a) {
        return (a.annotations || []).reduce(function (a, e) {
          var d;
          !1 !==
            (null === (d = e.options) || void 0 === d ? void 0 : d.visible) &&
            (a = a.concat(e.labels));
          return a;
        }, []);
      }
      function q(a) {
        ...
        return f
          ...
          : (null ===
              (b =
                null === (d = a.graphic) || void 0 === d ? void 0 : d.text) ||
            void 0 === b
              ? void 0
              : b.textStr) || "";
      }
        ...
        d = a.points
          ...
          .map(function (b) {
            ...
            if (
              !(a =
                null ===
                  (c = null === b || void 0 === b ? void 0 : b.accessibility) ||
                void 0 === c
                  ? void 0
                  : c.valueDescription)
            ) {
              ...
              a =
                (null ===
                  (f =
                    null ===
                      (d = null === b || void 0 === b ? void 0 : b.graphic) ||
                    void 0 === d
                      ? void 0
                      : d.element) || void 0 === f
                  ? void 0
      ...
      e(h.prototype, {
        ...
        defaultBeforeChartFormatter: function () {
          var b,
            ...
            l =
              c.sonify &&
              (null === (b = c.options.sonification) || void 0 === b
                ? void 0
                : b.enabled);
          ...
          if ((g = g[e[0]]))
            for (
              h = isNaN(h) ? g.length : h,
                h = 0 > h ? g.length + h : Math.min(h, g.length),
                e = 0;
              e < h;
              ++e
            )
