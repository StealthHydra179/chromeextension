...
(function (d) {
  typeof module === 'object' && module.exports
    ...
    : typeof define === 'function' && define.amd
      ...
      : d(typeof Highcharts !== 'undefined' ? Highcharts : void 0)
})(function (d) {
  function C (d, a, g, h) {
  ...
  C(
    d,
    'Extensions/Pane.js',
    [d['Core/Chart/Chart.js'], d['Core/Globals.js'], d['Core/Pointer.js'], d['Core/Utilities.js'], d['Mixins/CenteredSeries.js']],
    function (d, a, g, h, b) {
      function r (m, l, e) {
          ...
          if (e) {
            for (e = l(e), m = Math.max(e.length, this.background.length || 0), a = 0; a < m; a++) {
              e[a] && this.axis
                ...
                : this.background[a] && ((this.background[a] = this.background[a].destroy()), this.background.splice(a, 1))
            }
          }
        }
        m.prototype.renderBackground = function (m, l) {
          let e = 'animate'
          const a = { class: 'highcharts-pane ' + (m.className || '') }
      ...
      a.Chart.prototype.getHoverPane = function (m) {
        ...
        m &&
                    l.pane.forEach(function (e) {
                      const b = m.chartX - l.plotLeft
                      const k = m.chartY - l.plotTop
  ...
  C(
    ...
    function (d, a, g, h) {
      const b = h.addEvent
      const r = h.correctFloat
      const t = h.defined
      const x = h.extend
      const B = h.fireEvent
      const z = h.merge
      const l = h.pick
      const m = h.relativeLength
      const v = h.wrap
      h = (function () {
        function a () {}
        a.init = function (a) {
          ...
          a.getLinePath = function (k, p, c) {
            k = this.pane.center
            const f = this.chart
            let n = l(p, k[2] / 2 - this.offset)
            typeof c === 'undefined' && (c = this.horiz ? 0 : this.center && -this.center[3] / 2)
            c && (n += c)
            this.isCircular || typeof p !== 'undefined'
          ...
          a.beforeSetTickPositions = function () {
            this.autoConnect =
                            this.isCircular &&
                            typeof l(this.userMax, this.options.max) === 'undefined' &&
          ...
          a.setAxisSize = function () {
            ...
            if (this.isRadial) {
              ...
              const k = (this.center = x([], this.pane.center))
              if (this.isCircular) this.sector = this.endAngleRad - this.startAngleRad
              else {
                const p = this.postTranslate(this.angleRad, k[3] / 2)
          ...
          a.getPosition = function (k, p) {
            ...
            return this.postTranslate(
              ...
              l(this.isCircular ? p : k < 0 ? 0 : k, this.center[2] / 2) - this.offset
            )
          }
          ...
          a.getPlotBandPath = function (k, p, c) {
            ...
            const n = this.center
            let u = this.startAngleRad
            var A = n[2] / 2
            let q = Math.min(this.offset, 0)
            var D = /%$/
            let m = this.isCircular
            let a = l(f(c.outerRadius), A)
            let b = f(c.innerRadius)
            f = l(f(c.thickness), 10)
            if (this.options.gridLineInterpolation === 'polygon') { q = this.getPlotLinePath({ value: k }).concat(this.getPlotLinePath({ value: p, reverse: !0 })) } else {
              k = Math.max(k, this.min)
              p = Math.min(p, this.max)
              k = this.translate(k)
              p = this.translate(p)
              m || ((a = k || 0), (b = p || 0))
              if (c.shape !== 'circle' && m) (c = u + (k || 0)), (u += p || 0)
              else {
                c = -Math.PI / 2
                u = 1.5 * Math.PI
                var e = !0
              ...
              m &&
                                ...
                                (q.yBounds[0] += (m > -Math.PI && m < 0) || m > Math.PI ? -10 : 10))
            }
            return q
          }
          a.getCrosshairPosition = function (k, p, c) {
            let f = k.value
            const n = this.pane.center
            if (this.isCircular) {
              if (t(f)) {
                k.point &&
                                    ((u = k.point.shapeArgs || {}),
          ...
          a.getPlotLinePath = function (k) {
            ...
            let u = k.value
            let A = k.reverse
            let q = p.getPosition(u)
            let D = p.pane.options.background ? p.pane.options.background[0] || p.pane.options.background : {}
            const l = D.innerRadius || '0%'
            const a = D.outerRadius || '100%'
            D = c[0] + f.plotLeft
            let b = c[1] + f.plotTop
            let e = q.x
            let h = q.y
            ...
            if (p.isCircular) {
              ...
              (A = typeof l === 'string' ? m(l, 1) : l / u),
              (f = typeof a === 'string' ? m(a, 1) : a / u),
              c && q && ((u = q / u), A < u && (A = u), f < u && (f = u)),
              (c = [
                ['M', D + A * (e - D), b - A * (b - h)],
                ['L', e - (1 - f) * (e - D), h + (1 - f) * (b - h)]
              ])
            } else if (((u = p.translate(u)) && (u < 0 || u > g) && (u = 0), p.options.gridLineInterpolation === 'circle')) { c = p.getLinePath(0, u, q) } else if (
              ((c = []),
        ...
        a.compose = function (e, h) {
          b(e, 'init', function (k) {
            ...
            if (A === 'colorAxis') this.isRadial = !1
            else {
              if (f) {
                ...
                n &&
                                    ...
                                    (this.defaultPolarOptions = (m = this.horiz)
                                      ...
                                      : z(A === 'xAxis' ? e.defaultOptions : e.defaultYAxisOptions, a.defaultRadialOptions)),
                                    c && A === 'yAxis' && (this.defaultPolarOptions.stackLabels = e.defaultYAxisOptions.stackLabels))
              }
              f || n
                ? ((this.isRadial = !0),
          ...
          b(e, 'destroy', function () {
            if (this.chart && this.chart.labelCollectors) {
              const k = this.labelCollector ? this.chart.labelCollectors.indexOf(this.labelCollector) : -1
              k >= 0 && this.chart.labelCollectors.splice(k, 1)
            }
          })
          ...
          b(h, 'afterGetLabelPosition', function (k) {
            ...
            if (c) {
              const f = c.getBBox()
              const n = p.options.labels
              let u = n.y
              let A = 20
              let q = n.align
              const a = (((p.translate(this.pos) + p.startAngleRad + Math.PI / 2) / Math.PI) * 180) % 360
              ...
              let v = 0
              let r = 0
              const w = n.y === null ? 0.3 * -f.height : 0
              if (p.isRadial) {
                const y = p.getPosition(this.pos, p.center[2] / 2 + m(l(n.distance, -25), p.center[2] / 2, -p.center[2] / 2))
                n.rotation === 'auto'
                  ? c.attr({ rotation: a })
                  : u === null && (u = p.chart.renderer.fontMetrics(c.styles && c.styles.fontSize).b - f.height / 2)
                q === null &&
                                    (p.isCircular
                                      ...
                                      : (q = 'center'),
                                    c.attr({ align: q }))
                if (q === 'auto' && p.tickPositions.length === 2 && p.isCircular) {
                  h > 90 && h < 180 ? (h = 180 - h) : h > 270 && h <= 360 && (h = 540 - h)
                  g > 180 && g <= 360 && (g = 360 - g)
                  if (
                  ...
                  q =
                                        (e >= -90 && e <= 90) || (e >= -360 && e <= -270) || (e >= 270 && e <= 360)
                                          ? b === 'start'
                                            ? 'right'
                                            : 'left'
                                          : b === 'start'
                  ...
                  h < 15 || (h >= 180 && h < 195)
                    ? (v = 0.3 * f.height)
                    : h >= 15 && h <= 35
                      ? (v = b === 'start' ? 0 : 0.75 * f.height)
                      : h >= 195 && h <= 215
                        ? (v = b === 'start' ? 0.75 * f.height : 0)
                        : h > 35 && h <= 90
                          ? (v = b === 'start' ? 0.25 * -f.height : f.height)
                          : h > 215 && h <= 270 && (v = b === 'start' ? f.height : 0.25 * -f.height)
                  g < 15
                    ? (r = b === 'start' ? 0.15 * -f.height : 0.15 * f.height)
                    : g > 165 && g <= 180 && (r = b === 'start' ? 0.15 * f.height : 0.15 * -f.height)
                  c.attr({ align: q })
                  c.translate(r, v + w)
                }
                k.pos.x = y.x + n.x
  ...
  C(d, 'Series/AreaRangeSeries.js', [d['Core/Globals.js'], d['Core/Series/Point.js'], d['Core/Utilities.js']], function (d, a, g) {
    ...
    const x = g.pick
    g = g.seriesType
    const B = d.seriesTypes
    const z = d.Series.prototype
    const l = a.prototype
    g(
      'arearange',
      'area',
      ...
      },
      {
        ...
        highToXY: function (m) {
          const a = this.chart
          const l = this.xAxis.postTranslate(m.rectPlotX, this.yAxis.len - m.plotHigh)
        ...
        getGraphPath: function (a) {
          ...
          let m = []
          let b
          const h = B.area.prototype.getGraphPath
          let k = this.options
          const p = this.chart.polar
          const c = p && !1 !== k.connectEnds
          const f = k.connectNulls
          let n = k.step
          a = a || this.points
          for (b = a.length; b--;) {
            const u = a[b]
            const A = p ? { plotX: u.rectPlotX, plotY: u.yBottom, doCurve: !1 } : { plotX: u.plotX, plotY: u.plotY, doCurve: !1 }
          ...
          k.step = n
          k = [].concat(a, l)
          !this.chart.polar && m[0] && m[0][0] === 'M' && (m[0] = ['L', m[0][1], m[0][2]])
          this.graphPath = k
        ...
        drawDataLabels: function () {
          ...
          let e
          const h = []
          const g = this.options.dataLabels
          let k
          const p = this.chart.inverted
          if (r(g)) {
            if (g.length > 1) {
              var c = g[0]
              var f = g[1]
  ...
  C(d, 'Series/ColumnRangeSeries.js', [d['Core/Globals.js'], d['Core/Options.js'], d['Core/Utilities.js']], function (d, a, g) {
    ...
    g = g.seriesType
    const t = d.noop
    const x = d.seriesTypes.column.prototype
    g(
      'columnrange',
      'arearange',
      ...
      }),
      {
        translate: function () {
          ...
          const b = a.yAxis
          const l = a.xAxis
          const m = l.startAngleRad
          let g
          const e = a.chart
          const d = a.xAxis.isRadial
          const t = Math.max(e.chartWidth, e.chartHeight) + 999
          let k
          x.translate.apply(a)
          a.points.forEach(function (p) {
            const c = p.shapeArgs
            let f = a.options.minPointLength
            p.plotHigh = k = h(b.translate(p.high, 0, 1, 0, 1), -t, t)
            p.plotLow = h(p.plotY, -t, t)
            let n = k
            let u = r(p.rectPlotY, p.plotY) - k
            Math.abs(u) < f ? ((f -= u), (u += f), (n -= f / 2)) : u < 0 && ((u *= -1), (n -= u))
            d
  ...
  C(d, 'Series/ColumnPyramidSeries.js', [d['Core/Globals.js'], d['Core/Utilities.js']], function (d, a) {
    ...
    const h = a.pick
    a = a.seriesType
    const b = d.seriesTypes.column.prototype
    a(
      'columnpyramid',
      'column',
      {},
      {
        translate: function () {
          ...
          const d = a.chart
          const x = a.options
          let B = (a.dense = a.closestPointRange * a.xAxis.transA < 2)
          B = a.borderWidth = h(x.borderWidth, B ? 0 : 1)
          const z = a.yAxis
          const l = x.threshold
          let m = (a.translatedThreshold = z.getThreshold(l))
          const v = h(x.minPointLength, 5)
          const e = a.getColumnMetrics()
          const y = e.width
          let w = (a.barW = Math.max(y, 1 + 2 * B))
          const k = (a.pointXOffset = e.offset)
          d.inverted && (m -= 0.5)
          x.pointPadding && (w = Math.ceil(w))
          b.translate.apply(a)
          a.points.forEach(function (p) {
            let c = h(p.yBottom, m)
            let f = 999 + Math.abs(c)
            let n = g(p.plotY, -f, z.len + f)
            f = p.plotX + k
            const u = w / 2
            const A = Math.min(n, c)
            c = Math.max(n, c) - A
            let q
            p.barX = f
            p.pointWidth = y
            ...
            n = l + (p.total || p.y)
            x.stacking === 'percent' && (n = l + (p.y < 0) ? -100 : 100)
            n = z.toPixels(n, !0)
            let b = (q = d.plotHeight - n - (d.plotHeight - m)) ? (u * (A - n)) / q : 0
            let e = q ? (u * (A + c - n)) / q : 0
            q = f - b + u
            b = f + b + u
            let r = f + e + u
      ...
      },
      {
        ...
        translate: function () {
          ...
          this.points.forEach(function (d) {
            const e = b(l.dial, d.dial)
            const v = (t(r(e.radius, '80%')) * m[2]) / 200
            const w = (t(r(e.baseLength, '70%')) * v) / 100
            const k = (t(r(e.rearLength, '10%')) * v) / 100
            const p = e.baseWidth || 3
            const c = e.topWidth || 1
            let f = l.overshoot
            let n = a.startAngleRad + a.translate(d.y, null, null, null, !0)
  ...
  C(d, 'Series/BoxPlotSeries.js', [d['Core/Globals.js'], d['Core/Utilities.js']], function (d, a) {
    ...
    a(
      ...
      },
      {
        ...
        translate: function () {
          const a = this.yAxis
          const h = this.pointArrayMap
          b.column.prototype.translate.apply(this)
          this.points.forEach(function (b) {
            h.forEach(function (h) {
              b[h] !== null && (b[h + 'Plot'] = a.translate(b[h], 0, 1, 0, 1))
            })
        ...
        drawPoints: function () {
          ...
          let c
          let f
          const n = !1 !== a.doQuartiles
          let u
          const A = a.options.whiskerLength
          a.points.forEach(function (q) {
            let D = q.graphic
            const I = D ? 'animate' : 'attr'
            const r = q.shapeArgs
            const G = {}
            const E = {}
            const F = {}
            const H = {}
            const t = q.color || a.color
            typeof q.plotY !== 'undefined' &&
  ...
  C(
    ...
    function (d, a, g, h, b, r) {
      ...
      const x = r.arrayMax
      const B = r.arrayMin
      const z = r.correctFloat
      const l = r.isNumber
      const m = r.objectEach
      const v = r.pick
      r = r.seriesType
      const e = g.Series
      const y = g.seriesTypes
      let w;
      (function (a) {
        function p () {
          const c = this.waterfall.stacks
          c && ((c.changed = !1), delete c.alreadyChanged)
        }
        function c () {
          const c = this.options.stackLabels
          c && c.enabled && this.waterfall.stacks && this.waterfall.renderStackTotals()
        }
        function f () {
          for (let c = this.axes, f = this.series, n = f.length; n--;) {
        ...
        var u = (function () {
          ...
          c.prototype.renderStackTotals = function () {
            const c = this.axis
            const f = c.waterfall.stacks
            const n = c.stacking && c.stacking.stackTotalGroup
            const a = new b(c, c.options.stackLabels, !1, 0, void 0)
        ...
        },
        {
          ...
          generatePoints: function () {
            ...
            for (a = this.points.length; b < a; b++) {
              const c = this.points[b]
              const f = this.processedYData[b]
          ...
          translate: function () {
            ...
            const b = this.yAxis
            let c
            const f = v(a.minPointLength, 5)
            const n = f / 2
            const u = a.threshold
            const A = a.stacking
            const q = b.waterfall.stacks[this.stackKey]
            ...
            for (a = m.length; h < a; h++) {
              ...
              if (A) {
                if (q) {
                  ...
                  b.reversed ? ((g = t >= 0 ? w - t : w + t), (t = w)) : ((g = w), (t = w - t))
                  e.below = g <= v(u, 0)
              ...
              d.height <= f && !e.isNull
                ? ((d.height = f), (d.y -= n), (e.plotY = d.y), (e.minPointLengthOffset = e.y < 0 ? -n : n))
          ...
          processData: function (a) {
            ...
            for (m = q = A = l = k = 0; m < n; m++) {
              ...
              h === 'sum' || g.isSum
                ? (c[m] = z(q))
                : h === 'intermediateSum' || g.isIntermediateSum
                  ? ((c[m] = z(A)), (A = 0))
                  : ((q += h), (A += h))
              l = Math.min(q, l)
              k = Math.max(q, k)
          ...
          updateParallelArrays: function (a, b) {
            ...
            if (this.yData[0] === 'sum' || this.yData[0] === 'intermediateSum') this.yData[0] = null
          },
          pointAttribs: function (a, b) {
            const c = this.options.upColor
            c && !a.options.color && (a.color = a.y > 0 ? c : null)
          ...
          getCrispPath: function () {
            ...
            const b = this.yAxis
            const c = a.length
            const f = (Math.round(this.graph.strokeWidth()) % 2) / 2
            const n = (Math.round(this.borderWidth) % 2) / 2
            const u = this.xAxis.reversed
            const l = this.yAxis.reversed
            const q = this.options.stacking
            const m = []
            let e
            for (e = 1; e < c; e++) {
              const h = a[e].shapeArgs
              const g = a[e - 1]
              const d = a[e - 1].shapeArgs
              let r = b.waterfall.stacks[this.stackKey]
              let t = g.y > 0 ? -d.height : 0
              r &&
                                d &&
                                h &&
                                ((r = r[e - 1]),
          ...
          setStackedPoints: function () {
            ...
            const b = this.options
            const c = this.yAxis.waterfall.stacks
            const f = b.threshold
            let n = f || 0
            let u = n
            const l = this.stackKey
            const q = this.xData
            const m = q.length
            let e
            let h
            ...
            if (this.visible || !this.chart.options.chart.ignoreHiddenSeries) {
              let r = c.changed;
              (e = c.alreadyChanged) && e.indexOf(l) < 0 && (r = !0)
              c[l] || (c[l] = {})
              e = c[l]
              for (let t = 0; t < m; t++) {
                let w = q[t]
                ...
                var v = e[w]
                const y = this.yData[t]
                y >= 0 ? (v.posTotal += y) : (v.negTotal += y)
                const z = b.data[t]
                w = v.absolutePos = v.posTotal
                const x = (v.absoluteNeg = v.negTotal)
                v.stackTotal = w + x
          ...
          getExtremes: function () {
            const a = this.options.stacking
            if (a) {
              let b = this.yAxis
              b = b.waterfall.stacks
              const c = (this.stackedYNeg = [])
              const f = (this.stackedYPos = [])
              a === 'overlap'
  ...
  C(d, 'Series/PolygonSeries.js', [d['Core/Globals.js'], d['Mixins/LegendSymbol.js'], d['Core/Utilities.js']], function (d, a, g) {
    ...
    g(
      ...
      },
      {
        type: 'polygon',
        getGraphPath: function () {
          for (var a = h.prototype.getGraphPath.call(this), b = a.length + 1; b--;) { (b === a.length || a[b][0] === 'M') && b > 0 && a.splice(b, 0, ['Z']) }
  ...
  C(
    ...
    function (d, a, g, h, b) {
      ...
      const B = b.isNumber
      const z = b.merge
      const l = b.objectEach
      const m = b.pick
      let v = b.setOptions
      const e = b.stableSort
      const y = b.wrap;
      ('')
      const w = g.Series
      const k = g.noop
      ...
      v = (function () {
        ...
        a.prototype.drawLegendSymbol = function (c) {
          ...
          const b = m(c.options.itemDistance, 20)
          let l = a.ranges
          let q = a.connectorDistance
          ...
          l && l.length && B(l[0].value)
            ? (e(l, function (c, f) {
              ...
              (q = q > 0 ? q : 0),
              (this.maxLabel = f),
              (this.movementX = a.labels.align === 'left' ? q : 0),
        ...
        a.prototype.setOptions = function () {
          ...
          const a = this.chart.series[f.seriesIndex]
          const b = this.legend.baseline
          const l = { 'z-index': f.zIndex, 'stroke-width': f.borderWidth }
          const q = { 'z-index': f.zIndex, 'stroke-width': f.connectorWidth }
          const e = this.getLabelStyles()
          const h = a.options.marker.fillOpacity
          const g = this.chart.styledMode
          c.forEach(function (n, u) {
            g ||
                            ((l.stroke = m(n.borderColor, f.borderColor, a.color)),
                            (l.fill = m(n.color, f.color, h !== 1 ? r(a.color).setOpacity(h).get('rgba') : a.color)),
        ...
        a.prototype.getLabelStyles = function () {
          ...
          const f = {}
          const a = c.labels.align === 'left'
          const b = this.legend.options.rtl
          l(c.labels.style, function (c, a) {
            a !== 'color' && a !== 'fontSize' && a !== 'z-index' && (f[a] = c)
          })
          return z(!1, f, {
        ...
        a.prototype.render = function () {
          ...
          const f = this.options.zThreshold
        ...
        a.prototype.renderRange = function (c) {
          ...
          let h = f.connectorDistance || 0
          let g = a.align
          let k = a.style.fontSize
          h = this.legend.options.rtl || g === 'left' ? -h : h
          a = f.connectorWidth
          const d = this.ranges[0].radius || 0
          const p = m - e - f.borderWidth / 2 + a / 2
          k = k / 2 - (this.fontMetrics.h - k) / 2
          const r = b.styledMode
          g === 'center' && ((h = 0), (f.connectorDistance = 0), (c.labelStyle.align = 'center'))
          g = p + f.labels.y
          const t = d + h + f.labels.x
          l.bubbleItems.push(
            b
        ...
        a.prototype.getRanges = function () {
          const c = this.legend.bubbleLegend
          const f = c.options.ranges
          let a
          ...
          const q = b === l ? [{ value: l }] : [{ value: b }, { value: (b + l) / 2 }, { value: l, autoRanges: !0 }]
        ...
        a.prototype.predictBubbleSizes = function () {
          let c = this.chart
          let f = this.fontMetrics
          const a = c.legend.options
          const b = a.layout === 'horizontal'
          const l = b ? c.legend.lastLineHeight : 0
          const q = c.plotSizeX
          const m = c.plotSizeY
          let e = c.series[this.options.seriesIndex]
          c = Math.ceil(e.minPxSize)
          const h = Math.ceil(e.maxPxSize)
          e = e.options.maxSize
          const g = Math.min(m, q)
          if (a.floating || !/%$/.test(e)) f = h
          else if (
            ((e = parseFloat(e)), (f = ((g + l - f.h / 2) * e) / 100 / (e / 100 + 1)), (b && m - f >= q) || (!b && q - f >= m))
          ) { f = h }
          return [c, Math.ceil(f)]
        }
        a.prototype.updateRanges = function (c, a) {
          const f = this.legend.options.bubbleLegend
          f.minSize = c
          f.maxSize = a
        ...
        a.prototype.correctSizes = function () {
          const c = this.legend
          const a = this.chart.series[this.options.seriesIndex]
          Math.abs(Math.ceil(a.maxPxSize) - this.options.maxSize) > 1 &&
      ...
      a(h, 'afterGetAllItems', function (a) {
        ...
        const f = this.options
        const n = f.bubbleLegend
        const b = this.chart.getVisibleBubbleSeriesIndex()
        c && c.ranges && c.ranges.length && (n.ranges.length && (n.autoRanges = !!n.ranges[0].autoRanges), this.destroyItem(c))
        b >= 0 &&
                    f.enabled &&
                    n.enabled &&
                    ((n.seriesIndex = b), (this.bubbleLegend = new g.BubbleLegend(n, this)), this.bubbleLegend.addToLegend(a.allItems))
      })
      d.prototype.getVisibleBubbleSeriesIndex = function () {
        for (let a = this.series, c = 0; c < a.length;) {
      ...
      h.prototype.retranslateItems = function (a) {
        ...
        let f
        let n
        const b = this.options.rtl
        let l = 0
        this.allItems.forEach(function (q, u) {
          c = q.legendGroup.translateX
          f = q._legendItemPos[1]
          if ((n = q.movementX) || (b && q.ranges)) { (n = b ? c - q.options.maxSize / 2 : c + n), q.legendGroup.attr({ translateX: n }) }
          u > a[l].step && l++
      ...
      a(w, 'legendItemClick', function () {
        ...
        f &&
                    ...
                    ((this.visible = !c),
                    (this.ignoreSeries = c),
                    (a = a.getVisibleBubbleSeriesIndex() >= 0),
  ...
  C(
    ...
    function (d, a, g, h) {
      ...
      a(
        ...
        },
        {
          ...
          pointAttribs: function (a, l) {
            const m = this.options.marker.fillOpacity
            a = e.prototype.pointAttribs.call(this, a, l)
            m !== 1 && (a.fill = b(a.fill).setOpacity(m).get('rgba'))
            return a
          },
          ...
          getRadius: function (a, b, l, c, f, n) {
            ...
            const m = e.sizeBy !== 'width'
            const q = e.zThreshold
            let h = b - a
            let g = 0.5
        ...
        {
          haloPath: function (a) {
            return g.prototype.haloPath.call(this, a === 0 ? 0 : (this.marker ? this.marker.radius || 0 : 0) + a)
          },
          ttBelow: !1
        }
      )
      h.prototype.beforePadding = function () {
        ...
        let c = 0
        let f = b
        const n = this.isXAxis
        const u = n ? 'xData' : 'yData'
        const h = this.min
        const q = {}
        const g = Math.min(e.plotWidth, e.plotHeight)
        ...
        F.length &&
                    ...
                    [
                      ...
                      typeof l(a.options[c[0]], a[c[1]]) === 'undefined' && (a[c[0]] += c[2] / B)
                    }))
      };
      ('')
    }
      ...
      a.dragNodesMixin = {
        ...
        onMouseMove: function (a, h) {
          if (a.fixedPosition && a.inDragMode) {
            ...
            let g = a.fixedPosition.chartX - h.chartX
            let d = a.fixedPosition.chartY - h.chartY
    ...
    d.networkgraphIntegrations = {
      verlet: {
        ...
        barycenter: function () {
          ...
          let g = this.barycenter.xFactor
          let h = this.barycenter.yFactor
        ...
        attractive: function (a, g, h) {
          const b = a.getMass()
          const d = -h.x * g * this.diffTemperature
        ...
        integrate: function (a, g) {
          let h = -a.options.friction
          const b = a.options.maxSpeed
          let d = (g.plotX + g.dispX - g.prevX) * h
      ...
      euler: {
        ...
        barycenter: function () {
          const a = this.options.gravitationalConstant
          const g = this.barycenter.xFactor
          const h = this.barycenter.yFactor
        ...
        integrate: function (a, d) {
          ...
          const h = (d.temperature = a.vectorLength({
            x: d.dispX,
            y: d.dispY
          }))
          h !== 0 &&
  ...
  C(d, 'Series/Networkgraph/QuadTree.js', [d['Core/Globals.js'], d['Core/Utilities.js']], function (d, a) {
    a = a.extend
    const g = (d.QuadTreeNode = function (a) {
      this.box = a
    ...
    a(g.prototype, {
          ...
          : ((this.isEmpty = !1),
            this.body
              ? b
                ? ((this.isInternal = !0),
                  this.divideBox(),
                  !0 !== this.body && (this.nodes[this.getBoxPosition(this.body)].insert(this.body, b - 1), (this.body = !0)),
                  this.nodes[this.getBoxPosition(a)].insert(a, b - 1))
                : ((b = new g({
                    top: a.plotX,
                    left: a.plotY,
      ...
      divideBox: function () {
        const a = this.box.width / 2
        const b = this.box.height / 2
        this.nodes[0] = new g({
          left: this.box.left,
          top: this.box.top,
          width: a,
  ...
  C(d, 'Series/Networkgraph/Layouts.js', [d['Core/Chart/Chart.js'], d['Core/Globals.js'], d['Core/Utilities.js']], function (d, a, g) {
    ...
    const r = g.defined
    const t = g.extend
    const x = g.isFunction
    const B = g.pick
    const z = g.setAnimation
    ...
    t(a.layouts['reingold-fruchterman'].prototype, {
      ...
      step: function () {
        ...
        const d = this.series
        b.currentStep++
        b.approximation === 'barnes-hut' && (b.createQuadTree(), b.quadTree.calculateMassAndCenter())
      ...
      setCircularPositions: function () {
        ...
        const b = this.box
        const d = this.nodes
        const e = (2 * Math.PI) / (d.length + 1)
        const g = d.filter(function (a) {
          return a.linksTo.length === 0
        })
        var h = []
        var k = {}
        const p = this.options.initialPositionRadius
      ...
      barnesHutApproximation: function (a, b) {
        const d = this.getDistXY(a, b)
        const e = this.vectorLength(d)
        if (a !== b && e !== 0) {
          if (b.isInternal) {
            if (b.boxSize / e < this.options.theta && e !== 0) {
          ...
          : a.nodes.forEach(function (b) {
            a.nodes.forEach(function (d) {
              if (b !== d && !b.fixedPosition) {
                const e = a.getDistXY(b, d)
                const l = a.vectorLength(e)
                if (l !== 0) {
                  const g = a.repulsiveForce(l, a.k)
      ...
      attractiveForces: function () {
        ...
        a.links.forEach(function (g) {
          g.fromNode &&
                        ...
                        (d = a.vectorLength(b)),
                        d !== 0 && ((e = a.attractiveForce(d, a.k)), a.force('attractive', g, e, b, d)))
        })
      },
  ...
  C(
    ...
    [d['Core/Chart/Chart.js'], d['Core/Color.js'], d['Core/Globals.js'], d['Core/Series/Point.js'], d['Core/Utilities.js']],
    function (d, a, g, h, b) {
      const r = a.parse
      const t = b.addEvent
      const x = b.clamp
      ...
      b = b.seriesType
      const w = g.Series
      const k = g.layouts['reingold-fruchterman']
      const p = g.dragNodesMixin
      ...
      g.networkgraphIntegrations.packedbubble = {
        ...
        barycenter: function () {
          const a = this
          const f = a.options.gravitationalConstant
          const b = a.box
          const d = a.nodes
          let e
          let q
        ...
        repulsive: function (a, f, b, d) {
          const c = (f * this.diffTemperature) / a.mass / a.degree
          f = b.x * c
          b = b.y * c
      ...
      g.layouts.packedbubble = a(k, {
        ...
        setCircularPositions: function () {
          ...
          let e
          let q
          const g = a.options.initialPositionRadius
        ...
        repulsiveForces: function () {
          ...
          let b
          let d
          const e = a.options.bubblePadding
        ...
        applyLimitBox: function (a) {
          if (this.options.splitSeries && !a.isParentNode && this.options.parentNodeLimit) {
            const c = this.getDistXY(a, a.series.parentNode)
            const b = a.series.parentNodeRadius - a.marker.radius - this.vectorLength(c)
            b < 0 && b > -2 * a.marker.radius && ((a.plotX -= 0.01 * c.x), (a.plotY -= 0.01 * c.y))
          }
      ...
      b(
        ...
        },
        {
          ...
          seriesBox: function () {
            ...
            const d = Math.min
            let e
            const g = [a.plotLeft, a.plotLeft + a.plotWidth, a.plotTop, a.plotTop + a.plotHeight]
          ...
          drawGraph: function () {
            if (this.layout && this.layout.options.splitSeries) {
              const a = this.chart
              let b = this.layout.options.parentNodeOptions.marker
              b = {
              ...
              let d = this.visible ? 'inherit' : 'hidden'
          ...
          createParentNodes: function () {
            const a = this
            const b = a.chart
            const d = a.parentNodeLayout
            let e
            let g = a.parentNode
            const q = a.pointClass
            a.parentNodeMass = 0
            a.points.forEach(function (c) {
          ...
          drawTracker: function () {
            ...
            if (a) {
              const b = m(a.dataLabels) ? a.dataLabels : a.dataLabel ? [a.dataLabel] : []
          ...
          addSeriesLayout: function () {
            ...
            const b = this.chart.graphLayoutsStorage
            const d = this.chart.graphLayoutsLookup
            const h = e(a, a.parentNodeOptions, {
              enableSimulation: this.layout.options.enableSimulation
            })
            let l = b[a.type + '-series']
          ...
          addLayout: function () {
            const a = this.options.layoutAlgorithm
            let b = this.chart.graphLayoutsStorage
            let d = this.chart.graphLayoutsLookup
          ...
          translate: function () {
            ...
            const d = this.index
            let e
            const g = this.options.useSimulation
          ...
          checkOverlap: function (a, b) {
            const c = a[0] - b[0]
            const f = a[1] - b[1]
            return Math.sqrt(c * c + f * f) - Math.abs(a[2] + b[2]) < -0.001
          },
          ...
          resizeRadius: function () {
            const a = this.chart
            const b = a.rawPositions
            let d = Math.min
            const e = Math.max
            const g = a.plotLeft
            const h = a.plotTop
            const l = a.plotHeight
            const k = a.plotWidth
            let m
            let p
            let r
            let t = (m = Number.POSITIVE_INFINITY)
            let v = (p = Number.NEGATIVE_INFINITY)
        ...
        },
        {
          ...
          firePointEvent: function (a, b, d) {
            const c = this.series.options
            if (this.isParentNode && c.parentNode) {
              const f = c.allowPointSelect
  ...
  C(
    ...
    function (d, a, g, h, b, r) {
      ...
      p.searchPointByAngle = function (a) {
        const b = this.chart
        const c = this.xAxis.pane.center
      ...
      p.getConnectors = function (a, b, c, d) {
        let f = d ? 1 : 0
        let e = b >= 0 && b <= a.length - 1 ? b : b < 0 ? a.length - 1 + b : 0
        b = e - 1 < 0 ? a.length - (1 + f) : e - 1
        ...
        const m = Math.sqrt(Math.pow(h - f, 2) + Math.pow(k - e, 2))
      ...
      p.toXY = function (a) {
        ...
        const l = a.y
        let k = h ? f : d.len - e
        h && g && !g.isRadialBar && (a.plotY = e = typeof l === 'number' ? d.translate(l) || 0 : 0)
        a.rectPlotX = f
        a.rectPlotY = e
        ...
        this.kdByAngle
          ? ((b = ((f / Math.PI) * 180 + c.pane.options.startAngle) % 360), b < 0 && (b += 360), (a.clientX = b))
          : (a.clientX = a.plotX)
      }
      k.spline &&
        ...
        function () {
          ...
          if (b.polar && this.xAxis) {
            ...
            if (!this.preventPostTranslate) {
              for (let c = this.points, d = c.length; d--;) {
                this.toXY(c[d]),
      ...
      y(p, 'getGraphPath', function (a, b) {
        ...
        if (this.chart.polar) {
          ...
          if (!1 !== this.options.connectEnds && typeof f !== 'undefined') {
            this.connectEnds = !0
            b.splice(b.length, 0, b[f])
            var e = !0
          }
          b.forEach(function (a) {
            typeof a.polarPlotY === 'undefined' && c.toXY(a)
          })
        }
      ...
      const c = function (b, c) {
        const d = this
        const f = this.chart
        let e = this.options.animation
        const g = this.group
        const h = this.markerGroup
        const n = this.xAxis.center
        const l = f.plotLeft
        const k = f.plotTop
        let p
        let r
      ...
      k.column &&
                ...
                (k.polarArc = function (a, b, c, d) {
                  const f = this.xAxis.center
                  const e = this.yAxis.len
                  const g = f[3] / 2
                  b = e - b + g
                  a = e - m(a, e) + g
                  this.yAxis.reversed && (b < 0 && (b = g), a < 0 && (a = g))
                ...
                y(k, 'translate', function (a) {
                  ...
                  const m = f.endAngleRad - k
                  this.preventPostTranslate = !0
                  a.call(this)
                  if (f.isRadial) {
                    a = this.points
                    f = a.length
                    const p = e.translate(e.min)
                    const t = e.translate(e.max)
                    b = b.threshold || 0
                    if (d.inverted && l(b)) {
                      var v = e.translate(b)
                      B(v) && (v < 0 ? (v = 0) : v > m && (v = m), (this.translatedThreshold = v + k))
                    }
                    for (; f--;) {
                      b = a[f]
                      let w = b.barX
                      ...
                      if (d.inverted) {
                        ...
                        if (c && e.stacking) {
                          if (
                            ((y = e.stacking.stacks[(y < 0 ? '-' : '') + this.stackKey]),
                ...
                (k.findAlignments = function (a, b) {
                  b.align === null && (b.align = a > 20 && a < 160 ? 'left' : a > 200 && a < 340 ? 'right' : 'center')
                  b.verticalAlign === null && (b.verticalAlign = a < 45 || a > 315 ? 'bottom' : a > 135 && a < 225 ? 'top' : 'middle')
                  return b
                }),
                w && (w.findAlignments = k.findAlignments),
                y(k, 'alignDataLabel', function (a, b, c, d, e, g) {
                  const f = this.chart
                  const h = m(d.inside, !!this.options.stacking)
                  f.polar
      ...
      y(h, 'getCoordinates', function (a, b) {
        ...
        c.polar
          ? c.axes.forEach(function (a) {
            ...
            let f = a.center
            if (a.coll !== 'colorAxis') {
              const g = b.chartX - f[0] - c.plotLeft
      ...
      b.prototype.clipCircle = function (a, b, c, d) {
        const f = e()
        const g = this.createElement('clipPath').attr({ id: f }).add(this.defs)
