...
(function (d) {
  ...
  C(
    ...
    function (d, a, g, h, b) {
      function r (m, l, e) {
        return (
          Math.sqrt(Math.pow(m - e[0], 2) + Math.pow(l - e[1], 2)) <= e[2] / 2
        )
      }
      const t = h.addEvent
      const x = h.extend
      ...
      h = (function () {
        ...
        m.prototype.render = function () {
          ...
          if (e) {
            for (
              e = l(e),
              m = Math.max(e.length, this.background.length || 0),
              a = 0;
              a < m;
              a++
            ) {
        ...
        m.prototype.renderBackground = function (m, l) {
          ...
          this.background[l] ||
            ((this.background[l] = this.chart.renderer.path().add(this.group)),
            (e = 'attr'))
          this.background[l][e]({
        ...
        a.init = function (a) {
          ...
          a.getPosition = function (k, p) {
            ...
            return this.postTranslate(
              ...
              l(this.isCircular ? p : k < 0 ? 0 : k, this.center[2] / 2) -
                this.offset
            )
          }
          ...
          a.getCrosshairPosition = function (k, p, c) {
            ...
            if (this.isCircular) {
                ...
                k.point &&
                  ...
                  u.start &&
                    (f = this.chart.inverted
                      ? this.translate(k.point.rectPlotY, !0)
                      : k.point.x))
              } else {
                var u = k.chartX || 0
                var A = k.chartY || 0
                f = this.translate(
                  Math.atan2(A - c, u - p) - this.startAngleRad,
                  !0
                )
              }
              ...
              t(u) &&
                  ...
                  (f = this.translate(
                    Math.min(
                      Math.sqrt(Math.pow(u - p, 2) + Math.pow(A - c, 2)),
                      n[2] / 2
                    ) -
                      n[3] / 2,
                    !0
          ...
          a.getPlotLinePath = function (k) {
            ...
            let D = p.pane.options.background
            ...
            if (p.isCircular) {
              ...
              ((u = p.translate(u)) && (u < 0 || u > g) && (u = 0),
              p.options.gridLineInterpolation === 'circle')
            ) { c = p.getLinePath(0, u, q) } else if (
              ((c = []),
          ...
          a.getTitlePosition = function () {
            ...
            return {
              ...
              y:
                p.plotTop +
                k[1] -
                { high: 0.5, middle: 0.25, low: 0 }[c.align] * k[2] +
                (c.y || 0)
            }
          }
          a.createLabelCollector = function () {
        ...
        a.compose = function (e, h) {
            ...
            if (A === 'colorAxis') this.isRadial = !1
              ...
              f || n
                ? ((this.isRadial = !0),
                  ...
                  this.labelCollector &&
                    p.labelCollectors.push(this.labelCollector))
                : (this.isRadial = !1)
              k && m && (k.axis = this)
              this.isCircular = m
            }
          ...
          b(e, 'afterInit', function () {
            ...
            (k.angular && this.isXAxis) ||
              ...
              (this.endAngleRad =
                ((l(f.endAngle, f.startAngle + 360) - 90) * Math.PI) / 180),
          ...
          b(h, 'afterGetLabelPosition', function (k) {
            ...
            if (c) {
              ...
              let q = n.align
              const a =
                  (((p.translate(this.pos) + p.startAngleRad + Math.PI / 2) /
                    Math.PI) *
                    180) %
                  360
              ...
              if (p.isRadial) {
                const y = p.getPosition(
                  this.pos,
                  p.center[2] / 2 +
                    m(l(n.distance, -25), p.center[2] / 2, -p.center[2] / 2)
                )
                n.rotation === 'auto'
                  ? c.attr({ rotation: a })
                  : u === null &&
                ...
                q === null &&
                  (p.isCircular
                    ? (f.width > (p.len * p.tickInterval) / (p.max - p.min) &&
                        (A = 0),
                      (q =
                        a > A && a < 180 - A
                          ? 'left'
                    ...
                    : h >= 15 && h <= 35
                      ...
                      : h >= 195 && h <= 215
                        ...
                        : h > 35 && h <= 90
                          ...
                          : h > 215 &&
                      h <= 270 &&
                      (v = b === 'start' ? f.height : 0.25 * -f.height)
                  g < 15
    ...
    function (d, a, g) {
      ...
      g(
        ...
        },
        {
          ...
          highToXY: function (m) {
            const a = this.chart
            const l = this.xAxis.postTranslate(
              m.rectPlotX,
              ...
              d
                ...
                : ((c.height = u),
                  ...
                  (p.tooltipPos = e.inverted
                    ...
                    : [
                        l.left - e.plotLeft + c.x + c.width / 2,
        ...
        {},
        {
          translate: function () {
            ...
            a.points.forEach(function (p) {
              ...
              n = z.toPixels(n, !0)
              let b = (q = d.plotHeight - n - (d.plotHeight - m))
                ? (u * (A - n)) / q
                : 0
              let e = q ? (u * (A + c - n)) / q : 0
              q = f - b + u
          ...
          translate: function () {
            ...
            this.points.forEach(function (b) {
              h.forEach(function (h) {
                b[h] !== null &&
                  (b[h + 'Plot'] = a.translate(b[h], 0, 1, 0, 1))
              })
            ...
            a.points.forEach(function (q) {
              ...
              typeof q.plotY !== 'undefined' &&
                ...
                h.styledMode ||
                  ...
                  (E.dashstyle =
                    q.stemDashStyle || b.stemDashStyle || b.dashStyle),
                  q.stem.attr(E),
                  A &&
                    ...
                    (F.dashstyle =
                      q.whiskerDashStyle || b.whiskerDashStyle || b.dashStyle),
                    q.whiskers.attr(F)),
                  n &&
                    ...
                    (G.dashstyle =
                      q.boxDashStyle || b.boxDashStyle || b.dashStyle),
                    q.box.attr(G)),
                  ...
                  (H.dashstyle =
                    q.medianDashStyle || b.medianDashStyle || b.dashStyle),
            ...
            for (a = m.length; h < a; h++) {
              ...
              if (A) {
                if (q) {
                  ...
                  e.isSum ||
                    (r.connectorThreshold = r.threshold + r.stackTotal)
                  b.reversed
                    ? ((g = t >= 0 ? w - t : w + t), (t = w))
                    : ((g = w), (t = w - t))
                  e.below = g <= v(u, 0)
                ...
                e.isSum
                  ? ((d.y = b.translate(r[1], 0, 1, 0, 1)),
                    (d.height =
                        Math.min(b.translate(r[0], 0, 1, 0, 1), b.len) - d.y))
                  : e.isIntermediateSum
                    ? (t >= 0
                        ? ((g = r[1] + c), (t = c))
                        : ((g = c), (t = r[1] + c)),
                      ...
                      (d.y = b.translate(g, 0, 1, 0, 1)),
                      (d.height = Math.abs(
                        d.y - Math.min(b.translate(t, 0, 1, 0, 1), b.len)
                      )),
                      (c += r[1]))
                    : ((d.height =
                        g > 0
              ...
              d.height <= f && !e.isNull
                ? ((d.height = f),
                  (d.y -= n),
                  (e.plotY = d.y),
                  (e.minPointLengthOffset = e.y < 0 ? -n : n))
              ...
              r &&
                ...
                q
                  ? ((r = r.connectorThreshold),
                    (t =
                      Math.round(b.translate(r, 0, 1, 0, 1) + (l ? t : 0)) - f))
    ...
    function (d, a, g) {
      ...
      g(
        ...
        },
        {
          ...
          getGraphPath: function () {
            for (
              var a = h.prototype.getGraphPath.call(this), b = a.length + 1;
              b--;
    ...
    function (d, a, g, h, b) {
      ...
      v = (function () {
          ...
          c.forEach(function (n, u) {
            g ||
              ...
              (l.fill = m(
                n.color,
                f.color,
                h !== 1 ? r(a.color).setOpacity(h).get('rgba') : a.color
              )),
        ...
        a.prototype.renderRange = function (c) {
          ...
          c = b
            ...
            .attr(r ? {} : c.labelStyle)
            .addClass(
              'highcharts-bubble-legend-labels ' + (f.labels.className || '')
            )
            .add(this.legendSymbol)
          q.push(c)
          c.placed = !0
      ...
      a(h, 'afterGetAllItems', function (a) {
        ...
        c &&
          c.ranges &&
          c.ranges.length &&
          (n.ranges.length && (n.autoRanges = !!n.ranges[0].autoRanges),
          this.destroyItem(c))
        b >= 0 &&
          f.enabled &&
          n.enabled &&
      ...
      h.prototype.getLinesHeights = function () {
        ...
        for (n = 0; n < f; n++) {
          if (
            ...
            a[n] === a[f - 1] ||
              (a[n + 1] &&
                a[n]._legendItemPos[1] !== a[n + 1]._legendItemPos[1]))
          ) {
            c.push({ height: 0 })
        ...
        },
        {
          haloPath: function (a) {
            return g.prototype.haloPath.call(
              this,
              a === 0 ? 0 : (this.marker ? this.marker.radius || 0 : 0) + a
            )
          },
          ttBelow: !1
        }
      ...
      h.prototype.beforePadding = function () {
        ...
        F.length &&
          ...
          [
            ...
            typeof l(a.options[c[0]], a[c[1]]) === 'undefined' &&
              (a[c[0]] += c[2] / B)
          }))
      };
      ('')
      ...
      d.networkgraphIntegrations = {
        ...
        euler: {
          ...
          integrate: function (a, d) {
            ...
            h !== 0 &&
              ((d.plotX +=
                (d.dispX / h) * Math.min(Math.abs(d.dispX), a.temperature)),
              (d.plotY +=
                (d.dispY / h) * Math.min(Math.abs(d.dispY), a.temperature)))
          },
          getK: function (a) {
        ...
        setCircularPositions: function () {
          function a (c) {
            c.linksFrom.forEach(function (c) {
              k[c.toNode.id] ||
                ((k[c.toNode.id] = !0), h.push(c.toNode), a(c.toNode))
            })
          }
          const b = this.box
          const d = this.nodes
      ...
      g.networkgraphIntegrations.packedbubble = {
        ...
        barycenter: function () {
          ...
          d.forEach(function (c) {
            ...
            c.fixedPosition ||
              ((c.plotX -=
                ((c.plotX - e) * f) / (c.mass * Math.sqrt(d.length))),
              (c.plotY -=
                ((c.plotY - q) * f) / (c.mass * Math.sqrt(d.length))))
          })
        },
          ...
          a.nodes.forEach(function (c) {
            ...
            a.nodes.forEach(function (n) {
              ...
              c === n ||
                ...
                ((d = a.getDistXY(c, n)),
                (b =
                  a.vectorLength(d) - (c.marker.radius + n.marker.radius + e)),
                b < 0 &&
                  ((c.degree += 0.01),
                  c.neighbours++,
                  (f = a.repulsiveForce(
              ...
              g &&
                ...
                g.nodes.forEach(function (f) {
                  a &&
                    ...
                    c < 0 &&
                      (f.series.addPoint(
                        e(a.options, { plotX: a.plotX, plotY: a.plotY }),
                        !1
                      ),
    ...
    function (d, a, g, h, b, r) {
      ...
      p.toXY = function (a) {
        ...
        h &&
          g &&
          !g.isRadialBar &&
          (a.plotY = e = typeof l === 'number' ? d.translate(l) || 0 : 0)
        a.rectPlotX = f
        a.rectPlotY = e
                ...
                t(this, 'afterRender', function () {
                  if (b.polar) {
                    ...
                    this.clipCircle
                      ...
                      : (this.clipCircle = b.renderer.clipCircle(
                          c[0],
                          c[1],
                          c[2] / 2,
                          c[3] / 2
            ...
            for (; f--;) {
              ...
              if (d.inverted) {
                ...
                if (c && e.stacking) {
                  if (
                    ((y =
                      e.stacking.stacks[(y < 0 ? '-' : '') + this.stackKey]),
                ...
                b.plotY =
                  (B(this.translatedThreshold) &&
                    (C < this.translatedThreshold ? C : x)) - k
              } else {
                (C = w + k),
