        ...
        a = (function () {
            ...
            a.prototype.optionsToObject = function (f) {
                ...
                if (L(f) || null === f) m[k[0]] = f;
                    ...
                    for (
                        !l && f.length > g && ((h = typeof f[0]), "string" === h ? (m.name = f[0]) : "number" === h && (m.x = f[0]), d++);
                        p < g;
                ...
                a[m + "Stacker"] &&
                    [f, "-" + f].forEach(function (h) {
                        for (var f = q.length, k, g; f--; )
                            if (((k = q[f]), (v = a.getStackIndicator(v, k, a.index, h)), (g = (k = n[h] && n[h][k]) && k.points[v.key])))
                                a[m + "Stacker"](g, k, f);
                    });
            };
            ...
            q(y.prototype, {
                ...
                setState: function (a, f) {
                    ...
                    if (
                        ...
                        if (k && !k.dashstyle)
                            for (m = { "stroke-width": n }, k.animate(m, e); d["zone-graph-" + g]; ) d["zone-graph-" + g].attr(m), (g += 1);
                        l ||
