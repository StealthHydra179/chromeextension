    ...
    (i.prototype = {
      ...
      toggleTime: function (t, i) {
        ...
        if (i) {
          ...
          s.hour(this.convertHours(t)).minute(0).second(0),
            (a = !(
              this.isAfterMinDate(s, !0, !1) === !1 ||
              this.isBeforeMaxDate(s, !0, !1) === !1
            ));
        } else {
          var s = e(this.currentDate);
          s.minute(t).second(0),
            (a = !(
              this.isAfterMinDate(s, !0, !0) === !1 ||
              this.isBeforeMaxDate(s, !0, !0) === !1
            ));
        }
        return a;
      },
      ...
      _onSelectHour: function (e) {
        if (!t(e.target).hasClass("disabled")) {
          ...
          for (
            var r = a.find(".dtp-select-hour-text"), n = 0;
            n < r.length;
            n++
          )
            t(r[n]).attr("fill", "#000");
      ...
      _onSelectMinute: function (e) {
        if (!t(e.target).hasClass("disabled")) {
          for (
            ...
            t(s[n]).attr("fill", "transparent");
          for (
            var r = a.find(".dtp-select-minute-text"), n = 0;
            n < r.length;
            n++
          )
            t(r[n]).attr("fill", "#000");
      ...
      convertHours: function (t) {
        var e = t;
        return (
          this.params.shortTime === !0 && 12 > t && this.isPM() && (e += 12), e
        );
      },
      setDate: function (t) {
