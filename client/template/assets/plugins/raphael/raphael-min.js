  ...
  return (function (t) {
    ...
    function (t, e, r) {
      ...
      (n = (function (t) {
              ...
              for (let m = 0, b = r.length; m < b; m++) {
                ...
                if (_[0] == 'M') (s = u = _[1]), (o = c = _[2])
                  ...
                  if (i) g += w
                    ...
                    for (let k = 0, B = w.length; k < B; k++) { (w[k].segment1 = v), (w[k].segment2 = m), (w[k].bez1 = f), (w[k].bez2 = d) }
                    g = g.concat(w)
                  }
                }
              }
            ...
            if (h) (h.initstatus = a), (h.start = new Date() - h.ms * a)
              ...
              for (const C in l) {
                if (l[A](C) && (pt[A](C) || i.paper.customAttributes[A](C))) {
                  switch (((x[C] = i.attr(C)), x[C] == null && (x[C] = ft[C]), (m[C] = l[C]), pt[C])) {
                    case $:
                      b[C] = (m[C] - x[C]) / v
                      break
                    case 'colour':
                    ...
                    case 'csv':
                      var j = I(l[C])[q](k)
                      var D = I(x[C])[q](k)
                      if (C == 'clip-rect') { for (x[C] = D, b[C] = [], w = D.length; w--;) b[C][w] = (j[w] - x[C][w]) / v }
                      m[C] = j
                      break
                    default:
                      for (
                        j = [][P](l[C]), D = [][P](x[C]), b[C] = [], w = i.paper.customAttributes[C].length;
                        w--;
              ...
              if (
                ...
                Ee.push(_),
                a && !h && !u && ((_.stop = !0), (_.start = new Date() - v * a), Ee.length == 1))
              ) { return Ne() }
              u && (_.start = new Date() - _.ms * a), Ee.length == 1 && Me(Ne)
            }
        ...
        var z = 'apply'
        var P = 'concat'
        const F = 'ontouchstart' in T.win || (T.win.DocumentTouch && T.doc instanceof DocumentTouch)
        const R = ''
        var j = ' '
        var I = String
        var q = 'split'
        const D = 'click dblclick mousedown mousemove mouseout mouseover mouseup touchstart touchmove touchend touchcancel'[q](j)
        const V = {
        ...
        if (
          ((e._g = T),
          (e.type =
                            T.win.SVGAngle || T.doc.implementation.hasFeature('http://www.w3.org/TR/SVG11/feature#BasicStructure', '1.1')
                              ? 'SVG'
                              : 'VML'),
          e.type == 'VML')
        ) {
        ...
        const It = function (t, r, i) {
          if (
            (r == null && e.is(t, 'object') && 'r' in t && 'g' in t && 'b' in t && ((i = t.b), (r = t.g), (t = t.r)),
            r == null && e.is(t, Z))
          ) {
            const n = e.getRGB(t);
            (t = n.r), (r = n.g), (i = n.b)
        ...
        (e.rgb2hsb = function (t, e, r) {
          ...
          return (
            (a = W(t, e, r)),
            (s = a - G(t, e, r)),
            (i = s == 0 ? null : a == t ? (e - r) / s : a == e ? (r - t) / s + 2 : (t - e) / s + 4),
            (i = (((i + 360) % 6) * 60) / 360),
            (n = s == 0 ? 0 : s / a),
        ...
        (e.rgb2hsl = function (t, e, r) {
          ...
          return (
            ...
            (o = G(t, e, r)),
            (l = s - o),
            (i = l == 0 ? null : s == t ? (e - r) / l : s == e ? (r - t) / l + 2 : (t - e) / l + 4),
            (i = (((i + 360) % 6) * 60) / 360),
            (a = (s + o) / 2),
        ...
        (e.getRGB = n(function (t) {
          ...
          return u
            ? (u[2] &&
                                  ((s = ut(u[2].substring(5), 16)), (n = ut(u[2].substring(3, 5), 16)), (i = ut(u[2].substring(1, 3), 16))),
              u[3] &&
              ...
              u[5]
                ? ((h = u[5][q](gt)),
                  ...
                  (s = ht(h[2])),
                  h[2].slice(-1) == '%' && (s *= 2.55),
                  (h[0].slice(-3) == 'deg' || h[0].slice(-1) == '°') && (i /= 360),
            ...
            n.length ||
                                    I(t).replace(yt, function (t, e, r) {
                                      ...
                                      if (
                                        ...
                                        s == 'm' &&
                                                a.length > 2 &&
                                                (n.push([e][P](a.splice(0, 2))), (s = 'l'), (e = e == 'm' ? 'l' : 'L')),
                                        s == 'r')
                                      ) { n.push([e][P](a)) } else for (; a.length >= i[s] && (n.push([e][P](a.splice(0, i[s]))), i[s]););
                                    }),
        ...
        var Vt = function (t) {
          ...
          return (
            ...
            setTimeout(function () {
              for (const r in e) e[A](r) && r != t && (e[r].sleep--, !e[r].sleep && delete e[r])
            }),
            e[t]
          )
        };
        ...
        const Ot = (e.pathBBox = function (t) {
          ...
          for (var i = 0, n = 0, a = [], s = [], o, l = 0, h = t.length; l < h; l++) {
            if (((o = t[l]), o[0] == 'M')) (i = o[1]), (n = o[2]), a.push(i), s.push(n)
            else {
        ...
        const Wt = (e._pathToRelative = function (t) {
          ...
          let o = 0
          let l = 0
          t[0][0] == 'M' && ((n = t[0][1]), (a = t[0][2]), (s = n), (o = a), l++, i.push(['M', n, a]))
        ...
        const Gt = (e._pathToAbsolute = function (t) {
          ...
          let l = 0
          let h = 0
          t[0][0] == 'M' && ((n = +t[0][1]), (a = +t[0][2]), (o = n), (l = a), h++, (i[0] = ['M', n, a]))
          for (
            var u = t.length == 3 && t[0][0] == 'M' && t[1][0].toUpperCase() == 'R' && t[2][0].toUpperCase() == 'Z',
              c,
              f,
              p = h,
              d = t.length;
            ...
            } else if (f[0] == 'R') { (g = [n, a][P](f.slice(1))), i.pop(), (i = i[P](s(g, u))), (c = ['R'][P](f.slice(-2))) } else for (let y = 0, m = f.length; y < m; y++) c[y] = f[y]
            switch (c[0]) {
              case 'Z':
                (n = o), (a = l)
                break
        ...
        const Ut = function (t, e, r, i, a, s, o, l, h, u) {
          ...
          if (u) (S = u[0]), (A = u[1]), (B = u[2]), (C = u[3])
            ...
            const _ = r * r
            const w = i * i
            const k = (s == o ? -1 : 1) * Y.sqrt(H((_ * w - _ * m * m - w * y * y) / (_ * m * m + w * y * y)))
            var B = (k * r * m) / i + (t + l) / 2
            var C = (k * -i * y) / r + (e + h) / 2
            ...
            for (
              var i = Gt(t),
                ...
                l = function (t, e) {
                  if (t[e].length > 7) {
                    t[e].shift()
                    for (let r = t[e]; r.length;) { (u[e] = 'A'), n && (c[e] = 'A'), t.splice(e++, 0, ['C'][P](r.splice(0, 6))) }
        ...
        var se = (e._extractTransform = function (t, r) {
                  ...
                  : v == 's'
                    ? d == 2 || d == 3
                      ...
                      : d == 5 &&
                                              ...
                                              (o *= p[1]),
                                              (l *= p[2]))
                    : v == 'm' && d == 7 && u.add(p[1], p[2], p[3], p[4], p[5], p[6]),
              (h.dirtyT = 1),
              (t.matrix = u)
            }
          }
          ...
          (h.dx = a = u.e),
          (h.dy = s = u.f),
          o == 1 && l == 1 && !n && h.bbox ? ((h.bbox.x += +a), (h.bbox.y += +s)) : (h.dirtyT = 1)
        })
        const oe = function (t) {
          const e = t[0]
        ...
        var le = (e._equaliseTransform = function (t, r) {
          ...
          for (var i = W(t.length, r.length), n = [], a = [], s = 0, o, l, h, u; s < i; s++) {
            if (
              ...
              (u = r[s] || oe(h)),
              h[0] != u[0] ||
                                        (h[0].toLowerCase() == 'r' && (h[2] != u[2] || h[3] != u[3])) ||
                                        (h[0].toLowerCase() == 's' && (h[3] != u[3] || h[4] != u[4])))
            ) { return }
        ...
        (e._getContainer = function (t, r, i, n) {
          let a
          if (((a = n != null || e.is(t, 'object') ? t : T.doc.getElementById(t)), a != null)) {
            return a.tagName
              ? r == null
                ? {
                    container: a,
            ...
            return e.isSimple
              ? ((e.scalex = +e.scalex.toFixed(4)),
                ...
                (e.dx || e.dy ? 't' + [e.dx, e.dy] : R) +
                                              (e.scalex != 1 || e.scaley != 1 ? 's' + [e.scalex, e.scaley, 0, 0] : R) +
              ...
              return T.doc.addEventListener
                ? function (t, e, r, i) {
                  ...
                  if ((t.addEventListener(e, n, !1), F && V[e])) {
                    var a = function (e) {
                      for (
                        var n = pe(e), a = e, s = 0, o = e.targetTouches && e.targetTouches.length;
                        s < o;
                        s++
                      ) {
                ...
                : T.doc.attachEvent
                  ? function (t, e, r, i) {
                    const n = function (t) {
                      t = t || T.win.event
                      const e = T.doc.documentElement.scrollTop || T.doc.body.scrollTop
                      const n = T.doc.documentElement.scrollLeft || T.doc.body.scrollLeft
                      const a = t.clientX + n
                      const s = t.clientY + e
                      return (
        ...
        (ye.removeData = function (t) {
          return t == null ? (wt[this.id] = {}) : wt[this.id] && delete wt[this.id][t], this
        }),
        (ye.getData = function () {
          return r(wt[this.id] || {})
        }),
        ...
        (ye.undrag = function () {
          for (let r = be.length; r--;) { be[r].el == this && (this.unmousedown(be[r].start), be.splice(r, 1), t.unbind('raphael.drag.*.' + this.id)) }
        ...
        const _e = function (t) {
          ...
          const l = e.left + (T.win.pageXOffset || n.scrollLeft || i.scrollLeft) - s
          return { y: o, x: l }
        };
                    ...
                    if (l[A](y)) {
                      switch (pt[y]) {
                        ...
                        case 'transform':
                          ...
                          break
                        case 'csv':
                          if (y == 'clip-rect') { for (d = [], m = 4; m--;) d[m] = +l[y][m] + x * s * h[y][m] }
                          break
                        default:
                          var C = [][P](l[y])
        ...
        return (
          (Pe.attr = function (t, r) {
            if (t && e.is(t, Q) && e.is(t[0], 'object')) for (let i = 0, n = t.length; i < n; i++) this.items[i].attr(t[i])
          ...
          (N.getFont = function (t, r, i, n) {
            if (
              ...
              let a = e.fonts[t]
              if (!a) {
                const s = new RegExp('(^|\\s)' + t.replace(/[^\w\d\s+!~.:_-]/g, R) + '(\\s|$)', 'i')
            ...
            const r = function (t, r, i) {
              ...
              return (
                r.replace(e, function (t, e, r, i, a) {
                  (e = e || i), n && (e in n && (n = n[e]), typeof n === 'function' && a && (n = n()))
                }),
                (n = (n == null || n == i ? t : n) + '')
              )
            }
    ...
    function (t, e, r) {
      ...
      !(function (r) {
        ...
        (eve.on = function (t, e) {
          ...
          for (let r = m(t) ? (m(t[0]) ? t : [t]) : y(t).split(l), i = 0, n = r.length; i < n; i++) {
            !(function (t) {
    ...
    function (t, e, r) {
      ...
      (n = (function (t) {
        if (!t || t.svg) {
              ...
              if (a[e](d)) {
                ...
                switch (((u[d] = g), d)) {
                  ...
                  case 'target':
                    ...
                    d == 'target'
                      ? w.setAttributeNS(p, 'show', g == 'blank' ? 'new' : g)
                  ...
                  case 'clip-rect':
                    ...
                    if (!g) {
                      ...
                      if (E) {
                        const M = t._g.doc.getElementById(E.replace(/(^url\(#|\)$)/g, c))
                  ...
                  case 'cy':
                    ...
                    break
                  case 'r':
                    i.type == 'rect' ? v(l, { rx: g, ry: g }) : l.setAttribute(d, g), (i._.dirty = 1)
                    break
                  case 'src':
                  ...
                  case 'fill':
                    ...
                    var z = t.getRGB(g)
                    if (z.error) {
                      if ((i.type == 'circle' || i.type == 'ellipse' || r(g).charAt() != 'r') && x(i, g)) {
                  ...
                  case 'stroke':
                    ...
                    break
                  case 'gradient':
                    (i.type == 'circle' || i.type == 'ellipse' || r(g).charAt() != 'r') && x(i, g)
                    break
                  case 'opacity':
          ...
          const C = 1.2
          var S = function (i, a) {
            if (i.type == 'text' && (a[e]('text') || a[e]('font') || a[e]('font-size') || a[e]('x') || a[e]('y'))) {
              const s = i.attrs
              const o = i.node
          ...
          const A = function (t) {
            return t.parentNode && t.parentNode.tagName.toLowerCase() === 'a' ? t.parentNode : t
          }
          ...
          (E.remove = function () {
            ...
            if (!this.removed && e.parentNode) {
              ...
              this.removeData()
              for (const i in this) this[i] = typeof this[i] === 'function' ? t._removedFactory(i) : null
              this.removed = !0
            }
          }),
          (E._getBBox = function () {
          ...
          (E.attr = function (r, i) {
            ...
            if (i == null && t.is(r, 'string')) {
              if (r == 'fill' && this.attrs.fill == 'none' && this.attrs.gradient) return this.attrs.gradient
          ...
          (t.prototype.remove = function () {
            ...
            for (const e in this) this[e] = typeof this[e] === 'function' ? t._removedFactory(e) : null
          })
          const M = t.st
          for (const N in E) {
            E[e](N) &&
    ...
    function (t, e, r) {
      ...
      (n = (function (t) {
        if (!t || t.vml) {
          ...
          const y = /-?[^,\s-]+/g
          const m = 'position:absolute;left:0;top:0;width:1px;height:1px;behavior:url(#default#VML)'
          const b = 21600
          ...
          const k = function (e) {
              ...
              var s = r(e).replace(v, function (t, e, r) {
                ...
                return (
                  r.replace(y, function (t) {
                    n && i.length == 2 && ((s += i + g[e == 'm' ? 'l' : 'L']), (i = [])), i.push(a(t * b))
                  }),
                  s + i
                )
              })
            ...
            for (let u = 0, c = o.length; u < c; u++) {
              (l = o[u]), (h = o[u][0].toLowerCase()), h == 'z' && (h = 'x')
          ...
          const A = function (n, l) {
            ...
            const x =
                                        ...
                                        (l.x != f.x ||
                                            ...
                                            l.ry != f.ry ||
                                            l.r != f.r)
            const y = w[n.type] && (f.cx != l.cx || f.cy != l.cy || f.r != l.r || f.rx != l.rx || f.ry != l.ry)
            const m = n
            ...
            if (
              ...
              if (
                ...
                if (q) {
                  ...
                  t.getRGB(l.fill).error &&
                                                    (m.type in { circle: 1, ellipse: 1 } || r(l.fill).charAt() != 'r') &&
                                                    T(m, l.fill, j) &&
              ...
              c.appendChild(j)
              let O = c.getElementsByTagName('stroke') && c.getElementsByTagName('stroke')[0]
              let Y = !1
              !O && (Y = O = N('stroke')),
            ...
            if (m.type == 'text') {
              ...
              for (
                let Q = ['x', 'y', 'text', 'font', 'font-family', 'font-weight', 'font-style', 'font-size'],
                  J = 0,
                  K = Q.length;
                J < K;
                J++
          ...
          (M.transform = function (e) {
            ...
            return a !== null && ((this._.transform = a), t._extractTransform(this, a)), this
          }),
          ...
          (M.attr = function (r, i) {
            ...
            if (i == null && t.is(r, 'string')) {
              if (r == h && this.attrs.fill == 'none' && this.attrs.gradient) return this.attrs.gradient
            ...
            let p
            i != null && ((p = {}), (p[r] = i)), i == null && t.is(r, 'object') && (p = r)
            ...
            if (p) {
              for (d in this.paper.customAttributes) {
                if (
                  ...
                  const g = this.paper.customAttributes[d].apply(this, [].concat(p[d]))
                  this.attrs[d] = p[d]
                  for (const v in g) g[e](v) && (p[v] = g[v])
                }
              }
              p.text && this.type == 'text' && (this.textpath.string = p.text), A(this, p)
            }
            return this
          }),
          (M.toFront = function () {
          ...
          (t._engine.circle = function (t, e, r, i) {
            ...
            const a = n.attrs
            return (
              (n.X = e - i), (n.Y = r - i), (n.W = n.H = 2 * i), (n.type = 'circle'), A(n, { cx: e, cy: r, r: i }), n
            )
          }),
