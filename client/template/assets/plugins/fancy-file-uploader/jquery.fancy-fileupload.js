  ...
  $.fn.FancyFileUpload = function (options) {
    ...
    const AddFile = function (uploads, e, data) {
      ...
      inforow
        ...
        .text(data.ff_info.displayfilesize + (hasimage && settings.edit && !data.ff_info.errors.length ? ' | .' + fileext : ''))
