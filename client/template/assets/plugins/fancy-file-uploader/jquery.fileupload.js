...
(function (factory) {
  ...
  $.widget('blueimp.fileupload', {
    ...
    _initXHRData: function (options) {
      ...
      const paramName = $.type(options.paramName) === 'array' ? options.paramName[0] : options.paramName
    ...
    _addConvenienceMethods: function (e, data) {
      const that = this
      const getPromise = function (args) {
    ...
    _replaceFileInput: function (data) {
      ...
      const restoreFocus = input.is(document.activeElement)
    ...
    _handleFileTreeEntry: function (entry, path) {
      ...
      const successHandler = function (entries) {
    ...
    _getSingleFileInputFiles: function (fileInput) {
      // eslint-disable-next-line no-param-reassign
      fileInput = $(fileInput)
      const entries = fileInput.prop('webkitEntries') || fileInput.prop('entries')
      let files
      let value
