...
(function () {
  let $
  let Morris
  let minutesSpecHelper
  let secondsSpecHelper
  const __slice = [].slice
  ...
  Morris.Area = (function (_super) {
    ...
    Area.prototype.drawSeries = function () {
      ...
      if (this.options.behaveLikeLine) {
        range = (function () {
          _results = []
          for (let _i = 0, _ref = this.options.ykeys.length - 1; _ref >= 0 ? _i <= _ref : _i >= _ref; _ref >= 0 ? _i++ : _i--) {
            _results.push(_i)
          }
          return _results
        }.apply(this))
        ...
        range = (function () {
          _results1 = []
          for (let _j = (_ref1 = this.options.ykeys.length - 1); _ref1 <= 0 ? _j <= 0 : _j >= 0; _ref1 <= 0 ? _j++ : _j--) {
            _results1.push(_j)
          }
          return _results1
        }.apply(this))
