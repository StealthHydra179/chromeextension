                ...
                "static" === this.el.css("position") && this.el.css("position", "relative"),
                    ...
                    this.options.rangeSelect &&
                        ...
                        this.el.bind("mouseup", function (a) {
                            var b;
                            return (
                                (b = c.el.offset()), c.endRange(a.pageX - b.left), c.fire("hovermove", a.pageX - b.left, a.pageY - b.top)
                            );
                        })),
                    this.options.resize &&
        ...
        (b.Donut = (function (c) {
            ...
            return (
                ...
                (d.prototype.select = function (a) {
                    ...
                    return (
                        (d = this.segments[a]), d.select(), (b = this.data[a]), this.setLabels(b.label, this.options.formatter(b.value, b))
                    );
                }),
