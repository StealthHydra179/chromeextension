...
(function (factory) {
  ...
  DatePicker.prototype.validate = function (type, dateObject, options) {
    ...
    let hasEnabledBeforeTarget
    let hasEnabledAfterTarget
    // The min & max limits.
  ...
  DatePicker.prototype.parse = function (type, value, options) {
    ...
    calendar.formats.toArray(options.format).map(function (label) {
      const // Grab the formatting label.
                          ...
                          return [
                            _.group({
                              ...
                              item: function (targetDate) {
                                ...
                                const formattedDate = _.trigger(calendar.formats.toString, calendar, [
                                  settings.format,
                                  targetDate
                                ])
