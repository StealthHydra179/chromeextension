            ...
            return (
                ...
                b.define("select2/selection/allowClear", ["jquery", "../keys", "../utils"], function (a, b, c) {
                    ...
                    return (
                        ...
                        (d.prototype.update = function (b, d) {
                            if (
                                (b.call(this, d), !(this.$selection.find(".select2-selection__placeholder").length > 0 || 0 === d.length))
                            ) {
                ...
                b.define("select2/data/base", ["../utils"], function (a) {
                    ...
                    return (
                        ...
                        (b.prototype.generateResultId = function (b, c) {
                            var d = b.id + "-result-";
                            return (
                                (d += a.generateChars(4)), null != c.id ? (d += "-" + c.id.toString()) : (d += "-" + a.generateChars(4)), d
                            );
                        }),
                        b
                    );
                ...
                b.define("select2/core", ["jquery", "./options", "./utils", "./keys"], function (a, b, c, d) {
                    ...
                    return (
                        ...
                        (e.prototype.render = function () {
                            var b = a(
                                '<span class="select2 select2-container"><span class="selection"></span><span class="dropdown-nav-wrapper" aria-hidden="true"></span></span>',
                            );
                            return (
