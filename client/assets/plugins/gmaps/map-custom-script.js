...
function initMap () {
  ...
  function initMap () {
    const map = new google.maps.Map(document.getElementById('overlay-map'), {
      zoom: 11,
      center: {
        lat: 62.323907,
        lng: -150.109291
    ...
    const bounds = new google.maps.LatLngBounds(new google.maps.LatLng(62.281819, -150.287132), new google.maps.LatLng(62.400471, -150.005608))
