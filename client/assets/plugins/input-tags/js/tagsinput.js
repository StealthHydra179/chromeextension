...
(function ($) {
  ...
  TagsInput.prototype = {
    ...
    add: function (item, dontPushVal, options) {
      ...
      const beforeItemAddEvent = $.Event('beforeItemAdd', {
        item,
        cancel: false,
        options
      })
      ...
      if (this.isInit) {
        self.$element.trigger(
          $.Event('itemAddedOnInit', { item, options })
        )
      } else {
        self.$element.trigger(
          $.Event('itemAdded', { item, options })
        )
      }
    },
    ...
    remove: function (item, dontPushVal, options) {
      ...
      if (item) {
        const beforeItemRemoveEvent = $.Event('beforeItemRemove', {
          item,
          cancel: false,
          options
        })
      ...
      self.$element.trigger(
        $.Event('itemRemoved', { item, options })
      )
    },
