...
.
bs - stepper.vertical.bs - stepper - content.content
:
not(.active
),.
...
.
bs - stepper.bs - stepper - header.step.crossed +
.
line
{
    color:#
...
i, html[data - textdirection = rtl].btn - next
svg, html[data - textdirection = rtl].btn - prev
i, html[data - textdirection = rtl].btn - prev
svg
{
    -webkit - transform
:
