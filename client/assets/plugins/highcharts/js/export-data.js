...
(function (a) {
  ...
  g(a, 'Extensions/DownloadURL.js', [a['Core/Globals.js']], function (a) {
    ...
    const e = d.navigator
    const c = d.document
    const g = d.URL || d.webkitURL || d
    const u = /Edge\/\d+/.test(e.userAgent)
    const v = (a.dataURLtoBlob = function (f) {
      if (
        ...
        const a = d.atob(f[3])
        let c = new d.ArrayBuffer(a.length)
        c = new d.Uint8Array(c)
        for (let e = 0; e < c.length; ++e) c[e] = a.charCodeAt(e)
        f = new d.Blob([c], { type: f[1] })
        return g.createObjectURL(f)
      }
    })
    a = a.downloadURL = function (a, p) {
      const f = c.createElement('a')
      if (typeof a === 'string' || a instanceof String || !e.msSaveOrOpenBlob) {
        a = '' + a
        if (u || a.length > 2e6) if (((a = v(a) || ''), !a)) throw Error('Failed to convert to blob')
        if (typeof f.download !== 'undefined') { (f.href = a), (f.download = p), c.body.appendChild(f), f.click(), c.body.removeChild(f) } else {
          try {
            const g = d.open(a, 'chart')
            if (typeof g === 'undefined' || g === null) throw Error('Failed to open window')
          } catch (E) {
            d.location.href = a
          }
        }
  ...
  g(
    ...
    [a['Core/Axis/Axis.js'], a['Core/Chart/Chart.js'], a['Core/Globals.js'], a['Core/Utilities.js'], a['Extensions/DownloadURL.js']],
    function (a, d, e, c, g) {
      function u (a, d) {
        const b = p.navigator
        const f = b.userAgent.indexOf('WebKit') > -1 && b.userAgent.indexOf('Chrome') < 0
        const c = p.URL || p.webkitURL || p
        try {
          if (b.msSaveOrOpenBlob && p.MSBlobBuilder) {
            const q = new p.MSBlobBuilder()
            q.append(a)
      ...
      const E = c.find
      const D = c.fireEvent
      const K = c.getOptions
      const L = c.isNumber
      const w = c.pick
      c = c.setOptions
      const F = g.downloadURL
      c({
        exporting: {
          csv: {
      ...
      d.prototype.getDataRows = function (b) {
        const d = this.hasParallelCoordinates
        const f = this.time
        const c = (this.options.exporting && this.options.exporting.csv) || {}
        const e = this.xAxis
        const q = {}
        const g = []
        const p = []
        const n = []
        let r
        let t = this.options.lang.exportData
        const A = t.categoryHeader
        const x = t.categoryDatetimeHeader
        const G = function (l, d, f) {
          if (c.columnHeaderFormatter) {
            const h = c.columnHeaderFormatter(l, d, f)
            if (!1 !== h) return h
          }
          return l
            ? l instanceof a
              ...
              : b
                ? {
                    columnTitle: f > 1 ? d : l.name,
                    topLevelColumnTitle: l.name
                  }
                : l.name + (f > 1 ? ' (' + d + ')' : '')
            : A
        }
        const H = function (l, a, b) {
          const d = {}
          const f = {}
          a.forEach(function (a) {
            let c = ((l.keyToAxis && l.keyToAxis[a]) || a) + 'Axis'
        ...
        const y = function (a, b) {
          return a.data.filter(function (a) {
            return typeof a.y !== 'undefined' && a.name
          }).length &&
                            b &&
                            !b.categories &&
                            !a.keyToAxis
        ...
        this.series.forEach(function (a) {
          const x = a.xAxis
          const l = a.options.keys || y(a, x)
          const g = l.length
          const m = !a.requireSorting && {}
          const C = e.indexOf(x)
          let A = H(a, l)
          let k
          if (!1 !== a.options.includeInDataExport && !a.options.isInternal && !1 !== a.visible) {
            ...
            a.options.data.forEach(function (b, h) {
              ...
              b = y.x
              let e = a.data[h] && a.data[h].name
              k = 0
              if (!x || a.exportKey === 'name' || (!d && x && x.hasNames && e)) b = e
              m && (m[b] && (b += '|' + h), (m[b] = !0))
              q[b] || ((q[b] = []), (q[b].xValues = []))
              q[b].x = y.x
              q[b].name = e
      ...
      d.prototype.getCSV = function (a) {
        let b = ''
        const d = this.getDataRows()
        const c = this.options.exporting.csv
        const f = w(c.decimalPoint, c.itemDelimiter !== ',' && a ? (1.1).toLocaleString()[1] : '.')
        const e = w(c.itemDelimiter, f === ',' ? ';' : ',')
        const g = c.lineDelimiter
        d.forEach(function (a, c) {
          for (var k, q = a.length; q--;) {
            (k = a[q]),
            typeof k === 'string' && (k = '"' + k + '"'),
            typeof k === 'number' && f !== '.' && (k = k.toString().replace('.', f)),
            (a[q] = k)
          }
          b += a.join(e)
          c < d.length - 1 && (b += g)
      ...
      d.prototype.getTable = function (a) {
        let b = '<table id="highcharts-data-table-' + this.index + '">'
        const c = this.options
        const d = a ? (1.1).toLocaleString()[1] : '.'
        const f = w(c.exporting.useMultiLevelHeaders, !0)
        a = this.getDataRows(f)
        let e = 0
        const g = f ? a.shift() : null
        const p = a.shift()
        const n = function (a, b, c, f) {
          let e = w(f, '')
          b = 'text' + (b ? ' ' + b : '')
          typeof e === 'number'
        ...
        !1 !== c.exporting.tableCaption &&
                    (b +=
                        ...
                        '</caption>')
        for (let r = 0, t = a.length; r < t; ++r) a[r].length > e && (e = a[r].length)
        b += (function (a, b, d) {
          let e = '<thead>'
          let g = 0
          d = d || (b && b.length)
            ...
            for (e += '<tr>'; g < d; ++g) {
              ...
              h === m
                ...
                : k
                  ...
                  : (h === b[g] ? (c.exporting.useRowspanHeaders ? ((m = 2), delete b[g]) : ((m = 1), (b[g] = ''))) : (m = 1),
                    (e += n(
                      'th',
                      'highcharts-table-topheading',
                      'scope="col"' + (m > 1 ? ' valign="top" rowspan="' + m + '"' : ''),
                      h
                    )))
            }
            e += '</tr>'
          ...
          if (b) {
            e += '<tr>'
            g = 0
            for (d = b.length; g < d; ++g) typeof b[g] !== 'undefined' && (e += n('th', null, 'scope="col"', b[g]))
            e += '</tr>'
          }
          return e + '</thead>'
        ...
        a.forEach(function (a) {
          b += '<tr>'
          for (let c = 0; c < e; c++) b += n(c ? 'td' : 'th', null, c ? '' : 'scope="row"', a[c])
          b += '</tr>'
        })
        b += '</tbody></table>'
        a = { html: b }
      ...
      d.prototype.downloadXLS = function () {
        const a =
                    ...
                    '</body></html>'
        F(
          u(a, 'application/vnd.ms-excel') || 'data:application/vnd.ms-excel;base64,' + p.btoa(unescape(encodeURIComponent(a))),
      ...
      d.prototype.viewData = function () {
        ...
        if (this.dataTableDiv.style.display === '' || this.dataTableDiv.style.display === 'none') { this.dataTableDiv.style.display = 'block' }
        this.isDataTableVisible = !0
        D(this, 'afterViewData', this.dataTableDiv)
      }
      d.prototype.hideData = function () {
        this.dataTableDiv && this.dataTableDiv.style.display === 'block' && (this.dataTableDiv.style.display = 'none')
        this.isDataTableVisible = !1
      }
      d.prototype.toggleDataTable = function () {
        let a
        const c = this.exportDivElements
        const d = (a = n === null || void 0 === n ? void 0 : n.buttons) === null || void 0 === a ? void 0 : a.contextButton.menuItems
        a = this.options.lang
        this.isDataTableVisible ? this.hideData() : this.viewData();
        (n === null || void 0 === n ? 0 : n.menuItemDefinitions) &&
                    (a === null || void 0 === a ? 0 : a.viewData) &&
                    a.hideData &&
                    d &&
                    c &&
                    c.length &&
