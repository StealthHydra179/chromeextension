    ...
    function (c, l, h) {
      ...
      h = (function () {
        ...
        c.prototype.setButtonText = function () {
          ...
          const l =
              (e = k === null || void 0 === k ? void 0 : k.buttons) === null ||
              void 0 === e
                ? void 0
      ...
      w(c.prototype, {
        ...
        getSVG: function (a) {
          ...
          this.axes.forEach(function (a) {
            ...
            d = d.userMax
            b &&
              ((typeof f !== 'undefined' && f !== b.min) ||
                (typeof d !== 'undefined' && d !== b.max)) &&
        ...
        contextMenu: function (a, b, f, d, c, h, k) {
          ...
          k.alignOptions.verticalAlign !== 'top'
            ? (b.bottom = A - d - v + 'px')
            : (b.top = d + h - v + 'px')
          u(m, b)
        ...
        addButton: function (a) {
          ...
          if (!1 !== d.enabled) {
            ...
            d.text && d.symbol
              ...
              : d.text ||
                w(g, { width: d.width, height: d.height, padding: 0 })
            b.styledMode ||
            ...
            b.buttonOffset +=
              (r.width + d.buttonSpacing) * (d.align === 'right' ? -1 : 1)
