...
(function (c) {
  typeof module === 'object' && module.exports
    ...
    : typeof define === 'function' && define.amd
      ...
      : c(typeof Highcharts !== 'undefined' ? Highcharts : void 0)
})(function (c) {
  function p (c, l, h, k) {
    ...
    h = (function () {
      ...
      c.prototype.open = function () {
        ...
        if (e.browserProps) {
          ...
          const h = c.renderTo[e.browserProps.requestFullscreen]()
          if (h) {
            h.catch(function () {
      ...
      c.prototype.setButtonText = function () {
        let e
        const c = this.chart
        const h = c.exportDivElements
        const k = c.options.exporting
        const l = (e = k === null || void 0 === k ? void 0 : k.buttons) === null || void 0 === e ? void 0 : e.contextButton.menuItems
        e = c.options.lang;
        (k === null || void 0 === k ? 0 : k.menuItemDefinitions) &&
                    (e === null || void 0 === e ? 0 : e.exitFullscreen) &&
                    e.viewFullscreen &&
                    l &&
                    h &&
                    h.length &&
  ...
  p(
    ...
    function (c, l, h, k, p, e) {
      const x = h.doc
      const H = h.isTouchDevice
      const z = h.win
      k = k.defaultOptions
      const t = e.addEvent
      const u = e.css
      const y = e.createElement
      const D = e.discardElement
      const w = e.extend
      const I = e.find
      const B = e.fireEvent
      const J = e.isObject
      const n = e.merge
      const E = e.objectEach
      const q = e.pick
      const K = e.removeEvent
      const L = e.uniqueKey
      const F = z.navigator.userAgent
      const G = h.Renderer.prototype.symbols
      const M = /Edge\/|Trident\/|MSIE /.test(F)
      const N = /firefox/i.test(F)
      w(k.lang, {
      ...
      h.post = function (a, b, f) {
        const d = y('form', n({ method: 'post', action: a, enctype: 'multipart/form-data' }, f), { display: 'none' }, x.body)
        E(b, function (a, b) {
      ...
      w(c.prototype, {
        ...
        getSVG: function (a) {
          ...
          let c = this.renderTo.style.width
          let e = this.renderTo.style.height
          ...
          const k = new h.Chart(f, this.callback)
          a &&
          ...
          this.axes.forEach(function (a) {
            ...
            d = d.userMax
            b &&
                            ((typeof f !== 'undefined' && f !== b.min) || (typeof d !== 'undefined' && d !== b.max)) &&
        ...
        getSVGForExport: function (a, b) {
          const f = this.options.exporting
          return this.getSVG(
        ...
        beforePrint: function () {
          const a = x.body
          const b = this.options.exporting.printMaxWidth
          const f = {
          ...
          [].forEach.call(f.childNodes, function (a, b) {
            a.nodeType === 1 && ((f.origDisplay[b] = a.style.display), (a.style.display = 'none'))
          })
        ...
        afterPrint: function () {
          if (this.printReverseInfo) {
            const a = this.printReverseInfo.childNodes
            const b = this.printReverseInfo.origDisplay
            const f = this.printReverseInfo.resetParams
            this.moveContainers(this.renderTo);
            [].forEach.call(a, function (a, f) {
              a.nodeType === 1 && (a.style.display = b[f] || '')
            })
            this.isPrinting = !1
        ...
        contextMenu: function (a, b, f, d, c, h, k) {
          const g = this
          const C = g.options.navigation
          const l = g.chartWidth
          const A = g.chartHeight
          const r = 'cache-' + a
          let m = g[r]
          const v = Math.max(c, h)
          if (!m) {
            g.exportContextMenu =
                            g[r] =
                            m =
            ...
            const n = y('ul', { className: 'highcharts-menu' }, { listStyle: 'none', margin: 0, padding: 0 }, m)
            g.styledMode ||
                            u(
                              n,
                              w(
            ...
            b.forEach(function (a) {
              typeof a === 'string' && (a = g.options.exporting.menuItemDefinitions[a])
              if (J(a, !0)) {
          ...
          d + h + g.exportMenuHeight > A && k.alignOptions.verticalAlign !== 'top'
            ? (b.bottom = A - d - v + 'px')
            : (b.top = d + h - v + 'px')
          u(m, b)
        ...
        addButton: function (a) {
          const b = this
          const f = b.renderer
          const d = n(b.options.navigation.buttonOptions, a)
          const c = d.onclick
          const e = d.menuItems
          const h = d.symbolSize || 12
          ...
          if (!1 !== d.enabled) {
            ...
            b.buttonOffset += (r.width + d.buttonSpacing) * (d.align === 'right' ? -1 : 1)
        ...
        destroyExport: function (a) {
          ...
          const f = b.exportDivElements
          const d = b.exportEvents
          let c
          a &&
      ...
      c.prototype.inlineStyles = function () {
        ...
        function b (c) {
          function f (b, f) {
            ...
            f === 'transform' && b === 'none' && (v = !0)
            for (q = e.length; q-- && !v;) v = e[q].test(f) || typeof b === 'function'
            v ||
                            (y[f] === b && c.nodeName !== 'svg') ||
                            g[c.nodeName][f] === b ||
                            (d && d.indexOf(f) === -1 ? (m += a(f) + ':' + b + ';') : b && c.setAttribute(a(f), b))
          }
          var m = ''
          let v
          let u
          let q
          if (c.nodeType === 1 && k.indexOf(c.nodeName) === -1) {
            let t = z.getComputedStyle(c, null)
            var y = c.nodeName === 'svg' ? {} : z.getComputedStyle(c.parentNode, null)
            if (!g[c.nodeName]) {
              l = p.getElementsByTagName('svg')[0]
              const w = p.createElementNS(c.namespaceURI, c.nodeName)
              l.appendChild(w)
              g[c.nodeName] = n(z.getComputedStyle(w, null))
              c.nodeName === 'text' && delete g.text.fill
              l.removeChild(w)
            }
            if (N || M) for (const x in t) f(t[x], x)
            else E(t, f)
            m && ((t = c.getAttribute('style')), c.setAttribute('style', (t ? t + ';' : '') + m))
            c.nodeName === 'svg' && c.setAttribute('stroke-width', '1px')
            c.nodeName !== 'text' && [].forEach.call(c.children || c.childNodes, b)
          }
        }
        let c = this.renderer
        var d = c.inlineToAttributes
        var e = c.inlineBlacklist
        var h = c.inlineWhitelist
        var k = c.unstyledElements
        var g = {}
        let l
      ...
      c.prototype.renderExporting = function () {
        const a = this
        const b = a.options.exporting
        const c = b.buttons
        const d = a.isDirtyExporting || !a.exportSVGElements
        a.buttonOffset = 0
