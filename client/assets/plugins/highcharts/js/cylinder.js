  ...
  g(
    ...
    function (b, g, l, f) {
      ...
      f.getCylinderFront = function (a, c) {
        ...
        if (k(c)) {
          var d = c[0]
          d[0] === 'M' && (a.push(c[2]), a.push(c[1]), a.push(['L', d[1], d[2]]))
        } else {
          d = c[0]
          const e = c[1]
          c = c[2]
      ...
      f.getCylinderBack = function (a, c) {
        ...
        if (k(a)) {
          var e = a[0]
          const b = a[2]
          e[0] === 'M' && b[0] === 'L' && (d.push(['M', b[1], b[2]]), d.push(a[3]), d.push(['L', e[1], e[2]]))
        } else a[2][0] === 'C' && d.push(['M', a[2][5], a[2][6]]), d.push(a[3], a[4])
        k(c)
          ? ((e = c[0]), e[0] === 'M' && (d.push(['L', e[1], e[2]]), d.push(c[3]), d.push(c[2])))
          : ((a = c[2]),
            (e = c[3]),
            (c = c[4]),
            a[0] === 'C' &&
      ...
      f.getCylinderEnd = function (a, c, d) {
        ...
        const f = v * (a.options.chart.options3d.beta - 90 + (c.alphaCorrection || 0))
        d = c.y + (d ? c.height : 0)
        const g = 0.5519 * b
        ...
        a = r(m, a, !0)
        return Math.abs(a[3].y - a[9].y) < 2.5 && Math.abs(a[0].y - a[6].y) < 2.5
