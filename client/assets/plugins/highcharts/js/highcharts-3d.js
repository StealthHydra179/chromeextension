      ...
      m.prototype.polyhedron = function (c) {
        ...
        f.attr = function (c, e, D, E) {
          if (typeof c === 'object' && b(c.faces)) {
            ...
            for (let x = 0; x < c.faces.length; x++) {
        ...
        let z = function (c, t, g) {
          ...
          h(b) < 0
            ...
            : h(y) < 0
              ? (d = [y, 1])
              : g &&
              (q.push(g), (d = h(c) < 0 ? [b, 0] : h(t) < 0 ? [y, 1] : [b, 0]))
          return d
        }
    ...
    function (a, l, u, d, m) {
      ...
      return (function () {
        ...
        a.wrapGetLinePath = function (c) {
          return this.chart.is3d() && this.coll !== 'colorAxis'
            ? []
    ...
    function (a, l, u, d, m, w, k, G) {
      ...
      (function (a) {
        ...
        function v () {
          ...
          if (this.chart3d && this.is3d()) {
            c &&
              ((c.alpha = (c.alpha % 360) + (c.alpha >= 0 ? 0 : 360)),
              (c.beta = (c.beta % 360) + (c.beta >= 0 ? 0 : 360)))
        ...
        c.chart.is3d() &&
          c.data.forEach(function (a) {
            d = (a.visible =
              a.options.visible =
              b =
                typeof b === 'undefined' ? !h(c.visible, a.visible) : b)
              ? 'visible'
              : 'hidden'
      ...
      d(u.prototype, 'getStackBox', function (a, d, c, h, k, e, l, m) {
        ...
        if (d.is3d() && c.base) {
          ...
          g &&
            ...
            d.inverted &&
              ((n.width = 0), q.alpha >= 90 && q.alpha <= 270 && (g.y += e)),
            (g = p([g], d, !0, !1)[0]),
            (n.x = g.x - e / 2),
            (n.y = g.y))
        }
