...
(function (a) {
  ...
  B(a, 'Extensions/Math3D.js', [a['Core/Globals.js'], a['Core/Utilities.js']], function (a, l) {
    const u = l.pick
    const d = a.deg2rad
    const m = (a.perspective3D = function (d, k, h) {
      k = h > 0 && h < Number.POSITIVE_INFINITY ? h / (d.z + k.z + h) : 1
      return { x: d.x * k, y: d.y * k }
    })
    const w = (a.perspective = function (k, a, h, r) {
      let b = a.options.chart.options3d
      const p = u(r, h ? a.inverted : !1)
      const n = {
        x: a.plotWidth / 2,
        y: a.plotHeight / 2,
        z: b.depth / 2,
    ...
    l = a.pointCameraDistance = function (d, k) {
      let h = k.options.chart.options3d
      const a = k.plotWidth / 2
      k = k.plotHeight / 2
    ...
    const k = (a.shapeArea = function (d) {
      let k = 0
      let h
      for (h = 0; h < d.length; h++) {
        const a = (h + 1) % d.length
    ...
    function (a, l, u, d, m, w) {
      function k (c, e, f, d, b, x, D, E) {
        ...
        return x > b && x - b > Math.PI / 2 + 0.0001
          ? ((g = g.concat(k(c, e, f, d, b, b + Math.PI / 2, D, E))), (g = g.concat(k(c, e, f, d, b + Math.PI / 2, x, D, E))))
      ...
      const G = a.parse
      const p = u.perspective
      const h = u.shapeArea
      const r = w.animObject
      const b = w.defined
      const L = w.extend
      const n = w.merge
      const q = w.objectEach
      const c = w.pick
      const A = Math.cos
      const v = Math.PI
      const e = Math.sin
      ...
      m.prototype.face3d = function (g) {
        const e = this
        const f = this.createElement('path')
        f.vertexes = []
        f.insidePlotArea = !1
        f.enabled = !0
        f.attr = function (f) {
          if (typeof f === 'object' && (b(f.enabled) || b(f.vertexes) || b(f.insidePlotArea))) {
            ...
            let g = p(this.vertexes, C[e.chartIndex], this.insidePlotArea)
            const x = e.toLinePath(g, !0)
            g = h(g)
            g = this.enabled && g > 0 ? 'visible' : 'hidden'
            f.d = x
            f.visibility = g
          }
      ...
      m.prototype.polyhedron = function (c) {
        ...
        f.faces = []
        f.destroy = function () {
          for (let c = 0; c < f.faces.length; c++) f.faces[c].destroy()
          return e.call(this)
        }
        f.attr = function (c, e, D, E) {
          if (typeof c === 'object' && b(c.faces)) {
            for (; f.faces.length > c.faces.length;) f.faces.pop().destroy()
            for (; f.faces.length < c.faces.length;) f.faces.push(g.face3d().add(f))
            for (let x = 0; x < c.faces.length; x++) { g.styledMode && delete c.faces[x].fill, f.faces[x].attr(c.faces[x], null, D, E) }
            delete c.faces
          }
          return d.prototype.attr.apply(this, arguments)
        }
        f.animate = function (c, e, b) {
          if (c && c.faces) {
            for (; f.faces.length > c.faces.length;) f.faces.pop().destroy()
            for (; f.faces.length < c.faces.length;) f.faces.push(g.face3d().add(f))
            for (let x = 0; x < c.faces.length; x++) f.faces[x].animate(c.faces[x], e, b)
            delete c.faces
          }
          return d.prototype.animate.apply(this, arguments)
        }
      ...
      var N = n(a, {
        ...
        attr: function (c, e, f, h) {
          if (typeof c === 'string' && typeof e !== 'undefined') {
            const g = c
            c = {}
            c[g] = e
          }
        ...
        fillSetter: function (c) {
          ...
          this.singleSetterForParts('fill', null, {
            ...
            top: G(c)
              ...
              .get(),
            side: G(c)
              .brighten(this.forcedSides.indexOf('side') >= 0 ? 0 : -0.1)
              .get()
          })
      ...
      m.prototype.cuboidPath = function (c) {
        ...
        let E = c.width
        var v = c.depth
        const t = C[this.chartIndex]
        const y = t.options.chart.options3d.alpha
        let A = 0
        var a = [
          { x: g, y: d, z: b },
          { x: g + E, y: d, z: b },
        ...
        let z = function (c, t, g) {
          ...
          h(b) < 0
            ...
            : h(y) < 0
              ? (d = [y, 1])
              : g && (q.push(g), (d = h(c) < 0 ? [b, 0] : h(t) < 0 ? [y, 1] : [b, 0]))
          return d
        }
        let k = z([3, 2, 1, 0], [7, 6, 5, 4], 'front')
        c = k[0]
        const n = k[1]
        ...
        z = k[0]
        k = k[1]
        k === 1 ? (A += 1e6 * (t.plotWidth - g)) : k || (A += 1e6 * g)
        A += 10 * (!r || (y >= 0 && y <= 180) || (y < 360 && y > 357.5) ? t.plotHeight - d : 10 + d)
        n === 1 ? (A += 100 * b) : n || (A += 100 * (1e3 - b))
        return {
      ...
      m.prototype.arc3d = function (e) {
        function b (c) {
          ...
          let d
          c = n(c)
          for (d in c) a.indexOf(d) !== -1 && ((e[d] = c[d]), delete c[d], (f = !0))
          return f ? [e, c] : !1
        }
        const f = this.g()
        const g = f.renderer
        var a = 'x y r innerR start end depth'.split(' ')
        e = n(e)
        e.alpha = (e.alpha || 0) * M
        e.beta = (e.beta || 0) * M
        f.top = g.path()
        ...
        f.out = g.path()
        f.onAdd = function () {
          const c = f.parentGroup
          const e = f.attr('class')
          f.top.add(f);
        ...
        f.setPaths = function (c) {
          const e = f.renderer.arc3dPath(c)
          const d = 100 * e.zTop
          f.attribs = c
        ...
        f.animate = function (e, g, a) {
          const v = this.attribs
          const t = 'data-' + Math.random().toString(26).substring(2, 9)
          delete e.center
          delete e.z
          delete e.alpha
          delete e.beta
          const y = r(c(g, this.renderer.globalAnimation))
          if (y.duration) {
            g = b(e)
            f[t] = 0
            e[t] = 1
      ...
      m.prototype.arc3dPath = function (c) {
        ...
        c = Math.cos(a)
        let I = Math.sin(a)
        const z = h * Math.cos(y)
        h *= Math.cos(t)
        const H = q * Math.cos(y)
        const C = q * Math.cos(t)
        q = n * Math.sin(y)
        const r = n * Math.sin(t)
        n = [['M', f + z * J, b + h * K]]
        n = n.concat(k(f, b, z, h, g, a, 0, 0))
        n.push(['L', f + H * c, b + C * I])
        n = n.concat(k(f, b, H, C, a, g, 0, 0))
        n.push(['Z'])
        let m = y > 0 ? Math.PI / 2 : 0
        y = t > 0 ? 0 : Math.PI / 2
        m = g > -m ? g : a > -m ? -m : g
        const p = a < v - y ? a : g < v - y ? v - y : a
        const F = 2 * v - y
        t = [['M', f + z * A(m), b + h * e(m)]]
  ...
  B(a, 'Core/Axis/Tick3D.js', [a['Core/Utilities.js']], function (a) {
    ...
    return (function () {
      ...
      a.onAfterGetLabelPosition = function (d) {
        const a = this.axis.axis3D
        a && u(d.pos, a.fix3dPosition(d.pos))
      }
      a.wrapGetMarkPath = function (d) {
        let a = this.axis.axis3D
        const m = d.apply(this, [].slice.call(arguments, 1))
        if (a) {
          const p = m[0]
          const h = m[1]
          if (p[0] === 'M' && h[0] === 'L') {
  ...
  B(
    a,
    'Core/Axis/Axis3D.js',
    [a['Core/Globals.js'], a['Extensions/Math3D.js'], a['Core/Axis/Tick.js'], a['Core/Axis/Tick3D.js'], a['Core/Utilities.js']],
    function (a, l, u, d, m) {
      const w = l.perspective
      const k = l.perspective3D
      const G = l.shapeArea
      const p = m.addEvent
      const h = m.merge
      const r = m.pick
      ...
      const n = (function () {
        ...
        b.prototype.fix3dPosition = function (c, b) {
          const d = this.axis
          let e = d.chart
          if (d.coll === 'colorAxis' || !e.chart3d || !e.is3d()) return c
          let a = L * e.options.chart.options3d.alpha
          let h = L * e.options.chart.options3d.beta
          let q = r(b && d.options.title.position3d, d.options.labels.position3d)
          b = r(b && d.options.title.skew3d, d.options.labels.skew3d)
          const k = e.chart3d.frame3d
          let g = e.plotLeft
          const A = e.plotWidth + g
          const f = e.plotTop
          const n = e.plotHeight + f
          e = !1
          let p = 0
          let m = 0
          let l = { x: 0, y: 1, z: 0 }
      ...
      return (function () {
        ...
        a.wrapGetLinePath = function (c) {
          return this.chart.is3d() && this.coll !== 'colorAxis' ? [] : c.apply(this, [].slice.call(arguments, 1))
        }
        a.wrapGetPlotBandPath = function (c) {
          if (!this.chart.is3d() || this.coll === 'colorAxis') return c.apply(this, [].slice.call(arguments, 1))
          let d = arguments
          let a = d[2]
          const e = []
          ...
          if (d && a) {
            for (let b = 0; b < d.length; b += 2) {
              ...
              const n = a[b]
              const g = a[b + 1]
              h[0] === 'M' && k[0] === 'L' && n[0] === 'M' && g[0] === 'L' && e.push(h, k, g, ['L', n[1], n[2]], ['Z'])
            }
          }
          return e
        }
        a.wrapGetPlotLinePath = function (c) {
          let d = this.axis3D
          const a = this.chart
          let e = c.apply(this, [].slice.call(arguments, 1))
          if (this.coll === 'colorAxis' || !a.chart3d || !a.is3d() || e === null) return e
          let b = a.options.chart.options3d
          const h = this.isZAxis ? a.plotWidth : b.depth
          b = a.chart3d.frame3d
          const k = e[0]
          const n = e[1]
          e = []
        ...
        a.wrapGetSlotWidth = function (c, d) {
          let b = this.chart
          let a = this.ticks
          let h = this.gridGroup
          if (this.categories && b.frameShapes && b.is3d() && h && d && d.label) {
            h = h.element.childNodes[0].getBBox()
            const n = b.frameShapes.left.getBBox()
            let q = b.options.chart.options3d
            b = {
              x: b.plotWidth / 2,
              y: b.plotHeight / 2,
              z: q.depth / 2,
            ...
            const m = a[q - 1]
            a = a[q + 1]
            q !== 0 && m && m.label.xy && (p = k({ x: m.label.xy.x, y: m.label.xy.y, z: null }, b, b.vd))
        ...
        a.wrapGetTitlePosition = function (c) {
          const d = c.apply(this, [].slice.call(arguments, 1))
                ...
                (function () {
                  let d = function (a, b) {
                    d =
                            ...
                            function (d, b) {
                              for (const a in b) b.hasOwnProperty(a) && (d[a] = b[a])
                            }
                    return d(a, b)
                  }
                  return function (a, b) {
                    ...
                    d(a, b)
                    a.prototype = b === null ? Object.create(b) : ((h.prototype = b.prototype), new h())
                  }
                })()
    const d = l.addEvent
    const m = l.merge
  ...
  B(
    ...
    function (a, l, u, d, m, w, k, G) {
      ...
      const h = m.shapeArea3D
      const r = w.defaultOptions
      const b = k.addEvent
      m = k.Fx
      const B = k.isArray
      const n = k.merge
      ...
      (function (a) {
        function e (c) {
          this.is3d() && c.options.type === 'scatter' && (c.options.type = 'scatter3d')
        }
        function k () {
          if (this.chart3d && this.is3d()) {
            const c = this.renderer
            let a = this.options.chart.options3d
            const b = this.chart3d.get3dFrame()
            const e = this.plotLeft
            const f = this.plotLeft + this.plotWidth
            const g = this.plotTop
            const h = this.plotTop + this.plotHeight
            a = a.depth
            const k = e - (b.left.visible ? b.left.size : 0)
            const q = f + (b.right.visible ? b.right.size : 0)
            const n = g - (b.top.visible ? b.top.size : 0)
            const m = h + (b.bottom.visible ? b.bottom.size : 0)
            const p = 0 - (b.front.visible ? b.front.size : 0)
            const l = a + (b.back.visible ? b.back.size : 0)
            const v = this.hasRendered ? 'animate' : 'attr'
        ...
        function l () {
          ...
          this.is3d() &&
                        (c.series || []).forEach(function (b) {
                          (b.type || c.chart.type || c.chart.defaultSeriesType) === 'scatter' && (b.type = 'scatter3d')
                        })
        }
        function v () {
          const c = this.options.chart.options3d
          if (this.chart3d && this.is3d()) {
            c && ((c.alpha = (c.alpha % 360) + (c.alpha >= 0 ? 0 : 360)), (c.beta = (c.beta % 360) + (c.beta >= 0 ? 0 : 360)))
            const b = this.inverted
        ...
        var D = (function () {
          ...
          c.prototype.get3dFrame = function () {
            const c = this.chart
            let b = c.options.chart.options3d
            let a = b.frame
            let d = c.plotLeft
            const e = c.plotLeft + c.plotWidth
            const f = c.plotTop
            let g = c.plotTop + c.plotHeight
            const k = b.depth
            let n = function (a) {
              a = h(a, c)
            ...
            const C = function (c, a, b) {
              for (var d = ['size', 'color', 'visible'], e = {}, f = 0; f < d.length; f++) {
                for (let g = d[f], h = 0; h < c.length; h++) {
              ...
              c = b
              !0 === e.visible || !1 === e.visible ? (c = e.visible) : e.visible === 'auto' && (c = a > 0)
              return {
                size: q(e.size, 1),
          ...
          c.prototype.getScale = function (c) {
            const a = this.chart
            const b = a.plotLeft
            const d = a.plotWidth + b
            const e = a.plotTop
            const f = a.plotHeight + e
            const g = b + a.plotWidth / 2
            const h = e + a.plotHeight / 2
            ...
            e > q && (l = q < 0 ? Math.min(l, (e + h) / (-q + e + h)) : Math.min(l, 1 - (((e + h) / (q + h)) % 1)))
        ...
        a.compose = function (h, q) {
          ...
          q.matrixSetter = function () {
            if (this.pos < 1 && (B(this.start) || B(this.end))) {
              const c = this.start || [1, 0, 0, 1, 0, 0]
              const a = this.end || [1, 0, 0, 1, 0, 0]
              var b = []
              for (let d = 0; d < 6; d++) b.push(this.pos * a[d] + (1 - this.pos) * c[d])
            } else b = this.end
  ...
  B(a, 'Core/Series/Series3D.js', [a['Core/Globals.js'], a['Extensions/Math3D.js'], a['Core/Utilities.js']], function (a, l, u) {
    ...
    a.Series.prototype.translate3dPoints = function () {
      let a = this.chart
      let k = m(this.zAxis, a.options.zAxis[0])
      const l = []
      let p
      for (p = 0; p < this.data.length; p++) {
        var h = this.data[p]
        if (k && k.translate) {
          const r = k.logarithmic && k.val2lin ? k.val2lin(h.z) : h.z
  ...
  B(
    ...
    function (a, l, u, d) {
      ...
      function k (a, b, c) {
        const d = this.chart.is3d && this.chart.is3d()
      ...
      function G (a) {
        ...
        return this.series.chart.is3d() ? this.graphic && this.graphic.element.nodeName !== 'g' : a.apply(this, b)
      }
      const p = l.perspective
      l = d.addEvent
      var h = d.pick
      d = d.wrap
      const r = a.Series
      const b = a.seriesTypes
      const B = a.svg
      ...
      b.column.prototype.translate3dShapes = function () {
        ...
        const c = a.options
        const d = c.depth
        let h = (c.stacking ? c.stack || 0 : a.index) * (d + (c.groupZPadding || 1))
        let e = a.borderWidth % 2 ? 0.5 : 0
        let k
        ...
        a.data.forEach(function (c) {
          ...
          if (c.y !== null) {
            ...
            [
              ...
              g = l[b[0]] - e
              g < 0 && ((l[b[1]] += l[b[0]] + e), (l[b[0]] = -e), (g = 0))
              g + l[b[1]] > a[b[0] + 'Axis'].len && l[b[1]] !== 0 && (l[b[1]] = a[b[0] + 'Axis'].len - l[b[0]])
              if (l[b[1]] !== 0 && (l[b[0]] >= a[b[0] + 'Axis'].len || l[b[0]] + l[b[1]] <= e)) {
                for (const d in l) l[d] = 0
                c.outside3dPlot = !0
              }
            })
      ...
      d(b.column.prototype, 'setVisible', function (a, b) {
        ...
        c.chart.is3d() &&
                    c.data.forEach(function (a) {
                      d = (a.visible = a.options.visible = b = typeof b === 'undefined' ? !h(c.visible, a.visible) : b)
                        ? 'visible'
                        : 'hidden'
      ...
      l(r, 'afterInit', function () {
        if (this.chart.is3d() && this.handle3dGrouping) {
          ...
          let b = a.grouping
          let c = a.stacking
          const d = h(this.yAxis.options.reversedStacks, !0)
          let k = 0
      ...
      d(r.prototype, 'alignDataLabel', function (a, b, c, d, k) {
        ...
        if (e.is3d() && this.is('column')) {
          let l = this.options
          const m = h(d.inside, !!this.options.stacking)
          const n = e.options.chart.options3d
          const q = b.pointWidth / 2 || 0
          l = { x: k.x + q, y: k.y, z: this.z + l.depth / 2 }
          e.inverted &&
                        (m && ((k.width = 0), (l.x += b.shapeArgs.height / 2)),
                        n.alpha >= 90 && n.alpha <= 270 && (l.y += b.shapeArgs.width))
          l = p([l], e, !0, !1)[0]
          k.x = l.x - q
      ...
      d(u.prototype, 'getStackBox', function (a, d, c, h, k, e, l, m) {
        const n = a.apply(this, [].slice.call(arguments, 1))
        if (d.is3d() && c.base) {
          let q = +c.base.split(',')[0]
          let g = d.series[q]
          ...
          g &&
                        ...
                        d.inverted && ((n.width = 0), q.alpha >= 90 && q.alpha <= 270 && (g.y += e)),
                        (g = p([g], d, !0, !1)[0]),
                        (n.x = g.x - e / 2),
                        (n.y = g.y))
        }
  ...
  B(a, 'Series/Pie3DSeries.js', [a['Core/Globals.js'], a['Core/Utilities.js']], function (a, l) {
    ...
    l(m.pie.prototype, 'translate', function (a) {
      ...
      if (this.chart.is3d()) {
        ...
        const l = k.options
        const h = l.depth || 0
        const m = k.chart.options.chart.options3d
        const b = m.alpha
        const u = m.beta
        let n = l.stacking ? (l.stack || 0) * h : k._i * h
        n += h / 2
        !1 !== l.grouping && (n = 0)
    ...
    l(m.pie.prototype, 'drawDataLabels', function (a) {
      if (this.chart.is3d()) {
        const k = this.chart.options.chart.options3d
        this.data.forEach(function (a) {
          const h = a.shapeArgs
          const l = h.r
          const b = (h.start + h.end) / 2
          a = a.labelPosition
          const m = a.connectorPosition
          const n = -l * (1 - Math.cos((h.alpha || k.alpha) * d)) * Math.sin(b)
          const p = l * (Math.cos((h.beta || k.beta) * d) - 1) * Math.cos(b);
    ...
    l(m.pie.prototype, 'animate', function (a) {
      if (this.chart.is3d()) {
        let d = arguments[1]
        let k = this.options.animation
        const h = this.center
        const l = this.group
        const b = this.markerGroup
        w &&
                    (!0 === k && (k = {}),
                    d
  ...
  B(
    ...
    function (a, l, u, d) {
      const m = l.pointCameraDistance
      l = d.seriesType
      const w = a.seriesTypes
      l(
        'scatter3d',
        'scatter',
        {
        ...
        },
        {
          pointAttribs: function (a) {
            const d = w.scatter.prototype.pointAttribs.apply(this, arguments)
