...
(function (T, O) {
  ...
  O(n, 'Core/Globals.js', [], function () {
    const f = typeof T !== 'undefined' ? T : typeof window !== 'undefined' ? window : {}
    const a = f.document
    const S = (f.navigator && f.navigator.userAgent) || ''
    const y = a && a.createElementNS && !!a.createElementNS('http://www.w3.org/2000/svg', 'svg').createSVGRect
    const n = /(edge|msie|trident)/i.test(S) && !f.opera
    const G = S.indexOf('Firefox') !== -1
    const C = S.indexOf('Chrome') !== -1
    const J = G && parseInt(S.split('Firefox/')[1], 10) < 4
    return {
      product: 'Highcharts',
      version: '8.2.0',
  ...
  O(n, 'Core/Utilities.js', [n['Core/Globals.js']], function (f) {
    function a (b, c, e, d) {
      let z = c ? 'Highcharts error' : 'Highcharts warning'
      b === 32 && (b = z + ': Deprecated member')
      const w = I(b)
      let g = w ? z + ' #' + b + ': www.highcharts.com/errors/' + b + '/' : b.toString()
      z = function () {
        if (c) throw Error(g)
        v.console && a.messages.indexOf(g) === -1 && console.log(g)
      }
    ...
    function y (b, c) {
      return !!b && typeof b === 'object' && (!c || !E(b))
    }
    function n (b, c, e) {
      let d
      K(c)
        ? m(e)
          ? b.setAttribute(c, e)
          : b && b.getAttribute && ((d = b.getAttribute(c)) || c !== 'class' || (d = b.getAttribute(c + 'Name')))
        : U(c, function (c, e) {
          b.setAttribute(e, c)
        })
      return d
    ...
    function G () {
      for (let b = arguments, c = b.length, e = 0; e < c; e++) {
        const d = b[e]
    ...
    function C (b, c) {
      if (!b) return c
      const e = b.split('.').reverse()
      if (e.length === 1) return c[b]
      for (b = e.pop(); typeof b !== 'undefined' && typeof c !== 'undefined' && c !== null;) (c = c[b]), (b = e.pop())
      return c
    }
    f.timers = []
    const J = f.charts
    ...
    const L = (function () {
      ...
      b.prototype.dSetter = function () {
        ...
        const d = this.now || 0
        if (d !== 1 && c && b) {
          if (c.length === b.length && d < 1) {
            for (let z = 0; z < b.length; z++) {
              for (var w = c[z], g = b[z], k = [], h = 0; h < g.length; h++) {
                const P = w[h]
                const l = g[h]
                k[h] =
                                    typeof P === 'number' && typeof l === 'number' && (g[0] !== 'A' || (h !== 4 && h !== 5))
                                      ? P + d * (l - P)
                                      : l
              }
              e.push(k)
      ...
      b.prototype.run = function (b, c, e) {
        ...
        const h = function () {
          for (let b = 0; b < f.timers.length; b++) f.timers[b]() || f.timers.splice(b--, 1)
          f.timers.length && g(h)
        }
        b !== c || this.elem['forceAnimate:' + this.prop]
          ? ((this.startTime = +new Date()),
            ...
            (w.elem = this.elem),
            (w.prop = this.prop),
            w() && f.timers.push(w) === 1 && g(h))
          : (delete z.curAnim[this.prop], z.complete && Object.keys(z.curAnim).length === 0 && z.complete.call(this.elem))
      }
      ...
      b.prototype.initPath = function (b, c, e) {
        function d (b, c) {
          for (; b.length < r;) {
            const e = b[0]
            const d = c[r - b.length]
            d && e[0] === 'M' && (b[0] = d[0] === 'C' ? ['C', e[1], e[2], e[1], e[2], e[1], e[2]] : ['L', e[1], e[2]])
            b.unshift(e)
        ...
        function z (b, c) {
          for (; b.length < r;) {
            if (((c = b[b.length / k - 1].slice()), c[0] === 'C' && ((c[1] = c[5]), (c[2] = c[6])), h)) {
              const e = b[b.length / k].slice()
    ...
    f.Fx = L
    f.merge = S
    const q = (f.pInt = function (b, c) {
      return parseInt(b, c || 10)
    })
    var K = (f.isString = function (b) {
      return typeof b === 'string'
    })
    var E = (f.isArray = function (b) {
      b = Object.prototype.toString.call(b)
      return b === '[object Array]' || b === '[object Array Iterator]'
    })
    f.isObject = y
    var p = (f.isDOMElement = function (b) {
      return y(b) && typeof b.nodeType === 'number'
    })
    var t = (f.isClass = function (b) {
      const c = b && b.constructor
      return !(!y(b, !0) || p(b) || !c || !c.name || c.name === 'Object')
    })
    var I = (f.isNumber = function (b) {
      return typeof b === 'number' && !isNaN(b) && Infinity > b && -Infinity < b
    })
    const u = (f.erase = function (b, c) {
    ...
    var m = (f.defined = function (b) {
      return typeof b !== 'undefined' && b !== null
    })
    f.attr = n
    const h = (f.splat = function (b) {
      return E(b) ? b : [b]
    })
    const l = (f.syncTimeout = function (b, c, e) {
      if (c > 0) return setTimeout(b, c, e)
      b.call(0, e)
      return -1
    })
    const k = (f.clearTimeout = function (b) {
      m(b) && clearTimeout(b)
    })
    const g = (f.extend = function (b, c) {
      let e
      b || (b = {})
      for (e in c) b[e] = c[e]
      return b
    ...
    f.pick = G
    const d = (f.css = function (b, c) {
      f.isMS && !f.svg && c && typeof c.opacity !== 'undefined' && (c.filter = 'alpha(opacity=' + 100 * c.opacity + ')')
      g(b.style, c)
    })
    const x = (f.createElement = function (b, c, e, z, w) {
      b = H.createElement(b)
      c && g(b, c)
    ...
    const r = (f.extendClass = function (b, c) {
      const e = function () {}
      e.prototype = new b()
      g(e.prototype, c)
      return e
    ...
    const N = (f.relativeLength = function (b, c, e) {
      return /%$/.test(b) ? (c * parseFloat(b)) / 100 + (e || 0) : parseFloat(b)
    })
    const B = (f.wrap = function (b, c, e) {
      const d = b[c]
      b[c] = function () {
    ...
    const M = (f.format = function (b, c, e) {
      let d = '{'
      let z = !1
      const w = []
      const g = /f$/
      const h = /\.([0-9])/
      const k = f.defaultOptions.lang
      const P = (e && e.time) || f.time
      for (e = (e && e.numberFormatter) || X; b;) {
        ...
        if (z) {
          r = r.split(':')
          d = C(r.shift() || '', c)
          if (r.length && typeof d === 'number') {
            if (((r = r.join(':')), g.test(r))) {
              const m = parseInt((r.match(h) || ['', '-1'])[1], 10)
              d !== null && (d = e(d, m, k.decimalPoint, r.indexOf(',') > -1 ? k.thousandsSep : ''))
    ...
    const F = (f.normalizeTickInterval = function (b, c, e, d, z) {
      let w = b
      e = G(e, 1)
      const g = b / e
      c ||
    ...
    const e = (f.stableSort = function (b, c) {
      ...
      b.sort(function (b, e) {
        d = c(b, e)
        return d === 0 ? b.safeI - e.safeI : d
      })
      for (z = 0; z < e; z++) delete b[z].safeI
    })
    const c = (f.arrayMin = function (b) {
      for (var c = b.length, e = b[0]; c--;) b[c] < e && (e = b[c])
      return e
    })
    const b = (f.arrayMax = function (b) {
      for (var c = b.length, e = b[0]; c--;) b[c] > e && (e = b[c])
      return e
    })
    const z = (f.destroyObjectProperties = function (b, c) {
      U(b, function (e, d) {
        e && e !== c && e.destroy && e.destroy()
        delete b[d]
      })
    })
    const w = (f.discardElement = function (b) {
      let c = f.garbageBin
      c || (c = x('div'))
      b && c.appendChild(b)
      c.innerHTML = ''
    })
    var P = (f.correctFloat = function (b, c) {
      return parseFloat(b.toPrecision(c || 14))
    })
    const Z = (f.setAnimation = function (b, c) {
      c.renderer.globalAnimation = G(b, c.options.chart.animation, !0)
    })
    const W = (f.animObject = function (b) {
      return y(b) ? f.merge({ duration: 500, defer: 0 }, b) : { duration: b ? 500 : 0, defer: 0 }
    })
    const aa = (f.timeUnits = {
      millisecond: 1,
      second: 1e3,
      minute: 6e4,
      hour: 36e5,
    ...
    var X = (f.numberFormat = function (b, c, e, d) {
      b = +b || 0
      c = +c
      const z = f.defaultOptions.lang
      let w = (b.toString().split('.')[1] || '').split('e')[0].length
      const g = b.toString().split('e')
      if (c === -1) c = Math.min(w, 20)
      else if (!I(c)) c = 2
      else if (c && g[1] && g[1] < 0) {
        var h = c + +g[1]
        h >= 0
          ? ((g[0] = (+g[0]).toExponential(h).split('e')[0]), (c = h))
          : ((g[0] = g[0].split('.')[0] || 0), (b = c < 20 ? (g[0] * Math.pow(10, g[1])).toFixed(c) : 0), (g[1] = 0))
      }
      const k = (Math.abs(g[1] ? g[0] : b) + Math.pow(10, -Math.max(c, w) - 1)).toFixed(c)
      w = String(q(k))
      h = w.length > 3 ? w.length % 3 : 0
      e = G(e, z.decimalPoint)
      d = G(d, z.thousandsSep)
      b = (b < 0 ? '-' : '') + (h ? w.substr(0, h) + d : '')
    ...
    const ba = (f.getStyle = function (b, c, e) {
      ...
      if ((b = v.getComputedStyle(b, void 0))) (b = b.getPropertyValue(c)), G(e, c !== 'opacity') && (b = q(b))
      return b
    })
    ...
    const Q = (f.offset = function (b) {
      const c = H.documentElement
    ...
    const fa = (f.stop = function (b, c) {
      for (let e = f.timers.length; e--;) f.timers[e].elem !== b || (c && c !== f.timers[e].prop) || (f.timers[e].stopped = !0)
    })
    var U = (f.objectEach = function (b, c, e) {
      for (const d in b) Object.hasOwnProperty.call(b, d) && c.call(e || b[d], b[d], d, b)
    })
    U(
      {
        map: 'map',
    ...
    const ja = (f.addEvent = function (b, c, e, d) {
      void 0 === d && (d = {})
      const z = b.addEventListener || f.addEventListenerPolyfill
      const w =
    ...
    var ha = (f.removeEvent = function (b, c, e) {
      function d (c, e) {
        const d = b.removeEventListener || f.removeEventListenerPolyfill
        d && d.call(b, c, e, !1)
      }
      function z (e) {
        let z
    ...
    const ka = (f.animate = function (b, c, e) {
      ...
      e.easing = typeof e.easing === 'function' ? e.easing : Math[e.easing] || Math.easeInOutSine
      e.curAnim = S(c)
      U(c, function (h, k) {
        fa(b, k)
        g = new L(b, e, k)
        ...
        k === 'd' && E(c.d)
          ...
          : b.attr
            ? (d = b.attr(k))
            : ((d = parseFloat(ba(b, k)) || 0), k !== 'opacity' && (z = 'px'))
        w || (w = h)
    ...
    const O = (f.useSerialIds = function (b) {
      return (da = G(b, da))
    })
    const na = (f.isFunction = function (b) {
      return typeof b === 'function'
    })
    var ia = (f.getOptions = function () {
      return f.defaultOptions
    })
    const oa = (f.setOptions = function (b) {
  ...
  O(n, 'Core/Color.js', [n['Core/Globals.js'], n['Core/Utilities.js']], function (f, a) {
    ...
    a = (function () {
        ...
        if ((this.input = f = a.names[f && f.toLowerCase ? f.toLowerCase() : ''] || f) && f.stops) {
          ...
          if (f && f.charAt && f.charAt() === '#') {
            ...
            v === 7
              ...
              : v === 4 &&
                              (J = [((f & 3840) >> 4) | ((f & 3840) >> 8), ((f & 240) >> 4) | (f & 240), ((f & 15) << 4) | (f & 15), 1])
          }
          if (!J) {
      ...
      a.prototype.brighten = function (a) {
        ...
        } else if (S(a) && a !== 0) for (f = 0; f < 3; f++) (H[f] += n(255 * a)), H[f] < 0 && (H[f] = 0), H[f] > 255 && (H[f] = 255)
        return this
      }
  ...
  O(n, 'Core/Renderer/SVG/SVGElement.js', [n['Core/Color.js'], n['Core/Globals.js'], n['Core/Utilities.js']], function (f, a, n) {
    ...
    const h = n.fireEvent
    const l = n.isArray
    const k = n.isFunction
    const g = n.isNumber
    const d = n.isString
    const x = n.merge
    const r = n.objectEach
    const A = n.pick
    const N = n.pInt
    const B = n.stop
    const M = n.syncTimeout
    const R = n.uniqueKey;
    ('')
    n = (function () {
      function F () {
      ...
      F.prototype.add = function (e) {
        ...
        typeof this.textStr !== 'undefined' && this.element.nodeName === 'text' && c.buildText(this)
        this.added = !0
      ...
      F.prototype.addClass = function (e, c) {
        const b = c ? '' : this.attr('class') || ''
        e = (e || '')
          .split(/ /g)
          .reduce(
            function (c, e) {
              b.indexOf(e) === -1 && c.push(e)
              return c
            },
            b ? [b] : []
          )
      ...
      F.prototype.animate = function (e, c, b) {
        const d = this
        const w = K(A(c, this.renderer.globalAnimation, !0))
        c = w.defer
      ...
      F.prototype.applyTextOutline = function (e) {
        ...
        let b
        e.indexOf('contrast') !== -1 && (e = e.replace(/contrast/g, this.renderer.getContrast(c.style.fill)))
        e = e.split(' ')
        const d = e[e.length - 1]
        if ((b = e[0]) && b !== 'none' && a.svg) {
          this.fakeTS = !0
          ...
          const w = c.textContent ? /^[\u0591-\u065F\u066A-\u07FF\uFB1D-\uFDFD\uFE70-\uFEFC]/.test(c.textContent) : !1
      ...
      F.prototype.attr = function (e, c, b, d) {
        ...
        let k
        let l
        const m = this.symbolCustomAttribs
        if (typeof e === 'string' && typeof c !== 'undefined') {
          const x = e
          e = {}
          e[x] = c
        }
        typeof e === 'string'
          ...
          : (r(
              ...
              function (b, c) {
                k = !1
                d || B(this, c)
                this.symbolName && m.indexOf(c) !== -1 && (g || (this.symbolAttr(e), (g = !0)), (k = !0))
                !this.rotation || (c !== 'x' && c !== 'y') || (this.doTransform = !0)
                k ||
        ...
        h(this.renderer, 'complexColor', { args: arguments }, function () {
          ...
          if (g) {
            ...
            if (p[Q]) M = p[Q].attr('id')
              ...
              k.id = M = R()
              const z = (p[Q] = d.createElement(g).attr(k).add(d.defs))
              z.radAttr = m
              z.stops = []
      ...
      F.prototype.css = function (e) {
        ...
        let w = ''
        let g = !c
        const k = ['textOutline', 'textOverflow', 'width']
        ...
        if (g) {
          c && (e = m(c, b))
          if (e) {
            if (e.width === null || e.width === 'auto') delete this.textWidth
            else if (d.nodeName.toLowerCase() === 'text' && e.width) var h = (this.textWidth = N(e.width))
          }
          this.styles = e
          ...
          if (d.namespaceURI === this.SVG_NS) {
            ...
            r(e, function (b, c) {
              k.indexOf(c) === -1 && (w += c.replace(/([A-Z])/g, l) + ':' + b + ';')
            })
            w && E(d, 'style', w)
          } else t(d, e)
          this.added &&
                        (this.element.nodeName === 'text' && this.renderer.buildText(this),
                        e && e.textOutline && this.applyTextOutline(e.textOutline))
        }
        return this
      }
      F.prototype.dashstyleSetter = function (e) {
        let c = this['stroke-width']
        c === 'inherit' && (c = 1)
      ...
      F.prototype.destroy = function () {
        ...
        let c = e.element || {}
        const b = e.renderer
        let d = (b.isSVG && c.nodeName === 'SPAN' && e.parentGroup) || void 0
        let w = c.ownerSVGElement
        ...
        if (e.clipPath && w) {
          ...
          [].forEach.call(w.querySelectorAll('[clip-path],[CLIP-PATH]'), function (b) {
            b.getAttribute('clip-path').indexOf(g.element.id) > -1 && b.removeAttribute('clip-path')
          })
        ...
        e.safeRemoveChild(c)
        for (b.styledMode || e.destroyShadows(); d && d.div && d.div.childNodes.length === 0;) { (c = d.parentGroup), e.safeRemoveChild(d.div), delete d.div, (d = c) }
      ...
      F.prototype.destroyTextPath = function (e, c) {
        const b = e.getElementsByTagName('text')[0]
        if (b) {
          if (
      ...
      F.prototype.dSetter = function (e, c, b) {
        l(e) &&
                    (typeof e[0] === 'string' && (e = this.renderer.pathToSegments(e)),
                    (this.pathArray = e),
      ...
      F.prototype.fillSetter = function (e, c, b) {
        typeof e === 'string' ? b.setAttribute(c, e) : e && this.complexColor(e, c, b)
      }
      F.prototype.getBBox = function (e, c) {
        ...
        let g = this.styles
        const h = this.textStr
        const l = d.cache
        const r = d.cacheKeys
        const x = w.namespaceURI === this.SVG_NS
        c = A(c, this.rotation, 0)
        const p = d.styledMode ? w && F.prototype.getStyle.call(w, 'font-size') : g && g.fontSize
        if (I(h)) {
          var B = h.toString()
          B.indexOf('<') === -1 && (B = B.replace(/[0-9]/g, '0'))
        ...
        if (!b) {
          ...
          if (B && b.height > 0) {
            for (; r.length > 250;) delete l[r.shift()]
            l[B] || r.push(B)
            l[B] = b
          }
        }
      ...
      F.prototype.init = function (e, c) {
        this.element = c === 'span' ? p(c) : D.createElementNS(this.SVG_NS, c)
        this.renderer = e
        h(this, 'afterInit')
      }
        ...
        G && e === 'click'
          ? ((w.ontouchstart = function (c) {
            ...
            (w.ontouchend = function (e) {
              (b &&
                              Math.sqrt(Math.pow(b - e.changedTouches[0].clientX, 2) + Math.pow(d - e.changedTouches[0].clientY, 2)) >=
                                  4) ||
                              c.call(w, e)
              g = !0
              e.preventDefault()
      ...
      F.prototype.removeTextOutline = function (e) {
        for (var c = e.length, b; c--;) { (b = e[c]), b.getAttribute('class') === 'highcharts-text-outline' && u(e, this.element.removeChild(b)) }
      }
      ...
      F.prototype.setTextPath = function (e, c) {
        const b = this.element
        const d = { textAnchor: 'text-anchor' }
        let w = !1
        let k = this.textPathWrapper
        let h = !k
        c = x(
          !0,
          {
      ...
      F.prototype.shadow = function (e, c, b) {
        ...
        let x
        !0 === e ? (x = l) : typeof e === 'object' && (x = m(l, e))
        x &&
                    (x &&
                        h &&
                        r(x, function (b, c) {
        ...
        if (!x) this.destroyShadows()
          ...
          const p = x.opacity / x.width
          const B = this.parentInverted ? 'translate(-1,-1)' : 'translate(' + x.offsetX + ', ' + x.offsetY + ')'
          for (l = 1; l <= x.width; l++) {
            const t = g.cloneNode(!1)
            const A = 2 * x.width + 1 - 2 * l
            E(t, {
      ...
      F.prototype.strokeSetter = function (e, c, b) {
        ...
        this.stroke && this['stroke-width']
          ? (F.prototype.fillSetter.call(this, this.stroke, 'stroke', b),
            ...
            (this.hasStroke = !0))
          : c === 'stroke-width' && e === 0 && this.hasStroke
      ...
      F.prototype.strokeWidth = function () {
        ...
        if (e.indexOf('px') === e.length - 2) c = N(e)
          ...
          const b = D.createElementNS(v, 'rect')
      ...
      F.prototype.titleSetter = function (e) {
        let c = this.element.getElementsByTagName('title')[0]
      ...
      F.prototype.updateShadows = function (e, c, b) {
        ...
        if (d) {
          for (let g = d.length; g--;) { b.call(d[g], e === 'height' ? Math.max(c - (d[g].cutHeight || 0), 0) : e === 'd' ? this.d : c, e, d[g]) }
        }
      }
      F.prototype.updateTransform = function () {
        let e = this.translateX || 0
        let c = this.translateY || 0
        const b = this.scaleX
        const d = this.scaleY
        const g = this.inverted
        const k = this.rotation
        const h = this.matrix
      ...
      F.prototype.visibilitySetter = function (e, c, b) {
        e === 'inherit' ? b.removeAttribute(c) : this[c] !== e && b.setAttribute(c, e)
        this[c] = e
      }
      F.prototype.xGetter = function (e) {
        this.element.nodeName === 'circle' && (e === 'x' ? (e = 'cx') : e === 'y' && (e = 'cy'))
        return this._defaultGetter(e)
      }
      F.prototype.zIndexSetter = function (e, c) {
        let b = this.renderer
        let d = this.parentGroup
        const g = (d || b).element || b.box
        ...
        if (l) {
          ...
          c = g.childNodes
          for (r = c.length - 1; r >= 0 && !h; r--) {
            d = c[r]
            l = d.getAttribute('data-z-index')
            const m = !I(l)
            if (d !== k) {
              if (e < 0 && m && !b && !r) g.insertBefore(k, c[r]), (h = !0)
              else if (N(l) <= e || (m && (!I(e) || e >= 0))) g.insertBefore(k, c[r + 1] || null), (h = !0)
            }
          }
  ...
  O(n, 'Core/Renderer/SVG/SVGLabel.js', [n['Core/Renderer/SVG/SVGElement.js'], n['Core/Utilities.js']], function (f, a) {
                ...
                (function () {
                  let a = function (f, L) {
                    a =
                            ...
                            function (a, f) {
                              for (const q in f) f.hasOwnProperty(q) && (a[q] = f[q])
                            }
                    return a(f, L)
                  }
                  return function (f, L) {
                    ...
                    a(f, L)
                    f.prototype = L === null ? Object.create(L) : ((q.prototype = L.prototype), new q())
                  }
                })()
    const y = a.defined
    const D = a.extend
    const G = a.isNumber
    const C = a.merge
    const J = a.removeEvent
    return (function (a) {
      function v (f, q, H, E, p, t, I, u, m, h) {
        const l = a.call(this) || this
        l.init(f, 'g')
        l.textStr = q
        l.x = H
        l.y = E
        ...
        l.baseline = m
        l.className = h
        h !== 'button' && l.addClass('highcharts-label')
      ...
      v.prototype.css = function (a) {
        if (a) {
          ...
          v.textProps.forEach(function (f) {
            typeof a[f] !== 'undefined' && ((q[f] = a[f]), delete a[f])
          })
          this.text.css(q)
          const L = 'fontSize' in q || 'fontWeight' in q
      ...
      v.prototype.on = function (a, q) {
        const v = this
        const E = v.text
        const p = E && E.element.tagName === 'SPAN' ? E : void 0
        if (p) {
          var t = function (t) {
      ...
      v.prototype.textSetter = function (a) {
        typeof a !== 'undefined' && this.text.attr({ text: a })
        this.updateBoxSize()
        this.updateTextPadding()
      }
      v.prototype.updateBoxSize = function () {
        let a = this.text.element.style
        const f = {}
        const H = this.padding
        const E = this.paddingLeft
        const p =
      ...
      v.prototype.updateTextPadding = function () {
        ...
        let v = this.paddingLeft + this.padding
        y(this.widthSetting) &&
                    this.bBox &&
      ...
      v.prototype.xSetter = function (a) {
        this.x = a
        this.alignFactor &&
                    ((a -= this.alignFactor * ((this.widthSetting || this.bBox.width) + 2 * this.padding)), (this['forceAnimate:x'] = !0))
  ...
  O(
    ...
    function (f, a, n, y, D) {
      ...
      const H = D.css
      const v = D.defined
      const L = D.destroyObjectProperties
      const q = D.extend
      const K = D.isArray
      const E = D.isNumber
      const p = D.isObject
      ...
      const e = (function () {
        ...
        c.prototype.init = function (b, c, e, d, g, k, h) {
          const w = this.createElement('svg').attr({
            version: '1.1',
          ...
          b.appendChild(d)
          C(b, 'dir', 'ltr')
          b.innerHTML.indexOf('xmlns') === -1 && C(d, 'xmlns', this.SVG_NS)
          this.isSVG = !0
          this.box = d
          this.boxWrapper = w
          this.alignedObjects = []
        ...
        c.prototype.definition = function (b) {
          function c (b, d) {
            ...
            l(b).forEach(function (b) {
              const w = e.createElement(b.tagName)
              const z = {}
              u(b, function (b, c) {
                c !== 'tagName' && c !== 'children' && c !== 'textContent' && (z[c] = b)
              })
              w.attr(z)
              w.add(d || e.defs)
        ...
        c.prototype.truncate = function (b, c, e, d, g, k, h) {
          ...
          if ((a = g + A > k)) {
            ...
            m === 0 ? t('') : (e && m === e.length - 1) || t(l || h(e || d, P))
          }
          d && d.splice(0, P)
          b.actualWidth = A
          b.rotation = z
        ...
        c.prototype.buildText = function (b) {
          ...
          let a = b.styles
          const A = b.textWidth
          const I = a && a.lineHeight
          const Q = a && a.textOutline
          const f = a && a.textOverflow === 'ellipsis'
          const F = a && a.whiteSpace === 'nowrap'
          const N = a && a.fontSize
          let q
          let E = l.length
          ...
          const R = function (b, c) {
            u(e.escapes, function (e, d) {
              (c && c.indexOf(e) !== -1) || (b = b.toString().replace(new RegExp(e, 'g'), d))
            })
            return b
          }
          const n = function (b, c) {
            ...
            e = b.indexOf(c + '=')
            if (e !== -1 && ((e = e + c.length + 1), (c = b.charAt(e)), c === '"' || c === "'")) { return (b = b.substring(e + 1)), b.substring(0, b.indexOf(c)) }
          }
          const K = /<br.*?>/g
          const J = [g, f, F, I, Q, N, A].join()
          if (J !== b.textCache) {
            for (b.textCache = J; E--;) c.removeChild(l[E])
            k || Q || f || A || (g.indexOf(' ') !== -1 && (!F || K.test(g)))
              ? (a && a.appendChild(c),
                k
                  ? ((g = e.styledMode
                      ? g
                ...
                g.forEach(function (g, w) {
                  ...
                  h.forEach(function (g) {
                    if (g !== '' || h.length === 1) {
                      let l = {}
                      let m = x.createElementNS(e.SVG_NS, 'tspan')
                      let P
                      let a;
                      (P = n(g, 'class')) && C(m, 'class', P)
                      if ((P = n(g, 'style'))) (P = P.replace(/(;| |^)color([ :])/, '$1fill$2')), C(m, 'style', P)
                      if ((a = n(g, 'href')) && !d && a.split(':')[0].toLowerCase().indexOf('javascript') === -1) {
                      ...
                      if (g !== ' ') {
                        ...
                        k ? (l.dx = 0) : w && p !== null && (l.x = p)
                        C(m, l)
                        c.appendChild(t || m)
                        !k && q && (!B && d && H(m, { display: 'block' }), C(m, 'dy', v(m)))
                        if (A) {
                          const Q = g.replace(/([^\^])-/g, '$1- ').split(' ')
                          l = !F && (h.length > 1 || w || Q.length > 1)
                          t = 0
                          a = v(m)
                          if (f) {
                            r = e.truncate(
                            ...
                            for (; Q.length;) {
                              Q.length &&
                                                                  ...
                                                                  c.appendChild(m)),
                              e.truncate(b, m, null, Q, t === 0 ? z : 0, A, function (b, c) {
        ...
        c.prototype.getContrast = function (b) {
          ...
          b[1] *= 1.2
          b[2] *= 0.5
          return b[0] + b[1] + b[2] > 459 ? '#000000' : '#FFFFFF'
        }
        c.prototype.button = function (b, c, e, d, g, k, h, l, r, m) {
          const w = this.label(b, c, e, r, void 0, void 0, m, void 0, 'button')
          let z = 0
          const x = this.styledMode
          b = ((g = g ? I(g) : g) && g.style) || {}
        ...
        c.prototype.circle = function (b, c, e) {
          b = p(b) ? b : typeof b === 'undefined' ? {} : { x: b, y: c, r: e }
        ...
        c.prototype.rect = function (b, c, e, d, g, k) {
          g = p(b) ? b.r : g
          const w = this.createElement('rect')
          b = p(b) ? b : typeof b === 'undefined' ? {} : { x: b, y: c, width: Math.max(e, 0), height: Math.max(d, 0) }
          this.styledMode || (typeof k !== 'undefined' && ((b.strokeWidth = k), (b = w.crisp(b))), (b.fill = 'none'))
          g && (b.r = g)
        ...
        c.prototype.image = function (b, c, e, d, g, k) {
          let w = { preserveAspectRatio: 'none' }
          ...
          arguments.length > 1 && q(w, { x: c, y: e, width: d, height: g })
        ...
        c.prototype.symbol = function (b, c, e, d, k, h) {
          ...
          const z = /^url\((.*?)\)$/
          const l = z.test(b)
          const r = !l && (this.symbols[b] ? b : 'circle')
          const P = r && this.symbols[r]
          let t
          if (P) {
            typeof c === 'number' && (t = P.call(this.symbols, Math.round(c || 0), Math.round(e || 0), d || 0, k || 0, h))
            var a = this.path(t)
            ...
            ['width', 'height'].forEach(function (b) {
              a[b + 'Setter'] = function (b, c) {
                const e = {}
                let d = this['img' + c]
                const g = c === 'width' ? 'translateX' : 'translateY'
                this[c] = b
                v(d) &&
                                        (h &&
                                            h.backgroundSize === 'within' &&
                                            this.width &&
                                            this.height &&
            ...
            v(a.imgwidth) && v(a.imgheight)
              ...
              : (a.attr({ width: 0, height: 0 }),
                J('img', {
                  onload: function () {
                    const b = g[w.chartIndex]
                    this.width === 0 && (H(this, { position: 'absolute', top: '-999em' }), x.body.appendChild(this))
        ...
        c.prototype.clipRect = function (b, c, e, d) {
          const g = k() + '-'
          const w = this.createElement('clipPath').attr({ id: g }).add(this.defs)
        ...
        c.prototype.text = function (b, c, e, d) {
          ...
          d ||
                            (b.xSetter = function (b, c, e) {
                              const d = e.getElementsByTagName('tspan')
                              const g = e.getAttribute(c)
                              let k
        ...
        c.prototype.pathToSegments = function (b) {
          for (var c = [], e = [], d = { A: 8, C: 7, H: 2, L: 3, M: 3, Q: 5, S: 5, T: 3, V: 2 }, g = 0; g < b.length; g++) {
            ...
            typeof b[g] === 'string' && (e.length && c.push(e.slice(0)), (e.length = 0)),
            e.push(b[g])
          }
          c.push(e.slice(0))
          return c
      ...
      e.prototype.symbols = {
        ...
        arc: function (c, b, e, d, g) {
          ...
          if (g) {
            ...
            const z = g.r || e
            e = g.r || d || e
            let l = Math.abs(w - h - 2 * Math.PI) < 0.001
            w -= 0.001
            d = g.innerR
            l = m(g.open, l)
            const r = Math.cos(h)
            ...
            const a = Math.cos(w)
            const P = Math.sin(w)
            h = m(g.longArc, w - h - Math.PI < 0.001 ? 0 : 1)
        ...
        callout: function (c, b, e, d, g) {
          const k = Math.min((g && g.r) || 0, e, d)
          const h = k + 6
          const w = (g && g.anchorX) || 0
          g = (g && g.anchorY) || 0
          const l = [
            ['M', c + k, b],
            ['L', c + e - k, b],
  ...
  O(
    ...
    [n['Core/Globals.js'], n['Core/Renderer/SVG/SVGElement.js'], n['Core/Renderer/SVG/SVGRenderer.js'], n['Core/Utilities.js']],
    function (f, a, n, y) {
      const D = y.attr
      const G = y.createElement
      const C = y.css
      const J = y.defined
      const H = y.extend
      const v = y.pick
      ...
      H(a.prototype, {
        htmlCss: function (a) {
          const p = this.element.tagName === 'SPAN' && a && 'width' in a
          const t = v(p && a.width, void 0)
          if (p) {
            delete a.width
            this.textWidth = t
            var m = !0
          }
          a && a.textOverflow === 'ellipsis' && ((a.whiteSpace = 'nowrap'), (a.overflow = 'hidden'))
        ...
        htmlUpdateTransform: function () {
          if (this.added) {
            ...
            const u = this.translateX || 0
            const m = this.translateY || 0
            const h = this.x || 0
            const l = this.y || 0
            const k = this.textAlign || 'left'
            const g = { left: 0, center: 0.5, right: 1 }[k]
            let d = this.styles
            let x = d && d.whiteSpace
            ...
            if (p.tagName === 'SPAN') {
              d = this.rotation
              const r = this.textWidth && L(this.textWidth)
              const A = [d, k, p.innerHTML, this.textWidth, this.textAlign].join()
              let f;
              (f = r !== this.oldTextWidth) &&
                                !(f = r > this.oldTextWidth) &&
                                ((f = this.textPxLength) || (C(p, { width: '', whiteSpace: x || 'nowrap' }), (f = p.offsetWidth)),
                                (f = f > r))
              f && (/[ \-]/.test(p.textContent || p.innerText) || p.style.textOverflow === 'ellipsis')
                ? (C(p, {
                    width: r + 'px',
                    display: 'block',
                    whiteSpace: x || 'normal'
        ...
        setSpanRotation: function (a, p, u) {
          const m = {}
          const h = this.renderer.getTransformKey()
      ...
      H(n.prototype, {
        ...
        html: function (p, f, u) {
          ...
          m.xSetter =
                        ...
                        m.rotationSetter =
                            function (d, g) {
                              g === 'align' ? (m.alignValue = m.textAlign = d) : (m[g] = d)
                              m.doTransform = !0
                            }
                          ...
                          if ((this.parentGroup = d)) {
                            ...
                            if (!a) {
                              ...
                              r.reverse().forEach(function (d) {
                                function h (g, e) {
                                  d[e] = g
                                  e === 'translateX' ? (x.left = g + 'px') : (x.top = g + 'px')
                                  d.doTransform = !0
                                }
                                const l = D(d.element, 'class')
                                a = d.div =
                                            d.div ||
                                            G(
                                              'div',
  ...
  O(n, 'Core/Axis/Tick.js', [n['Core/Globals.js'], n['Core/Utilities.js']], function (f, a) {
    const n = a.clamp
    const y = a.correctFloat
    const D = a.defined
    const G = a.destroyObjectProperties
    const C = a.extend
    const J = a.fireEvent
    const H = a.isNumber
    const v = a.merge
    const L = a.objectEach
    const q = a.pick
    const K = f.deg2rad
    a = (function () {
      ...
      a.prototype.addLabel = function () {
        ...
        const u = t.chart
        let m = t.categories
        const h = t.logarithmic
        let l = t.names
        const k = a.pos
        const g = q(a.options && a.options.labels, f.labels)
        let d = t.tickPositions
        const x = k === d[0]
        const r = k === d[d.length - 1]
        l = this.parameters.category || (m ? q(m[k], l[k], k) : k)
        let A = a.label
        m = (!g.step || g.step === 1) && t.tickInterval === 1
        d = d.info
        let N, B
        if (t.dateTime && d) {
      ...
      a.prototype.getPosition = function (a, t, f, u) {
        const m = this.axis
        const h = m.chart
        const l = (u && h.oldChartHeight) || h.chartHeight
        a = {
          x: a
      ...
      a.prototype.getLabelPosition = function (a, t, f, u, m, h, l, k) {
        const g = this.axis
        const d = g.transA
        const x = g.isLinked && g.linkedParent ? g.linkedParent.reversed : g.reversed
        const r = g.staggerLines
        const p = g.tickRotCorr || { x: 0, y: 0 }
        let I = m.y
        const B = u || g.reserveSpaceDefault ? 0 : -g.labelOffset * (g.labelAlign === 'center' ? 0.5 : 1)
        const M = {}
        D(I) ||
                    (I =
                        g.side === 0
      ...
      a.prototype.handleOverflow = function (a) {
        const p = this.axis
        const f = p.options.labels
        const u = a.x
        let m = p.chart.chartWidth
        let h = p.chart.spacing
        const l = q(p.labelLeft, Math.min(p.pos, h[3]))
        h = q(p.labelRight, Math.max(p.isRadial ? 0 : p.pos + p.len, m - h[1]))
        const k = this.label
        const g = this.rotation
        const d = { left: 0, center: 0.5, right: 1 }[p.labelAlign || k.attr('align')]
        const x = k.getBBox().width
        const r = p.getSlotWidth(this)
        let A = r
        let N = 1
        let B
        const M = {}
        if (g || q(f.overflow, 'justify') !== 'justify') {
          g < 0 && u - d * x < l
            ? (B = Math.round(u / Math.cos(g * K) - l))
            : g > 0 && u + d * x > h && (B = Math.round((m - u) / Math.cos(g * K)))
        } else if (
          ((m = u + (1 - d) * x),
          u - d * x < l ? (A = a.x + A * (1 - d) - l) : m > h && ((A = h - a.x + A * d), (N = -1)),
          (A = Math.min(r, A)),
          A < r && p.labelAlign === 'center' && (a.x += N * (r - A - d * (r - Math.min(x, A)))),
          x > A || (p.autoRotation && (k.styles || {}).width))
        ) { B = A }
        B &&
                    (this.shortenLabel
                      ? this.shortenLabel()
                      : ((M.width = Math.floor(B) + 'px'), (f.style || {}).textOverflow || (M.textOverflow = 'ellipsis'), k.css(M)))
      }
      ...
      a.prototype.render = function (a, t, f) {
        ...
        const m = p.horiz
        let h = this.pos
        let l = q(this.tickmarkOffset, p.tickmarkOffset)
      ...
      a.prototype.renderGridLine = function (a, t, f) {
        ...
        const k = this.pos
        const g = this.type
        const d = q(this.tickmarkOffset, p.tickmarkOffset)
        const x = p.chart.renderer
        const r = g ? g + 'Grid' : 'grid'
        const A = m[r + 'LineWidth']
        const N = m[r + 'LineColor']
        m = m[r + 'LineDashStyle']
        h ||
      ...
      a.prototype.renderMark = function (a, t, f) {
        const p = this.axis
        let m = p.options
        const h = p.chart.renderer
        const l = this.type
        const k = l ? l + 'Tick' : 'tick'
        const g = p.tickSize(k)
        let d = this.mark
        const x = !d
        const r = a.x
        a = a.y
        const A = q(m[k + 'Width'], !l && p.isXAxis ? 1 : 0)
        m = m[k + 'Color']
        g &&
                    (p.opposite && (g[0] = -g[0]),
                    x &&
      ...
      a.prototype.renderLabel = function (a, f, I, u) {
        ...
        k &&
                    ...
                    (this.isFirst && !this.isLast && !q(l.showFirstLabel, 1)) || (this.isLast && !this.isFirst && !q(l.showLastLabel, 1))
                      ? (x = !1)
                      : !h || g.step || g.rotation || f || I === 0 || this.handleOverflow(a),
                    d && u % d && (x = !1),
                    x && H(a.y)
      ...
      a.prototype.replaceMovedLabel = function () {
        ...
        let q = f.reversed
        if (a && !this.isNew) {
          const u = f.horiz ? (q ? f.left : f.width + f.left) : a.xy.x
    ...
    a = (function () {
      ...
      a.prototype.get = function (a, f) {
        if (this.variableTimezone || this.timezoneOffset) {
          const p = f.getTime()
          const t = p - this.getTimezoneOffset(f)
          f.setTime(t)
          a = f['getUTC' + a]()
          f.setTime(p)
          return a
      ...
      a.prototype.set = function (a, f, q) {
        if (this.variableTimezone || this.timezoneOffset) {
          if (a === 'Milliseconds' || a === 'Seconds' || a === 'Minutes') return f['setUTC' + a](q)
      ...
      a.prototype.makeTime = function (a, t, q, u, m, h) {
        if (this.useUTC) {
          ...
          const k = this.getTimezoneOffset(l)
          l += k
          const g = this.getTimezoneOffset(l)
      ...
      a.prototype.dateFormat = function (a, t, q) {
        let p
        if (!n(t) || isNaN(t)) return ((p = f.defaultOptions.lang) === null || void 0 === p ? void 0 : p.invalidDate) || ''
        a = v(a, '%Y-%m-%d %H:%M:%S')
        const m = this
        p = new this.Date(t)
        const h = this.get('Hours', p)
        const l = this.get('Day', p)
        const k = this.get('Date', p)
        const g = this.get('Month', p)
        const d = this.get('FullYear', p)
        const x = f.defaultOptions.lang
        const r = x === null || void 0 === x ? void 0 : x.weekdays
        const A = x === null || void 0 === x ? void 0 : x.shortWeekdays
        p = D(
          {
        ...
        J(p, function (d, g) {
          for (; a.indexOf('%' + g) !== -1;) a = a.replace('%' + g, typeof d === 'function' ? d.call(m, t) : d)
        })
      ...
      a.prototype.getTimeTicks = function (a, f, I, u) {
        ...
        if (n(f)) {
          ...
          r = m.get('FullYear', k)
          u = m.get('Month', k)
          const p = m.get('Date', k)
          const t = m.get('Hours', k)
          f = k.getTime()
          ...
          g <= q.hour &&
                        ...
                        h.forEach(function (d) {
                          d % 18e5 === 0 && m.dateFormat('%H%M%S%L', d) === '000000000' && (l[d] = 'day')
                        })
        }
  ...
  O(
    ...
    function (f, a, n, y, D) {
      const G = y.addEvent
      const C = y.animObject
      const J = y.arrayMax
      const H = y.arrayMin
      const v = y.clamp
      const L = y.correctFloat
      const q = y.defined
      const K = y.destroyObjectProperties
      const E = y.error
      const p = y.extend
      const t = y.fireEvent
      const I = y.format
      const u = y.getMagnitude
      const m = y.isArray
      const h = y.isFunction
      const l = y.isNumber
      const k = y.isString
      const g = y.merge
      const d = y.normalizeTickInterval
      const x = y.objectEach
      const r = y.pick
      const A = y.relativeLength
      const N = y.removeEvent
      const B = y.splat
      const M = y.syncTimeout
      const R = D.defaultOptions
      const F = a.deg2rad
      y = (function () {
        function e (c, b) {
          this.zoomEnabled =
        ...
        e.prototype.init = function (c, b) {
          ...
          d.hasNames = k === 'category' || !0 === g.categories
          ...
          b = d.options.events
          c.axes.indexOf(d) === -1 && (e ? c.axes.splice(c.xAxis.length, 0, d) : c.axes.push(d), c[d.coll].push(d))
          d.series = d.series || []
          c.inverted && !d.isZAxis && e && typeof d.reversed === 'undefined' && (d.reversed = !0)
        ...
        e.prototype.setOptions = function (c) {
          this.options = g(
            e.defaultOptions,
            this.coll === 'yAxis' && e.defaultYAxisOptions,
        ...
        e.prototype.defaultLabelFormatter = function () {
          let c = this.axis
          const b = l(this.value) ? this.value : NaN
          let e = c.chart.time
          const d = c.categories
          const g = this.dateTimeLabelFormat
          let k = R.lang
          const h = k.numericSymbols
          k = k.numericSymbolMagnitude || 1e3
          let a = h && h.length
          const r = c.options.labels.format
          c = c.logarithmic ? Math.abs(b) : c.tickInterval
          const m = this.chart
          const x = m.numberFormatter
          if (r) var f = I(r, this, m)
          else if (d) f = '' + this.value
          else if (g) f = e.dateFormat(g, b)
          else if (a && c >= 1e3) {
            for (; a-- && typeof f === 'undefined';) { (e = Math.pow(k, a + 1)), c >= e && (10 * b) % e === 0 && h[a] !== null && b !== 0 && (f = x(b / e, -1) + h[a]) }
          }
          typeof f === 'undefined' && (f = Math.abs(b) >= 1e4 ? x(b, -1) : x(b, -1, void 0, ''))
          return f
        }
          ...
          t(this, 'getSeriesExtremes', null, function () {
            ...
            c.series.forEach(function (d) {
              if (d.visible || !b.options.chart.ignoreHiddenSeries) {
                ...
                c.positiveValuesOnly && k <= 0 && (k = null)
                if (c.isXAxis) {
                  if (((g = d.xData), g.length)) {
                    ...
                    g.length &&
                                            ((c.dataMin = Math.min(r(c.dataMin, h), h)), (c.dataMax = Math.max(r(c.dataMax, a), a)))
                  }
                } else if (
                  ((d = d.applyExtremes()),
        ...
        e.prototype.translate = function (c, b, e, d, g, k) {
          const h = this.linkedParent || this
          let a = 1
          let w = 0
          let z = d ? h.oldTransA : h.transA
          d = d ? h.oldMin : h.min
          const r = h.minPixelPadding
        ...
        e.prototype.getPlotLinePath = function (c) {
          function b (b, c, e) {
            if ((f !== 'pass' && b < c) || b > e) f ? (b = v(b, c, e)) : (q = !0)
            return b
          }
          const e = this
          const d = e.chart
          ...
          let A
          let M
          const F = (h && d.oldChartHeight) || d.chartHeight
          const u = (h && d.oldChartWidth) || d.chartWidth
          let q
          const N = e.transB
          c = {
            value: a,
        ...
        e.prototype.getMinorTickPositions = function () {
          let c = this.options
          const b = this.tickPositions
          const e = this.minorTickInterval
          let d = []
          let g = this.pointRangePadding || 0
          const k = this.min - g
          g = this.max + g
          const h = g - k
          if (h && h / e < this.len / 3) {
        ...
        e.prototype.adjustForMinRange = function () {
          ...
          let l
          this.isXAxis &&
                        typeof this.minRange === 'undefined' &&
                        !d &&
                        (q(c.min) || q(c.max)
                          ? (this.minRange = null)
          ...
          if (e - b < this.minRange) {
            const m = this.dataMax - this.dataMin >= this.minRange
            const x = this.minRange
            let f = (x - e + b) / 2
            f = [b - f, r(c.min, b - f)]
        ...
        e.prototype.getClosest = function () {
          ...
          this.categories
            ? (c = 1)
            : this.series.forEach(function (b) {
              const e = b.closestPointRange
              const d = b.visible || !b.chart.options.chart.ignoreHiddenSeries
              !b.noSharedTooltip && q(e) && d && (c = q(c) ? Math.min(c, e) : e)
            })
          return c
        }
        e.prototype.nameToX = function (c) {
          const b = m(this.categories)
          const e = b ? this.categories : this.names
          let d = c.options.x
          c.series.requireSorting = !1
          q(d) ||
                        (d = !1 === this.options.uniqueNames ? c.series.autoIncrement() : b ? e.indexOf(c.name) : r(e.keys[c.name], -1))
          if (d === -1) {
            if (!b) var g = e.length
          } else g = d
          typeof g !== 'undefined' && ((this.names[g] = c.name), (this.names.keys[c.name] = g))
          return g
        }
        ...
        e.prototype.setAxisTranslation = function (c) {
          const b = this
          const e = b.max - b.min
          let d = b.axisPointRange || 0
          let g = 0
          let h = 0
          let a = b.linkedParent
          const l = !!b.categories
          let m = b.transA
          const x = b.isXAxis
          if (x || l || d) {
            const f = b.getClosest()
            a
              ? ((g = a.minPointOffset), (h = a.pointRangePadding))
              : b.series.forEach(function (c) {
                const e = l ? 1 : x ? r(c.options.pointRange, f, 0) : b.axisPointRange || 0
                const a = c.options.pointPlacement
                d = Math.max(d, e)
                if (!b.single || l) {
                  (c = c.is('xrange') ? !x : x),
                  (g = Math.max(g, c && k(a) ? 0 : e / 2)),
                  (h = Math.max(h, c && a === 'on' ? 0 : e))
                }
              })
        ...
        e.prototype.setTickInterval = function (c) {
          const b = this
          let e = b.chart
          const g = b.logarithmic
          const k = b.options
          const h = b.isXAxis
          const a = b.isLinked
          let m = k.maxPadding
          let x = k.minPadding
          let f = k.tickInterval
          const p = k.tickPixelInterval
          const B = b.categories
          let A = l(b.threshold) ? b.threshold : null
          const Q = b.softThreshold
          b.dateTime || B || a || this.getTickAmount()
          let M = r(b.userMin, k.min)
          let F = r(b.userMax, k.max)
          if (a) {
          ...
          g &&
                        (b.positiveValuesOnly && !c && Math.min(b.min, r(b.dataMin, b.min)) <= 0 && E(10, 1, e),
          ...
          l(b.userMin) ||
                        (l(k.softMin) && k.softMin < b.min && (b.min = M = k.softMin), l(k.floor) && (b.min = Math.max(b.min, k.floor)))
          l(b.userMax) ||
          ...
          Q &&
                        ...
                        !q(M) && b.min < A && b.dataMin >= A
                          ...
                          : !q(F) && b.max > A && b.dataMax <= A && (b.max = b.options.minRange ? Math.max(A, b.min + b.minRange) : A))
          b.tickInterval =
                        b.min === b.max || typeof b.min === 'undefined' || typeof b.max === 'undefined'
                          ? 1
          ...
          b.dateTime ||
                        ...
                        (b.tickInterval = d(
                          ...
                          void 0,
                          u(b.tickInterval),
                          r(k.allowDecimals, b.tickInterval < 0.5 || void 0 !== this.tickAmount),
                          !!this.tickAmount
                        ))
        ...
        e.prototype.setTickPositions = function () {
          const c = this.options
          const b = c.tickPositions
          let e = this.getMinorTickInterval()
          let d = c.tickPositioner
          let g = this.hasVerticalPanning()
          const k = this.coll === 'colorAxis'
          const h = (k || !g) && c.startOnTick
          g = (k || !g) && c.endOnTick
          this.tickmarkOffset = this.categories && c.tickmarkPlacement === 'between' && this.tickInterval === 1 ? 0.5 : 0
          this.minorTickInterval = e === 'auto' && this.tickInterval ? this.tickInterval / 5 : e
          this.single =
                        this.min === this.max &&
                        q(this.min) &&
                        !this.tickAmount &&
          ...
          this.isLinked ||
                        (this.single &&
                            ...
                            !this.series.some(function (b) {
                              return b.is('heatmap') && b.options.pointPlacement === 'between'
                            }) &&
        ...
        e.prototype.trimTicks = function (c, b, e) {
          ...
          const k = (!this.isOrdinal && this.minPointOffset) || 0
          t(this, 'trimTicks')
          if (!this.isLinked) {
        ...
        e.prototype.adjustTickAmount = function () {
          let c = this.options
          let b = this.tickInterval
          const e = this.tickPositions
          const d = this.tickAmount
          const g = this.finalTickAmt
          const k = e && e.length
          const h = r(this.threshold, this.softThreshold ? 0 : null)
          let a
          if (this.hasData()) {
            if (k < d) {
            ...
            if (q(g)) {
              for (b = c = e.length; b--;) ((g === 3 && b % 2 === 1) || (g <= 2 && b > 0 && b < c - 1)) && e.splice(b, 1)
        ...
        e.prototype.setScale = function () {
          ...
          this.series.forEach(function (c) {
            ...
            e = e || ((d = c.xAxis) === null || void 0 === d ? void 0 : d.isDirty) || !1
          })
        ...
        e.prototype.zoom = function (c, b) {
          const e = this
          const d = this.dataMin
          const g = this.dataMax
          const k = this.options
          const h = Math.min(d, r(k.min, d))
          const a = Math.max(g, r(k.max, g))
          c = { newMin: c, newMax: b }
          t(this, 'zoom', c, function (b) {
            ...
            if (c !== e.min || k !== e.max) {
              ...
              (e.displayBtn = typeof c !== 'undefined' || typeof k !== 'undefined'),
        ...
        e.prototype.setAxisSize = function () {
          const c = this.chart
          let b = this.options
          const e = b.offsets || [0, 0, 0, 0]
          const d = this.horiz
          const g = (this.width = Math.round(A(r(b.width, c.plotWidth - e[3] + e[1]), c.plotWidth)))
          const k = (this.height = Math.round(A(r(b.height, c.plotHeight - e[0] + e[2]), c.plotHeight)))
          const h = (this.top = Math.round(A(r(b.top, c.plotTop + e[0]), c.plotHeight, c.plotTop)))
        ...
        e.prototype.getThreshold = function (c) {
          let b = this.logarithmic
          const e = b ? b.lin2log(this.min) : this.min
          b = b ? b.lin2log(this.max) : this.max
          c === null || -Infinity === c ? (c = e) : Infinity === c ? (c = b) : e > c ? (c = e) : b < c && (c = b)
          return this.translate(c, 0, 1, 0, 1)
        }
        e.prototype.autoLabelAlign = function (c) {
          const b = (r(c, 0) - 90 * this.side + 720) % 360
          c = { align: 'center' }
          t(this, 'autoLabelAlign', c, function (c) {
            b > 15 && b < 165 ? (c.align = 'right') : b > 195 && b < 345 && (c.align = 'left')
          })
          return c.align
        }
        e.prototype.tickSize = function (c) {
          const b = this.options
          let e = b[c === 'tick' ? 'tickLength' : 'minorTickLength']
          const d = r(b[c === 'tick' ? 'tickWidth' : 'minorTickWidth'], c === 'tick' && this.isXAxis && !this.categories ? 1 : 0)
          if (d && e) {
            b[c + 'Position'] === 'inside' && (e = -e)
            var g = [e, d]
          }
          c = { tickSize: g }
        ...
        e.prototype.labelMetrics = function () {
          const c = (this.tickPositions && this.tickPositions[0]) || 0
        ...
        e.prototype.unsquish = function () {
          ...
          const b = this.horiz
          const e = this.tickInterval
          let d = e
          const g = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / e)
          let k
          const h = c.rotation
          const a = this.labelMetrics()
          let l
          let m = Number.MAX_VALUE
          let x
          const f = this.max - this.min
          const p = function (b) {
            let c = b / (g || 1)
            c = c > 1 ? Math.ceil(c) : 1
        ...
        e.prototype.getSlotWidth = function (c) {
          ...
          const e = this.chart
          const d = this.horiz
          const g = this.options.labels
          const k = Math.max(this.tickPositions.length - (this.categories ? 0 : 1), 1)
          const h = e.margin[3]
          if (c && l(c.slotWidth)) return c.slotWidth
          if (d && g && (g.step || 0) < 2) return g.rotation ? 0 : ((this.staggerLines || 1) * this.len) / k
          if (!d) {
            c = (b = g === null || void 0 === g ? void 0 : g.style) === null || void 0 === b ? void 0 : b.width
        ...
        e.prototype.renderUnsquish = function () {
          ...
          const h = (g && g.style) || {}
          const a = this.horiz
          const l = this.getSlotWidth()
          let m = Math.max(1, Math.round(l - 2 * (g.padding || 5)))
          const r = {}
          const x = this.labelMetrics()
          const f = g.style && g.style.textOverflow
          let p = 0
          ...
          if (this.autoRotation) p > m && p > x.h ? (r.rotation = this.labelRotation) : (this.labelRotation = 0)
            ...
            if (!f) {
              ...
              for (m = e.length; !a && m--;) {
                let t = e[m]
                if ((t = d[t].label)) {
                  t.styles && t.styles.textOverflow === 'ellipsis'
          ...
          e.forEach(function (b) {
            ...
            c &&
                            ...
                            b.shortenLabel
                              ? b.shortenLabel()
                              : B && !e && h.whiteSpace !== 'nowrap' && (B < c.textPxLength || c.element.tagName === 'SPAN')
          ...
          this.tickRotCorr = b.rotCorr(x.b, this.labelRotation || 0, this.side !== 0)
        }
        ...
        e.prototype.getOffset = function () {
          ...
          let e = b.renderer
          let d = c.options
          const g = c.tickPositions
          const k = c.ticks
          let h = c.horiz
          const a = c.side
          const l = b.inverted && !c.isZAxis ? [1, 0, 3, 2][a] : a
          let m
          let f = 0
          let p = 0
          const B = d.title
          const A = d.labels
          let M = 0
          const F = b.axisOffset
          b = b.clipOffset
          const u = [-1, 1, 1, -1][a]
          const N = d.className
          const v = c.axisParent
          const I = c.hasData()
          ...
          I || c.isLinked
            ? (g.forEach(function (b, e) {
              ...
              c.renderUnsquish(),
              (c.reserveSpaceDefault = a === 0 || a === 2 || { 1: 'left', 3: 'right' }[a] === c.labelAlign),
              r(A.reserveSpace, c.labelAlign === 'center' ? !0 : null, c.reserveSpaceDefault) &&
          ...
          e = a === 0 ? -c.labelMetrics().h : a === 2 ? c.tickRotCorr.y : 0
          p = Math.abs(M) + p
        ...
        e.prototype.getLinePath = function (c) {
          const b = this.chart
          const e = this.opposite
          let d = this.offset
          const g = this.horiz
          const k = this.left + (e ? this.width : 0) + d
        ...
        e.prototype.getTitlePosition = function () {
          ...
          const e = this.top
          let d = this.len
          const g = this.options.title
          const k = c ? b : e
          const h = this.opposite
          const a = this.offset
          const l = g.x || 0
          const m = g.y || 0
          let r = this.axisTitle
          const x = this.chart.renderer.fontMetrics(g.style && g.style.fontSize, r)
        ...
        e.prototype.renderMinorTick = function (c) {
          const b = this.chart.hasRendered && l(this.oldMin)
        ...
        e.prototype.renderTick = function (c, b) {
          const e = this.isLinked
          const d = this.ticks
          const g = this.chart.hasRendered && l(this.oldMin)
          if (!e || (c >= this.min && c <= this.max)) { d[c] || (d[c] = new n(this, c)), g && d[c].isNew && d[c].render(b, !0, -1), d[c].render(b) }
        }
        e.prototype.render = function () {
          const c = this
          const b = c.chart
          const e = c.logarithmic
          let d = c.options
          const g = c.isLinked
          const k = c.tickPositions
          const h = c.axisTitle
          const m = c.ticks
          const r = c.minorTicks
          const f = c.alternateBands
          const p = d.stackLabels
          const B = d.alternateGridColor
          const A = c.tickmarkOffset
          const Q = c.axisLine
          const F = c.showAxis
          const u = C(b.renderer.globalAnimation)
          let q
          let N
          ...
          if (c.hasData() || g) {
            ...
            k.length &&
                                ...
                                A && (c.min === 0 || c.single) && (m[-1] || (m[-1] = new n(c, -1, null, !0)), m[-1].render(-1))),
            B &&
                                k.forEach(function (d, g) {
                                  N = typeof k[g + 1] !== 'undefined' ? k[g + 1] + A : c.max - A
                                  g % 2 === 0 &&
                                        d < c.max &&
                                        N <= c.max + (b.polar ? -A : A) &&
        ...
        e.prototype.destroy = function (c) {
          ...
          x(b, function (c, e) {
            b.getKeepProps().indexOf(e) === -1 && delete b[e]
          })
        }
        e.prototype.drawCrosshair = function (c, b) {
          ...
          if (this.crosshair && !1 !== (q(b) || !d)) {
            d
              ? q(b) &&
                              (g = r(this.coll !== 'colorAxis' ? b.crosshairPos : null, this.isXAxis ? b.plotX : this.len - b.plotY))
        ...
        e.prototype.hasVerticalPanning = function () {
          let c, b
          return /y/.test(
            ((b = (c = this.chart.options.chart) === null || void 0 === c ? void 0 : c.panning) === null || void 0 === b
              ? void 0
              : b.type) || ''
          )
        }
        ...
        e.defaultYAxisOptions = {
          ...
          stackLabels: {
            ...
            overflow: 'justify',
            formatter: function () {
              const c = this.axis.chart.numberFormatter
  ...
  O(n, 'Core/Axis/DateTimeAxis.js', [n['Core/Axis/Axis.js'], n['Core/Utilities.js']], function (f, a) {
    const n = a.addEvent
    const y = a.getMagnitude
    const D = a.normalizeTickInterval
    const G = a.timeUnits
    const C = (function () {
      function a (a) {
        this.axis = a
      ...
      a.prototype.normalizeTimeTickInterval = function (a, f) {
        ...
        a = D(a / q, H, f[0] === 'year' ? Math.max(y(a / q), 1) : 1)
    ...
    a = (function () {
      ...
      a.compose = function (a) {
        ...
        n(a, 'init', function (a) {
          a.userOptions.type !== 'datetime' ? (this.dateTime = void 0) : this.dateTime || (this.dateTime = new C(this))
        })
      }
      a.AdditionsClass = C
      return a
  ...
  O(n, 'Core/Axis/LogarithmicAxis.js', [n['Core/Axis/Axis.js'], n['Core/Utilities.js']], function (f, a) {
    ...
    const C = (function () {
      ...
      a.prototype.getLogTickPositions = function (a, f, n, q) {
        ...
        if (a >= 0.5) (a = Math.round(a)), (t = v.getLinearTickPositions(a, f, n))
        else if (a >= 0.08) {
          p = Math.floor(f)
          let I, u
          for (E = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; p < n + 1 && !u; p++) {
            const m = E.length
            for (I = 0; I < m && !u; I++) {
              const h = this.log2lin(this.lin2log(p) * E[I])
              h > f && (!q || l <= n) && typeof l !== 'undefined' && t.push(l)
              l > n && (u = !0)
              var l = h
            }
          }
    ...
    a = (function () {
      ...
      a.compose = function (a) {
        ...
        n(a, 'init', function (a) {
          ...
          a.userOptions.type !== 'logarithmic'
  ...
  O(n, 'Core/Axis/PlotLineOrBand.js', [n['Core/Axis/Axis.js'], n['Core/Globals.js'], n['Core/Utilities.js']], function (f, a, n) {
    ...
    const D = n.arrayMin
    const G = n.defined
    const C = n.destroyObjectProperties
    const J = n.erase
    const H = n.extend
    const v = n.merge
    const L = n.objectEach
    const q = n.pick
    const K = (function () {
      function f (a, f) {
        this.axis = a
      ...
      f.prototype.render = function () {
        ...
        h && (G(h.text) || G(h.formatter)) && B && B.length && t.width > 0 && t.height > 0 && !B.isFlat
          ? ((h = v(
              {
                align: I && x && 'center',
                x: I ? !x && 4 : 10,
      ...
      f.prototype.renderLabel = function (a, f, q, u) {
        let m = this.label
        let h = this.axis.chart.renderer
        m ||
                        ((m = {
    ...
    H(f.prototype, {
      getPlotBandPath: function (a, f) {
        const p = this.getPlotLinePath({
          value: f,
          force: !0,
          acrossPanes: this.options.acrossPanes
        })
        const q = this.getPlotLinePath({
          value: a,
          force: !0,
          acrossPanes: this.options.acrossPanes
        })
      ...
      addPlotBandOrLine: function (a, f) {
        const p = new K(this, a).render()
        const q = this.userOptions
        if (p) {
          if (f) {
            const u = q[f] || []
            u.push(a)
    ...
    const u = (function () {
      ...
      m.prototype.bodyFormatter = function (h) {
        return h.map(function (h) {
          const k = h.series.tooltipOptions
      ...
      m.prototype.defaultFormatter = function (h) {
        const a = this.points || p(this)
        let k = [h.tooltipFooterHeaderFormatter(a[0])]
      ...
      m.prototype.getAnchor = function (h, a) {
        ...
        this.followPointer && a
          ? (typeof a.chartX === 'undefined' && (a = g.normalize(a)), (h = [a.chartX - f, a.chartY - l]))
          : h[0].tooltipPos
            ? (h = h[0].tooltipPos)
            : (h.forEach(function (g) {
                B = g.series.yAxis
              ...
              (m /= h.length),
              (t /= h.length),
              (h = [d ? k.plotWidth - t : m, this.shared && !d && h.length > 1 && a ? a.chartY - l : d ? k.plotHeight - m : t]))
        return h.map(Math.round)
      }
      m.prototype.getDateFormat = function (h, a, k, g) {
        const d = this.chart.time
        const l = d.dateFormat('%m-%d %H:%M:%S.%L', a)
        const f = { millisecond: 15, second: 12, minute: 9, hour: 6, day: 3 }
        let m = 'millisecond'
        for (p in I) {
          if (h === I.week && +d.dateFormat('%w', a) === k && l.substr(6) === '00:00:00.000') {
            var p = 'week'
            break
          }
          if (I[p] > h) {
      ...
      m.prototype.getLabel = function () {
        ...
        let a
        const k = this
        let g = this.chart.renderer
        const d = this.chart.styledMode
        const m = this.options
        const r = 'tooltip' + (G(m.className) ? ' ' + m.className : '')
        const p =
                        ((h = m.style) === null || void 0 === h ? void 0 : h.pointerEvents) ||
          ...
          this.outside &&
                        ...
                        (this.renderer = g =
                            new f.Renderer(
                              ...
                              0,
                              0,
                              (a = this.chart.options.chart) === null || void 0 === a ? void 0 : a.style,
                              void 0,
                              void 0,
                              g.styledMode
                            )))
      ...
      m.prototype.getPosition = function (a, l, k) {
        ...
        const h = {}
        const f = (g.inverted && k.h) || 0
        let m
        const p = this.outside
        const B = p ? n.documentElement.clientWidth - 2 * d : g.chartWidth
        const M = p
          ? Math.max(
            n.body.scrollHeight,
          ...
          : g.chartHeight
        const t = g.pointer.getChartPosition()
        const F = g.containerScaling
        const e = function (b) {
        ...
        let z = b('y')
        let w = b('x')
        const q = !this.followPointer && E(k.ttBelow, !g.inverted === !!k.negative)
        const u = function (b, g, k, a, l, m, r) {
          const x = b === 'y' ? c(d) : e(d)
          const w = (k - a) / 2
          const p = a < l - d
          const B = l + d + a < g
          ...
          else if (p) h[b] = Math.min(r - a, z - f < 0 ? z : z - f)
          else if (B) h[b] = Math.max(m, l + f + k > g ? l : l + f)
          else return !1
        }
        const v = function (b, c, e, g, k) {
          let a
      ...
      m.prototype.move = function (h, l, k, g) {
        const d = this
        const f = d.now
        const m = !1 !== d.options.animation && !d.isHidden && (Math.abs(h - f.x) > 1 || Math.abs(l - f.y) > 1)
        const p = d.followPointer || d.len > 1
        J(f, {
          x: m ? (2 * f.x + h) / 3 : h,
          y: m ? (f.y + l) / 2 : l,
      ...
      m.prototype.refresh = function (h, l) {
        ...
        let f = {}
        const m = []
        let A = g.formatter || this.defaultFormatter
        f = this.shared
        const t = k.styledMode
        if (g.enabled) {
          a.clearTimeout(this.hideTimer)
          this.followPointer = p(d)[0].series.tooltipOptions.followPointer
          const B = this.getAnchor(d, l)
          l = B[0]
          const M = B[1]
      ...
      m.prototype.renderSplit = function (a, l) {
        ...
        let d = g.chart
        let h = g.chart
        const m = h.plotHeight
        const p = h.plotLeft
        const t = h.plotTop
        let B = h.pointer
        const M = h.renderer
        let u = h.scrollablePixelsY
        const F = void 0 === u ? 0 : u
        u = h.scrollingContainer
        u = void 0 === u ? { scrollLeft: 0, scrollTop: 0 } : u
        const e = u.scrollLeft
        const c = u.scrollTop
        const b = h.styledMode
        var z = g.distance
        const w = g.options
        const v = g.options.positioner
        var n = {
          left: e,
        ...
        const I = g.getLabel()
        var H = !(!d.xAxis[0] || !d.xAxis[0].opposite)
        var K = t + c
        let C = 0
        var G = m - F
        q(a) && (a = [!1, a])
        a = a.slice(0, l.length + 1).reduce(function (e, d, a) {
          if (!1 !== d && d !== '') {
            ...
            let x = a.isHeader
            let B = a.series
            let A = 'highcharts-color-' + E(a.colorIndex, B.colorIndex, 'none')
            r ||
        ...
        !v &&
                    ...
                    (a = a.map(function (b) {
                      const c = k(b.anchorX, b.anchorY, b.point.isHeader, b.boxWidth, !1)
        ...
        a.forEach(function (b) {
          const c = b.pos
          b.tt.attr({
            visibility: typeof c === 'undefined' ? 'hidden' : 'inherit',
            x: b.x,
            y: c + K,
            anchorX: b.anchorX,
            anchorY: b.anchorY
      ...
      m.prototype.drawTracker = function () {
        if (this.followPointer || !this.options.stickOnContact) this.tracker && this.tracker.destroy()
          ...
          let k = a.hoverPoint
          if (l && k) {
            const g = { x: 0, y: 0, width: 0, height: 0 }
            k = this.getAnchor(k)
            const d = l.getBBox()
            ...
            g.x = Math.min(0, k[0])
            g.y = Math.min(0, k[1])
            g.width = k[0] < 0 ? Math.max(Math.abs(k[0]), d.width - k[0]) : Math.max(Math.abs(k[0]), d.width)
            g.height = k[1] < 0 ? Math.max(Math.abs(k[1]), d.height - Math.abs(k[1])) : Math.max(Math.abs(k[1]), d.height)
            this.tracker
              ? this.tracker.attr(g)
      ...
      m.prototype.tooltipFooterHeaderFormatter = function (a, l) {
        const k = l ? 'footer' : 'header'
        const g = a.series
        const d = g.tooltipOptions
        let h = d.xDateFormat
        const f = g.xAxis
        const m = f && f.options.type === 'datetime' && L(a.key)
        let p = d[k + 'Format']
      ...
      m.prototype.updatePosition = function (a) {
        let h = this.chart
        let k = h.pointer
        const g = this.getLabel()
        let d = a.plotX + h.plotLeft
        let f = a.plotY + h.plotTop
        k = k.getChartPosition()
        a = (this.options.positioner || this.getPosition).call(this, g.width, g.height, a)
        if (this.outside) {
          const m = (this.options.borderWidth || 0) + 2 * this.distance
    ...
    function (f, a, n, y) {
      ...
      f = (function () {
        ...
        l.prototype.destroy = function () {
          const k = this
          typeof k.unDocMouseMove !== 'undefined' && k.unDocMouseMove()
        ...
        l.prototype.drag = function (a) {
          const g = this.chart
          const d = g.options.chart
          let k = a.chartX
          let h = a.chartY
          const l = this.zoomHor
          const f = this.zoomVert
          const m = g.plotLeft
          const p = g.plotTop
          const u = g.plotWidth
          const F = g.plotHeight
          let e = this.selectionMarker
          const c = this.mouseDownX || 0
          const b = this.mouseDownY || 0
          const z = t(d.panning) ? d.panning && d.panning.enabled : d.panning
          const w = d.panKey && a[d.panKey + 'Key']
          if (!e || !e.touch) {
            if (
              (k < m ? (k = m) : k > m + u && (k = m + u),
              h < p ? (h = p) : h > p + F && (h = p + F),
              ...
              const q = g.isInsidePlot(c - m, b - p)
              g.hasCartesianSeries &&
                                ...
                                g.styledMode ||
                                    e.attr({
                                      fill: d.selectionMarkerFill || D('#335cad').setOpacity(0.25).get()
                                    }))
              e && l && ((k -= c), e.attr({ width: Math.abs(k), x: (k > 0 ? 0 : k) + c }))
              e && f && ((k = h - b), e.attr({ height: Math.abs(k), y: (k > 0 ? 0 : k) + b }))
        ...
        l.prototype.drop = function (a) {
          const g = this
          const d = this.chart
          const k = this.hasPinched
          if (this.selectionMarker) {
            const h = { originalEvent: a, xAxis: [], yAxis: [] }
            const l = this.selectionMarker
            const f = l.attr ? l.attr('x') : l.x
            const m = l.attr ? l.attr('y') : l.y
            const t = l.attr ? l.attr('width') : l.width
            const u = l.attr ? l.attr('height') : l.height
            let F
            if (this.hasDragged || k) {
              d.axes.forEach(function (e) {
                if (e.zoomEnabled && L(e.min) && (k || g[{ xAxis: 'zoomX', yAxis: 'zoomY' }[e.coll]]) && p(f) && p(m)) {
                  let c = e.horiz
                  const b = a.type === 'touchend' ? e.minPixelPadding : 0
                  const d = e.toValue((c ? f : m) + b)
          ...
          d &&
                        ...
                        (d.cancelClick = this.hasDragged > 10),
                        (d.mouseIsDown = this.hasDragged = this.hasPinched = !1),
                        (this.pinchDown = []))
        }
        l.prototype.findNearestKDPoint = function (a, g, d) {
          let k = this.chart
          const h = k.hoverPoint
          k = k.tooltip
          if (h && k && k.isStickyOnContact()) return h
          let l
          a.forEach(function (a) {
            let k = !(a.noSharedTooltip && g) && a.options.findNearestPointBy.indexOf('y') < 0
            a = a.searchPoint(d, k)
            if ((k = t(a, !0)) && !(k = !t(l, !0))) {
              k = l.distX - a.distX
              const h = l.dist - a.dist
              const f = (a.series.group && a.series.group.zIndex) - (l.series.group && l.series.group.zIndex)
              k = (k !== 0 && g ? k : h !== 0 ? h : f !== 0 ? f : l.series.index > a.series.index ? -1 : 1) > 0
            }
            k && (l = a)
          })
          return l
        ...
        l.prototype.onTrackerMouseOut = function (a) {
          ...
          const g = this.chart.hoverSeries
        ...
        l.prototype.inClass = function (a, g) {
          for (var d; a;) {
            if ((d = H(a, 'class'))) {
              if (d.indexOf(g) !== -1) return !0
              if (d.indexOf('highcharts-container') !== -1) return !1
            }
            a = a.parentNode
          }
        }
        ...
        l.prototype.normalize = function (a, g) {
          let d = a.touches
          let k = d ? (d.length ? d.item(0) : m(d.changedTouches, a.changedTouches)[0]) : a
        ...
        l.prototype.onContainerMouseDown = function (k) {
          const g = ((k.buttons || k.button) & 1) === 1
          k = this.normalize(k)
          if (a.isFirefox && k.button !== 0) this.onContainerMouseMove(k)
          if (typeof k.button === 'undefined' || g) { this.zoomOption(k), g && k.preventDefault && k.preventDefault(), this.dragStart(k) }
        }
        l.prototype.onContainerMouseLeave = function (k) {
          const g = G[m(a.hoverChartIndex, -1)]
          const d = this.chart.tooltip
          k = this.normalize(k)
        ...
        l.prototype.onContainerMouseMove = function (a) {
          ...
          g.mouseIsDown === 'mousedown' && this.drag(a)
          g.openMenu ||
                        (!this.inClass(a.target, 'highcharts-tracker') && !g.isInsidePlot(a.chartX - g.plotLeft, a.chartY - g.plotTop)) ||
        ...
        l.prototype.pinch = function (a) {
          ...
          const k = a.touches || []
          const l = k.length
          const f = g.lastValidTouch
          const p = g.hasZoom
          let t = g.selectionMarker
          const u = {}
          const F = l === 1 && ((g.inClass(a.target, 'highcharts-tracker') && d.runTrackerClick) || g.runChartClick)
          const e = {}
          l > 1 && (g.initiated = !0)
          ...
          a.type === 'touchstart'
            ? ([].forEach.call(k, function (c, b) {
              ...
              d.axes.forEach(function (c) {
                if (c.zoomEnabled) {
                  const b = d.bounds[c.horiz ? 'h' : 'v']
                  const e = c.minPixelPadding
                  const g = c.toPixels(Math.min(m(c.options.min, c.dataMin), c.dataMin))
                  const a = c.toPixels(Math.max(m(c.options.max, c.dataMax), c.dataMax))
                  const h = Math.max(g, a)
        ...
        l.prototype.pinchTranslateDirection = function (a, g, d, h, l, f, m, p) {
          ...
          const b = k['plot' + (a ? 'Left' : 'Top')]
          let B
          let w
          let t = p || 1
          const A = k.inverted
          const u = k.bounds[a ? 'h' : 'v']
          const q = g.length === 1
          const v = g[0][e]
          let n = d[0][e]
          const I = !q && g[1][e]
          let N = !q && d[1][e]
          d = function () {
            typeof N === 'number' && Math.abs(v - I) > 20 && (t = p || Math.abs(n - N) / Math.abs(v - I))
            w = (b - n) / t + v
          ...
          H ? ((n -= 0.8 * (n - m[r][0])), typeof N === 'number' && (N -= 0.8 * (N - m[r][1])), d()) : (m[r] = [n, N])
          A || ((f[r] = w - b), (f[c] = B))
          f = A ? 1 / t : t
          l[c] = B
          l[r] = g
        ...
        l.prototype.reset = function (a, g) {
          const d = this.chart
          const k = d.hoverSeries
          const l = d.hoverPoint
          const f = d.hoverPoints
          const m = d.tooltip
          const p = m && m.shared ? f : l
          a &&
                        p &&
                        h(p).forEach(function (d) {
                          d.series.isCartesian && typeof d.plotX === 'undefined' && (a = !1)
                        })
          if (a) {
            m &&
                            p &&
        ...
        l.prototype.runPointActions = function (h, g) {
          const d = this.chart
          const k = d.tooltip && d.tooltip.options.enabled ? d.tooltip : void 0
          let l = k ? k.shared : !1
          let f = g || d.hoverPoint
          let p = (f && f.series) || d.hoverSeries
          p = this.getHoverData(
            f,
            p,
            d.series,
            (!h || h.type !== 'touchmove') && (!!g || (p && p.directTouch && this.isDirectTouch)),
            l,
            h
          )
          f = p.hoverPoint
          const B = p.hoverPoints
        ...
        l.prototype.setHoverChartIndex = function () {
          const h = this.chart
          const g = a.charts[m(a.hoverChartIndex, -1)]
          ...
          if (a.touches.length === 1) {
            if (((a = this.normalize(a)), (h = d.isInsidePlot(a.chartX - d.plotLeft, a.chartY - d.plotTop)) && !d.openMenu)) {
              ...
              if (a.type === 'touchmove') {
                g = this.pinchDown
                var k = g[0]
                  ? Math.sqrt(Math.pow(g[0].chartX - a.chartX, 2) + Math.pow(g[0].chartY - a.chartY, 2)) >= 4
                  : !1
              }
              m(k, !0) && this.pinch(a)
            } else g && this.reset()
  ...
  O(n, 'Core/MSPointer.js', [n['Core/Globals.js'], n['Core/Pointer.js'], n['Core/Utilities.js']], function (f, a, n) {
    ...
    function D (a, p, u, m) {
      (a.pointerType !== 'touch' && a.pointerType !== a.MSPOINTER_TYPE_TOUCH) ||
                !C[f.hoverChartIndex] ||
                (m(a),
                ...
                (function () {
                  let a = function (f, p) {
                    a =
                            ...
                            function (a, h) {
                              for (const l in h) h.hasOwnProperty(l) && (a[l] = h[l])
                            }
                    return a(f, p)
                  }
                  return function (f, p) {
    ...
    const L = n.css
    var q = n.objectEach
    const K = n.removeEvent
    var E = {}
    const p = !!f.win.PointerEvent
    return (function (a) {
      function f () {
  ...
  O(n, 'Core/Legend.js', [n['Core/Globals.js'], n['Core/Utilities.js']], function (f, a) {
    ...
    const t = a.stableSort
    const I = a.syncTimeout
    a = a.wrap
    const u = f.isFirefox
    const m = f.marginNames
    const h = f.win
    const l = (function () {
      function a (a, d) {
        this.allItems = []
      ...
      a.prototype.setOptions = function (a) {
        ...
        this.pages = []
        this.proximate = a.layout === 'proximate' && !this.chart.inverted
      ...
      a.prototype.colorizeItem = function (a, d) {
        ...
        if (!this.chart.styledMode) {
          let g = this.options
          const h = a.legendItem
          const k = a.legendLine
          const f = a.legendSymbol
          const l = this.itemHiddenStyle.color
          g = d ? g.itemStyle.color : l
          const m = d ? a.color || l : l
          const p = a.options && a.options.marker
          let t = { fill: m }
      ...
      a.prototype.positionItem = function (a) {
        const d = this
        let g = this.options
        let h = g.symbolPadding
        let k = !g.rtl
        let f = a._legendItemPos
        g = f[0]
        f = f[1]
        const l = a.checkbox
        const m = a.legendGroup
        m &&
                        m.element &&
                        ((h = {
      ...
      a.prototype.positionCheckboxes = function () {
        ...
        const d = this.clipHeight || this.legendHeight
        const h = this.titleHeight
        if (a) {
          const k = a.translateY
          this.allItems.forEach(function (g) {
            const f = g.checkbox
            if (f) {
              const l = k + h + f.y + (this.scrollOffset || 0) + 3
              D(f, {
      ...
      a.prototype.renderItem = function (a) {
        ...
        const k = this.symbolWidth
        const f = h.symbolPadding
        const l = this.itemStyle
        const m = this.itemHiddenStyle
        let p = h.layout === 'horizontal' ? K(h.itemDistance, 20) : 0
        const t = !h.rtl
        let e = a.legendItem
        const c = !a.series
        const b = !c && a.series.drawLegendSymbol ? a.series : a
        let z = b.options
      ...
      a.prototype.layoutItem = function (a) {
        ...
        const h = d.layout === 'horizontal'
        const k = a.itemHeight
        const f = this.itemMarginBottom
        const l = this.itemMarginTop
        const m = h ? K(d.itemDistance, 20) : 0
        const p = this.maxLegendWidth
        d = d.alignColumns && this.totalItemWidth > p ? this.maxItemWidth : a.itemWidth
        h &&
                        this.itemX - g + d > p &&
                        ((this.itemX = g), this.lastLineHeight && (this.itemY += l + this.lastLineHeight + f), (this.lastLineHeight = 0))
      ...
      a.prototype.getAllItems = function () {
        ...
        this.chart.series.forEach(function (d) {
          ...
          d &&
                            ...
                            (a = a.concat(d.legendItems || (g.legendType === 'point' ? d.data : d)))
        })
      ...
      a.prototype.proximatePositions = function () {
        const a = this.chart
        const d = []
        const h = this.options.align === 'left'
        this.allItems.forEach(function (g) {
          let k
          let l = h
          if (g.yAxis) {
      ...
      a.prototype.render = function () {
        ...
        let m = a.spacingBox.width - 2 * f - l.x;
        ['rm', 'lm'].indexOf(this.getAlignment().substring(0, 2)) > -1 && (m /= 2)
        ...
        let q = this.lastItemY + this.lastLineHeight + this.titleHeight
        ...
        p > 0 &&
                        ...
                        (k.isNew = !1))
        k[m ? 'show' : 'hide']()
        a.styledMode && h.getStyle('display') === 'none' && (p = q = 0)
        this.legendWidth = p
        this.legendHeight = q
        m && this.align()
      ...
      a.prototype.align = function (a) {
        ...
        const g = this.options
        let h = a.y;
        /(lth|ct|rth)/.test(this.getAlignment()) && d.titleOffset[0] > 0
          ? (h += d.titleOffset[0])
          : /(lbh|cb|rbh)/.test(this.getAlignment()) && d.titleOffset[2] > 0 && (h -= d.titleOffset[2])
        h !== a.y && (a = q(a, { y: h }))
        this.group.align(
          q(g, {
      ...
      a.prototype.handleOverflow = function (a) {
        ...
        let l = k.y
        const f = this.padding
        l = g.spacingBox.height + (k.verticalAlign === 'top' ? -l : l) - f
        const m = k.maxHeight
        let p
        let t = this.clipRect
        const e = k.navigation
        const c = K(e.animation, !0)
        const b = e.arrowSize || 12
        let z = this.nav
        const w = this.pages
        let q
        const u = this.allItems
        const n = function (b) {
          typeof b === 'number' ? t.attr({ height: b }) : t && ((d.clipRect = t.destroy()), d.contentGroup.clip())
          d.contentGroup.div &&
        ...
        k.layout !== 'horizontal' || k.verticalAlign === 'middle' || k.floating || (l /= 2)
        m && (l = Math.min(l, m))
        w.length = 0
        a > l && !1 !== e.enabled
          ? ((this.clipHeight = p = Math.max(l - 20 - this.titleHeight - f, 0)),
            ...
            u.forEach(function (b, c) {
              const e = b._legendItemPos[1]
              const d = Math.round(b.legendItem.getBBox().height)
              let a = w.length
      ...
      a.prototype.scroll = function (a, d) {
        ...
        const k = this.pages
        const l = k.length
        let f = this.currentPage + a
        a = this.clipHeight
        const m = this.options.navigation
        const t = this.pager
        const q = this.padding
        f > l && (f = l)
        f > 0 &&
                        (typeof d !== 'undefined' && p(d, h),
                        this.nav.attr({
                          translateX: q,
                        ...
                        [this.up, this.upTracker].forEach(function (e) {
                          e.attr({
                            class: f === 1 ? 'highcharts-legend-nav-inactive' : 'highcharts-legend-nav-active'
                          })
                        }),
                        t.attr({ text: f + '/' + l }),
                        ...
                        h.styledMode ||
                            (this.up.attr({
                              fill: f === 1 ? m.inactiveColor : m.activeColor
                            }),
                            this.upTracker.css({ cursor: f === 1 ? 'default' : 'pointer' }),
                            this.down.attr({
  ...
  O(
    ...
    function (f, a, n, y, D, G, C, J) {
      const H = a.charts
      const v = a.doc
      const L = a.seriesTypes
      const q = a.win
      const K = D.defaultOptions
      const E = J.addEvent
      const p = J.animate
      const t = J.animObject
      const I = J.attr
      const u = J.createElement
      const m = J.css
      const h = J.defined
      const l = J.discardElement
      const k = J.erase
      const g = J.error
      const d = J.extend
      const x = J.find
      ...
      const A = J.getStyle
      const N = J.isArray
      const B = J.isFunction
      const M = J.isNumber
      const R = J.isObject
      const F = J.isString
      const e = J.merge
      const c = J.numberFormat
      const b = J.objectEach
      const z = J.pick
      const w = J.pInt
      const P = J.relativeLength
      const Z = J.removeEvent
      const W = J.setAnimation
      const aa = J.splat
      const X = J.syncTimeout
      const ba = J.uniqueKey
      const ca = a.marginNames
      const Y = (function () {
        function D (b, c, e) {
          this.yAxis =
                            this.xAxis =
        ...
        D.prototype.isInsidePlot = function (b, c, e) {
          ...
          d = {
            x: d,
            y: b,
            isInsidePlot: d >= 0 && d <= this.plotWidth && b >= 0 && b <= this.plotHeight
          }
        ...
        D.prototype.redraw = function (b) {
          ...
          const g = c.pointer
          const h = c.legend
          const k = c.userOptions.legend
          let l = c.isDirtyLegend
          const f = c.hasCartesianSeries
          let m = c.isDirtyBox
          const p = c.renderer
          const w = p.isHidden()
          const z = []
        ...
        D.prototype.get = function (b) {
          ...
          const e = this.series
          let d
          let a = x(this.axes, c) || x(this.series, c)
        ...
        D.prototype.layOutTitles = function (b) {
          ...
          const a = this.spacingBox;
          ['title', 'subtitle', 'caption'].forEach(function (b) {
            const g = this[b]
            const h = this.options[b]
            const k = h.verticalAlign || 'top'
            b = b === 'title' ? -3 : k === 'top' ? c[0] + 2 : 0
            if (g) {
              ...
              const f = Math.round(g.getBBox(h.useHTML).height)
              g.align(d({ y: k === 'bottom' ? l : b + l, height: f }, h), !1, 'spacingBox')
              h.floating || (k === 'top' ? (c[0] = Math.ceil(c[0] + f)) : k === 'bottom' && (c[2] = Math.ceil(c[2] + f)))
            }
          }, this)
          c[0] && (this.options.title.verticalAlign || 'top') === 'top' && (c[0] += this.options.title.margin)
          c[2] && this.options.caption.verticalAlign === 'bottom' && (c[2] += this.options.caption.margin)
          const g = !this.titleOffset || this.titleOffset.join(',') !== c.join(',')
          this.titleOffset = c
          r(this, 'afterLayOutTitles')
          !this.isDirtyBox &&
                            g &&
                            ((this.isDirtyBox = this.isDirtyLegend = g), this.hasRendered && z(b, !0) && this.isDirtyBox && this.redraw())
        }
        D.prototype.getChartSize = function () {
          let b = this.options.chart
          const c = b.width
          b = b.height
          const e = this.renderTo
          h(c) || (this.containerWidth = A(e, 'width'))
          h(b) || (this.containerHeight = A(e, 'height'))
          this.chartWidth = Math.max(0, c || this.containerWidth || 600)
          this.chartHeight = Math.max(0, P(b, this.chartWidth) || (this.containerHeight > 1 ? this.containerHeight : 400))
        }
        D.prototype.temporaryDisplay = function (b) {
          ...
          if (b) {
            ...
            for (; c && c.style;) {
              ...
              if (A(c, 'display', !1) === 'none' || c.hcOricDetached) {
                (c.hcOrigStyle = {
        ...
        D.prototype.getContainer = function () {
          ...
          e || g(13, !0, this)
          let f = w(I(e, 'data-highcharts-chart'))
        ...
        D.prototype.getMargins = function (b) {
          const c = this.spacing
          const e = this.margin
          const d = this.titleOffset
          this.resetMargins()
        ...
        D.prototype.reflow = function (b) {
          const c = this
          let e = c.options.chart
          let d = c.renderTo
          const a = h(e.width) && h(e.height)
          const g = e.width || A(d, 'width')
        ...
        D.prototype.setSize = function (b, c, e) {
          ...
          typeof b !== 'undefined' && (d.options.chart.width = b)
          typeof c !== 'undefined' && (d.options.chart.height = c)
          d.getChartSize()
        ...
        D.prototype.setChartSize = function (b) {
          let c = this.inverted
          let e = this.renderer
          let d = this.chartWidth
          const a = this.chartHeight
          const g = this.options.chart
          const h = this.spacing
          const k = this.clipOffset
          let f
          let l
          let m
          let p
        ...
        D.prototype.resetMargins = function () {
          r(this, 'resetMargins')
          const b = this
          const c = b.options.chart;
          ['margin', 'spacing'].forEach(function (e) {
            const d = c[e]
            const a = R(d) ? d : [d, d, d, d];
        ...
        D.prototype.drawChartBox = function () {
          ...
          const c = this.renderer
          const e = this.chartWidth
          const d = this.chartHeight
          let a = this.chartBackground
          let g = this.plotBackground
          let h = this.plotBorder
          const k = this.styledMode
          const f = this.plotBGImage
          let l = b.backgroundColor
          const m = b.plotBackgroundColor
          const p = b.plotBackgroundImage
          let w
          const z = this.plotLeft
          const t = this.plotTop
          const B = this.plotWidth
          const q = this.plotHeight
          const x = this.plotBox
          const u = this.clipRect
          const A = this.clipBox
          let F = 'animate'
        ...
        D.prototype.linkSeries = function () {
          ...
          c.forEach(function (c) {
            let e = c.options.linkedTo
            F(e) &&
                                (e = e === ':previous' ? b.series[c.index - 1] : b.get(e)) &&
                                e.linkedParent !== c &&
        ...
        D.prototype.renderLabels = function () {
          const b = this
          const c = b.options.labels
          c.items &&
                            c.items.forEach(function (e) {
                              const a = d(c.style, e.style)
                              const g = w(a.left) + b.plotLeft
                              const h = w(a.top) + b.plotTop + 12
                              delete a.left
                              delete a.top
        ...
        D.prototype.render = function () {
          ...
          const h = (this.plotHeight = Math.max(this.plotHeight - a, 0))
          b.forEach(function (b) {
            b.setScale()
          })
          this.getAxisMargins()
          const k = d / this.plotWidth > 1.1
          const l = h / this.plotHeight > 1.05
          if (k || l) {
            b.forEach(function (b) {
        ...
        D.prototype.addCredits = function (b) {
          const c = this
          const d = e(!0, this.options.credits, b)
          d.enabled &&
                            !this.credits &&
        ...
        D.prototype.updateContainerScaling = function () {
          ...
          if (b.offsetWidth > 2 && b.offsetHeight > 2 && b.getBoundingClientRect) {
            const c = b.getBoundingClientRect()
            const e = c.width / b.offsetWidth
            b = c.height / b.offsetHeight
            e !== 1 || b !== 1 ? (this.containerScaling = { scaleX: e, scaleY: b }) : delete this.containerScaling
          }
        }
        ...
        D.prototype.onload = function () {
          this.callbacks.concat([this.callback]).forEach(function (b) {
            b && typeof this.index !== 'undefined' && b.apply(this, [this])
          }, this)
          r(this, 'load')
          r(this, 'render')
  ...
  O(n, 'Extensions/ScrollablePlotArea.js', [n['Core/Chart/Chart.js'], n['Core/Globals.js'], n['Core/Utilities.js']], function (f, a, n) {
    ...
    y(f, 'afterSetChartSize', function (f) {
      let n = this.options.chart.scrollablePlotArea
      let v = n && n.minWidth
      n = n && n.minHeight
                    ...
                    this.axes.forEach(function (f) {
                      C[f.side]
                        ? (f.getPlotLinePath = function () {
                            const q = C[f.side].name
                            const n = this[q]
                            this[q] = n - C[f.side].value
                            const p = a.Axis.prototype.getPlotLinePath.apply(this, arguments)
                            this[q] = n
                            return p
                          })
    ...
    f.prototype.applyFixed = function () {
      ...
      let n
      let v = !this.fixedDiv
      let L = this.options.chart.scrollablePlotArea
      v
        ? ((this.fixedDiv = D(
            'div',
          ...
          (f = this.scrollingContainer) === null || void 0 === f
            ? void 0
          ...
          (this.fixedRenderer = f =
                      new a.Renderer(
                        ...
                        this.chartWidth,
                        this.chartHeight,
                        (n = this.options.chart) === null || void 0 === n ? void 0 : n.style
                      )),
      ...
      const q = this.plotLeft + this.plotWidth - (this.scrollablePixelsX || 0)
      const K = this.plotTop + this.plotHeight - (this.scrollablePixelsY || 0)
      v = this.scrollablePixelsX
        ...
        : this.scrollablePixelsY
          ...
          : [['M', 0, 0]]
      this.redrawTrigger !== 'adjustHeight' && this.scrollableMask.attr({ d: v })
    }
  })
  O(n, 'Core/Axis/StackingAxis.js', [n['Core/Utilities.js']], function (f) {
    const a = f.addEvent
    const n = f.destroyObjectProperties
    const y = f.fireEvent
    const D = f.getDeferredAnimation
    const G = f.objectEach
    const C = f.pick
    const J = (function () {
      function a (a) {
        this.oldStacks = {}
      ...
      a.prototype.buildStacks = function () {
        const a = this.axis
        const f = a.series
        const q = C(a.options.reversedStacks, !0)
        const n = f.length
        let E
        if (!a.isXAxis) {
  ...
  O(n, 'Mixins/LegendSymbol.js', [n['Core/Globals.js'], n['Core/Utilities.js']], function (f, a) {
    ...
    return (f.LegendSymbolMixin = {
      drawRectangle: function (a, f) {
        const n = a.symbolHeight
        const D = a.options.squareSymbol
      ...
      drawLineMarker: function (a) {
        let f = this.options
        let C = f.marker
        const D = a.symbolWidth
        const H = a.symbolHeight
        const v = H / 2
        const L = this.chart.renderer
        const q = this.legendGroup
        ...
        C &&
                    ...
                    this.symbol.indexOf('url') === 0 && ((C = n(C, { width: H, height: H })), (f = 0)),
                    (this.legendSymbol = C =
  ...
  O(n, 'Core/Series/Point.js', [n['Core/Globals.js'], n['Core/Utilities.js']], function (f, a) {
    const n = a.animObject
    const y = a.defined
    const D = a.erase
    const G = a.extend
    const C = a.fireEvent
    const J = a.format
    const H = a.getNestedProperty
    const v = a.isArray
    const L = a.isNumber
    const q = a.isObject
    const K = a.syncTimeout
    const E = a.pick
    const p = a.removeEvent
    const t = a.uniqueKey;
    ('')
    a = (function () {
      function a () {
      ...
      a.prototype.animateBeforeDestroy = function () {
        const a = this
        const f = { x: a.startXPos, opacity: 0 }
        let h
        const l = a.getGraphicalProps()
      ...
      a.prototype.applyOptions = function (f, m) {
        const h = this.series
        const l = h.options.pointValKey || h.pointValKey
        ...
        this.formatPrefix = (this.isNull = E(this.isValid && !this.isValid(), this.x === null || !L(this.y))) ? 'null' : 'point'
        this.selected && (this.state = 'select')
        'name' in this && typeof m === 'undefined' && h.xAxis && h.xAxis.hasNames && (this.x = h.xAxis.nameToX(this))
        typeof this.x === 'undefined' && h && (this.x = typeof m === 'undefined' ? h.autoIncrement(this) : m)
        return this
      }
      a.prototype.destroy = function () {
        function a () {
        ...
        const k = l.hoverPoints
        const g = n(f.series.chart.renderer.globalAnimation)
        let d
      ...
      a.prototype.getClassName = function () {
        return (
          'highcharts-point' +
                    ...
                    (typeof this.colorIndex !== 'undefined' ? ' highcharts-color-' + this.colorIndex : '') +
      ...
      a.prototype.getNestedProperty = function (a) {
        if (a) return a.indexOf('custom.') === 0 ? H(a, this.options) : this[a]
      }
      ...
      a.prototype.optionsToObject = function (f) {
        let m = {}
        let h = this.series
        const l = h.options.keys
        const k = l || h.pointArrayMap || ['y']
        const g = k.length
        let d = 0
        let p = 0
        if (L(f) || f === null) m[k[0]] = f
        else if (v(f)) {
          for (
            !l && f.length > g && ((h = typeof f[0]), h === 'string' ? (m.name = f[0]) : h === 'number' && (m.x = f[0]), d++);
            p < g;

          ) {
            (l && typeof f[d] === 'undefined') ||
                            (k[p].indexOf('.') > 0 ? a.prototype.setNestedProperty(m, f[d], k[p]) : (m[k[p]] = f[d])),
            d++,
            p++
          }
        } else typeof f === 'object' && ((m = f), f.dataLabels && (h._hasPointLabels = !0), f.marker && (h._hasPointMarkers = !0))
        return m
      }
      a.prototype.resolveColor = function () {
        const a = this.series
        let f = a.chart.options.chart.colorCount
        let h = a.chart.styledMode
      ...
      a.prototype.tooltipFormatter = function (a) {
        const f = this.series
        const h = f.tooltipOptions
        const l = E(h.valueDecimals, '')
        const k = h.valuePrefix || ''
        const g = h.valueSuffix || ''
  ...
  O(
    ...
    function (f, a, n, y, D, G) {
      const C = n.defaultOptions
      const J = G.addEvent
      const H = G.animObject
      const v = G.arrayMax
      const L = G.arrayMin
      const q = G.clamp
      const K = G.correctFloat
      const E = G.defined
      const p = G.erase
      const t = G.error
      const I = G.extend
      const u = G.find
      const m = G.fireEvent
      const h = G.getNestedProperty
      const l = G.isArray
      const k = G.isFunction
      const g = G.isNumber
      const d = G.isString
      const x = G.merge
      const r = G.objectEach
      const A = G.pick
      const N = G.removeEvent
      n = G.seriesType
      const B = G.splat
      const M = G.syncTimeout;
      ('')
      const R = f.seriesTypes
      const F = f.win
      f.Series = n(
        'line',
        null,
        {
          ...
          dataLabels: {
            ...
            defer: !0,
            formatter: function () {
              const e = this.series.chart.numberFormatter
        ...
        },
        {
            ...
            m(this, 'bindAxes', null, function () {
              (e.axisTypes || []).forEach(function (d) {
                b[d].forEach(function (b) {
                  ...
                  if (
                    c[d] === a.index ||
                                        (typeof c[d] !== 'undefined' && c[d] === a.id) ||
                                        (typeof c[d] === 'undefined' && a.index === 0)
          ...
          updateParallelArrays: function (e, c) {
            ...
            const d = g(c)
              ? function (a) {
                const d = a === 'y' && b.toYData ? b.toYData(e) : e[a]
                b[a + 'Data'][c] = d
              }
              : function (e) {
          ...
          hasData: function () {
            return (
              (this.visible && typeof this.dataMax !== 'undefined' && typeof this.dataMin !== 'undefined') ||
                            (this.visible && this.yData && this.yData.length > 0)
            )
          },
          autoIncrement: function () {
            let e = this.options
            let c = this.xIncrement
            let b
            const a = e.pointIntervalUnit
            const d = this.chart.time
            ...
            a &&
                            ...
                            a === 'day'
                              ...
                              : a === 'month'
                                ...
                                : a === 'year' && d.set('FullYear', e, d.get('FullYear', e) + b),
                            (b = e.getTime() - c))
            this.xIncrement = c + b
            return c
          },
          ...
          setOptions: function (e) {
            ...
            e = x(e)
            c = c.styledMode
            const g = { plotOptions: a, userOptions: e }
            m(this, 'setOptions', g)
            const h = g.plotOptions[this.type]
            const f = d.plotOptions || {}
          ...
          getCyclic: function (e, c, b) {
            ...
            const g = e + 'Index'
            const h = e + 'Counter'
            const f = b ? b.length : A(a.options.chart[e + 'Count'], a[e + 'Count'])
            if (!c) {
              var k = A(d[g], d['_' + g])
              E(k) || (a.series.length || (a[h] = 0), (d['_' + g] = k = a[h] % f), (a[h] += 1))
              b && (c = b[k])
            }
            typeof k !== 'undefined' && (this[g] = k)
            this[e] = c
          },
          getColor: function () {
            this.chart.styledMode
              ...
              : this.options.colorByPoint
                ...
                : this.getCyclic('color', this.options.color || C.plotOptions[this.type].color, this.chart.options.colors)
          },
          ...
          findPointIndex: function (e, c) {
            ...
            const d = this.points
            let h
            const f = this.options.dataSorting
            if (b) var k = this.chart.get(b)
            else if (this.linkedParent || this.enabledDataSorting) {
              const l = f && f.matchByName ? 'name' : 'index'
              k = u(d, function (b) {
            ...
            if (k) {
              var m = k && k.index
              typeof m !== 'undefined' && (h = !0)
            }
            typeof m === 'undefined' && g(a) && (m = this.xData.indexOf(a, c))
            m !== -1 && typeof m !== 'undefined' && this.cropped && (m = m >= this.cropStart ? m - this.cropStart : m)
          ...
          updateData: function (e, c) {
            const b = this.options
            const a = b.dataSorting
            const d = this.points
            const h = []
            let f
            let k
            let l
            const m = this.requireSorting
            const p = e.length === d.length
            let r = !0
            this.xIncrement = null
            e.forEach(function (c, e) {
              const k = (E(c) && this.pointClass.prototype.optionsToObject.call({ series: this }, c)) || {}
              let w = k.x
              if (k.id || g(w)) {
                if (
                  ((w = this.findPointIndex(k, l)),
                  w === -1 || typeof w === 'undefined'
                    ? h.push(c)
                    : d[w] && c !== b.data[w]
          ...
          setData: function (e, c, b, a) {
            ...
            const p = h.options
            const r = h.chart
            const B = p.dataSorting
            let z = null
            const n = h.xAxis
            z = p.turboThreshold
            const q = this.xData
            const x = this.yData
            const F = (m = h.pointArrayMap) && m.length
            const M = p.keys
            let v = 0
            let u = 1
            let I
            ...
            if (!I) {
              ...
              if (z && m > z) {
                if (((z = h.getFirstValidPoint(e)), g(z))) { for (b = 0; b < m; b++) (q[b] = this.autoIncrement()), (x[b] = e[b]) } else if (l(z)) {
                  if (F) for (b = 0; b < m; b++) (a = e[b]), (q[b] = a[0]), (x[b] = a.slice(1, F + 1))
                  else {
                    for (
                      M && ((v = M.indexOf('x')), (u = M.indexOf('y')), (v = v >= 0 ? v : 0), (u = u >= 0 ? u : 1)),
                      b = 0;
                      b < m;
                      b++
            ...
            p.legendType === 'point' && (this.processData(), this.generatePoints())
            c && r.redraw(b)
          },
          sortData: function (e) {
            const c = this
            const b = c.options.dataSorting.sortKey || 'y'
          ...
          getProcessedData: function (e) {
            ...
            let g = this.xAxis
            let h = this.options
            let f = h.cropThreshold
            const k = e || this.getExtremesFromAll || h.getExtremesFromAll
            const l = this.isCartesian
            e = g && g.val2lin
            h = !(!g || !g.logarithmic)
            ...
            for (f = c.length || 1; --f;) {
              if (((a = h ? e(c[f]) - e(c[f - 1]) : c[f] - c[f - 1]), a > 0 && (typeof n === 'undefined' || a < n))) { var n = a } else a < 0 && m && (t(15, !1, this.chart), (m = !1))
            }
            return {
              xData: c,
              yData: b,
          ...
          generatePoints: function () {
            ...
            let b = this.data
            let a
            const d = this.processedXData
            const g = this.processedYData
            const h = this.pointClass
            const f = d.length
            const k = this.cropStart || 0
            const l = this.hasGroupedData
            e = e.keys
            const p = []
            let r
            ...
            for (r = 0; r < f; r++) {
              ...
              } else (n = b[t]) || typeof c[t] === 'undefined' || (b[t] = n = new h().init(this, c[t], d[r]))
              n && ((n.index = t), (p[r] = n))
            }
            this.options.keys = e
          ...
          getExtremes: function (e, c) {
            ...
            let k = 0
            let p = 0
            const r = this.requireSorting ? this.cropShoulder : 0
            const t = a ? a.positiveValuesOnly : !1
            let B
          ...
          getFirstValidPoint: function (e) {
            for (var c = null, b = e.length, a = 0; c === null && a < b;) (c = e[a]), a++
            return c
          },
          translate: function () {
            ...
            const d = this.enabledDataSorting
            const h = this.yAxis
            const f = this.points
            const k = f.length
            const p = !!this.modifyValue
            let r
            const t = this.pointPlacementToXValue()
            const B = !!t
            const n = e.threshold
            const x = e.startFromThreshold ? n : 0
            let F
            const M = this.zoneAxis || 'y'
            ...
            for (r = 0; r < k; r++) {
              ...
              let C = u.y
              let H = u.low
              const R = c && h.stacking && h.stacking.stacks[(this.negStacks && C < (x ? 0 : n) ? '-' : '') + this.stackKey]
              if (
                (h.positiveValuesOnly && !h.validatePositiveValue(C)) ||
                                (b.positiveValuesOnly && !b.validatePositiveValue(I))
              ) { u.isNull = !0 }
              u.plotX = F = K(q(b.translate(I, 0, 0, 0, 1, t, this.type === 'flags'), -1e5, 1e5))
              ...
              l(D) &&
                                ...
                                h.positiveValuesOnly && H <= 0 && (H = null),
              ...
              u.plotY = typeof C === 'number' && Infinity !== C ? q(h.translate(C, 0, 1, 0, 1), -1e5, 1e5) : void 0
              u.isInside = this.isPointInside(u)
              u.clientX = B ? K(b.translate(I, 0, 0, 0, 1, t)) : F
              u.negative = u[M] < (e[M + 'Threshold'] || n || 0)
              u.category = a && typeof a[u.x] !== 'undefined' ? a[u.x] : u.x
              if (!u.isNull && !1 !== u.visible) {
                typeof G !== 'undefined' && (v = Math.min(v, Math.abs(F - G)))
                var G = F
              }
          ...
          getClipBox: function (e, c) {
            ...
            const d = a.inverted
            const g = this.xAxis
            const h = g && this.yAxis
            const f = a.options.chart.scrollablePlotArea || {}
            e && !1 === b.clip && h
              ? (e = d
                  ? {
          ...
          setClip: function (e) {
            ...
            const a = c.renderer
            const d = c.inverted
            const g = this.clipBox
            const h = this.getClipBox(e)
            const f = this.sharedClipKey || ['_sharedClip', e && e.duration, e && e.easing, h.height, b.xAxis, b.yAxis].join()
            let k = c[f]
            let l = c[f + 'm']
          ...
          animate: function (e) {
            const c = this.chart
            const b = H(this.options.animation)
            if (!c.hasRendered) {
              if (e) this.setClip(b)
              else {
                const a = this.sharedClipKey
                e = c[a]
                const d = this.getClipBox(b, !0)
                e && e.animate(d, b)
          ...
          drawPoints: function () {
            ...
            let b
            let a
            const d = this.options.marker
            const g = this[this.specialGroup] || this.markerGroup
            const h = this.xAxis
            const f = A(d.enabled, !h || h.isRadial ? !0 : null, this.closestPointRangePx >= d.enabledThreshold * d.radius)
            if (!1 !== d.enabled || this._hasPointMarkers) {
              for (b = 0; b < e.length; b++) {
                const k = e[b]
                let l = (a = k.graphic) ? 'animate' : 'attr'
                const m = k.marker || {}
                const p = !!k.marker
                if (((f && typeof m.enabled === 'undefined') || m.enabled) && !k.isNull && !1 !== k.visible) {
                  const r = A(m.symbol, this.symbol)
                  const t = this.markerAttribs(k, k.selected && 'select')
                  this.enabledDataSorting && (k.startXPos = h.reversed ? -t.width : h.width)
                  const B = !1 !== k.isInside
                  a
                    ? a[B ? 'show' : 'hide'](B).animate(t)
                    : B &&
                                          (t.width > 0 || k.hasImage) &&
                  ...
                  a && l === 'animate' && a[B ? 'show' : 'hide'](B).animate(t)
          ...
          markerAttribs: function (e, c) {
            ...
            let a = b.marker
            const d = e.marker || {}
            const g = d.symbol || a.symbol
            let h = A(d.radius, a.radius)
            c &&
                            ((a = a.states[c]),
                            (c = d.states && d.states[c]),
                            (h = A(c && c.radius, a && a.radius, h + ((a && a.radiusPlus) || 0))))
            e.hasImage = g && g.indexOf('url') === 0
            e.hasImage && (h = 0)
            e = {
          ...
          destroy: function (e) {
            const c = this
            const b = c.chart
            const a = /AppleWebKit\/533/.test(F.navigator.userAgent)
            let d
            let g
            const h = c.data || []
            let f
            ...
            r(c, function (b, c) {
              b instanceof D && !b.survive && ((d = a && c === 'group' ? 'hide' : 'destroy'), b[d]())
            })
            b.hoverSeries === c && (b.hoverSeries = null)
            p(b.series, c)
            b.orderSeries()
            r(c, function (b, a) {
              (e && a === 'hcEvents') || delete c[a]
            })
          },
          ...
          drawGraph: function () {
            const e = this
            const c = this.options
            const b = (this.gappedPath || this.getGraphPath).call(this)
            const a = this.chart.styledMode
            ...
            d.forEach(function (d, g) {
              ...
              f &&
                                ...
                                d[3]
                                  ? (h.dashstyle = d[3])
                                  : c.linecap !== 'square' && (h['stroke-linecap'] = h['stroke-linejoin'] = 'round'),
                                f[k](h).shadow(g < 2 && c.shadow))
          ...
          applyZones: function () {
            ...
            const l = this.graph
            const m = this.area
            const p = Math.max(c.chartWidth, c.chartHeight)
            const r = this[(this.zoneAxis || 'y') + 'Axis']
            const t = c.inverted
            let B
            let n
            let x
            ...
            let u
            let M
            if (d.length && (l || m) && r && typeof r.min !== 'undefined') {
              const v = r.reversed
              const I = r.horiz
              l && !this.showLine && l.hide()
              m && m.hide()
              const E = r.getExtremes()
          ...
          render: function () {
            ...
            const c = a.chart
            const b = a.options
            const d = H(b.animation)
            let g = !a.finishedAnimating && c.renderer.isSVG && d.duration
            const h = a.visible ? 'inherit' : 'hidden'
            const f = b.zIndex
            const k = a.hasRendered
            const l = c.seriesGroup
            const p = c.inverted
            m(this, 'render')
            const r = a.plotGroup('group', 'series', h, f, l)
          ...
          redraw: function () {
            const a = this.chart
            const c = this.isDirty || this.isDirtyData
            const b = this.group
            const d = this.xAxis
            const g = this.yAxis
            b &&
          ...
          buildKDTree: function (a) {
            ...
            var b = this
            const d = b.options.findNearestPointBy.indexOf('y') > -1 ? 2 : 1
            delete b.kdTree
            M(
              function () {
          ...
          searchKDTree: function (a, c, b) {
            function d (b, c, a, k) {
              const l = c.point
              let m = e.kdAxisArray[a % k]
              let p = l
              let r = E(b[g]) && E(l[g]) ? Math.pow(b[g] - l[g], 2) : null
              let t = E(b[h]) && E(l[h]) ? Math.pow(b[h] - l[h], 2) : null
              t = (r || 0) + (t || 0)
            ...
            var e = this
            var g = this.kdAxisArray[0]
            var h = this.kdAxisArray[1]
            var f = c ? 'distX' : 'dist'
            c = e.options.findNearestPointBy.indexOf('y') > -1 ? 2 : 1
            this.kdTree || this.buildingKdTree || this.buildKDTree(b)
            if (this.kdTree) return d(a, this.kdTree, c, c)
          },
          pointPlacementToXValue: function () {
            let a = this.options
            const c = a.pointRange
            const b = this.xAxis
            a = a.pointPlacement
            a === 'between' && (a = b.reversed ? -0.5 : 0.5)
            return g(a) ? a * A(c, b.pointRange) : 0
          },
          isPointInside: function (a) {
            return (
              typeof a.plotY !== 'undefined' &&
                            typeof a.plotX !== 'undefined' &&
                            a.plotY >= 0 &&
  ...
  O(
    ...
    [n['Core/Axis/Axis.js'], n['Core/Chart/Chart.js'], n['Core/Globals.js'], n['Core/Axis/StackingAxis.js'], n['Core/Utilities.js']],
    function (f, a, n, y, D) {
      const G = D.correctFloat
      const C = D.defined
      const J = D.destroyObjectProperties
      const H = D.format
      const v = D.isNumber
      const L = D.pick;
      ('')
      ...
      const K = (function () {
        ...
        a.prototype.setOffset = function (a, f, n, u, m) {
          let h = this.axis
          let l = h.chart
          u = h.translate(h.stacking.usePercentage ? 100 : u || this.total, 0, 0, 0, 1)
          n = h.translate(n || 0)
          n = C(u) && Math.abs(u - n)
          ...
          f = this.label
          n = this.isNegative
          a = L(this.options.overflow, 'justify') === 'justify'
          let k = this.textAlign
          f &&
                            h &&
                            ((m = f.getBBox()),
                            (u = f.padding),
        ...
        a.prototype.getStackBox = function (a, f, n, q, m, h, l) {
          ...
          const g = a.inverted
          const d = l.height + l.pos - (g ? a.plotLeft : a.plotTop)
      ...
      a.prototype.getStacks = function () {
        ...
        a.series.forEach(function (p) {
          const n = (p.xAxis && p.xAxis.options) || {}
          !p.options.stacking ||
      ...
      q.prototype.setStackedPoints = function (a) {
        const f = a || this.options.stacking
        if (f && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
          const n = this.processedXData
          const q = this.processedYData
          const u = []
          const m = q.length
          let h = this.options
          const l = h.threshold
          const k = L(h.startFromThreshold && l, 0)
          h = h.stack
          a = a ? this.type + ',' + f : this.stackKey
          const g = '-' + a
          const d = this.negStacks
          const x = this.yAxis
          const r = x.stacking.stacks
          const A = x.stacking.oldStacks
          let v
          let B
          ...
          for (B = 0; B < m; B++) {
            ...
            E !== null
              ? ((c.points[e] = c.points[this.index] = [L(c.cumulative, k)]),
                ...
                F.index > 0 && !1 === this.singleStacks && (c.points[e][0] = c.points[this.index + ',' + M + ',0'][0]))
            ...
            f === 'percent'
              ...
              : f === 'group'
                ? E !== null && (c.total = (c.total || 0) + 1)
                : (c.total = G(c.total + (E || 0)))
            c.cumulative = f === 'group' ? (c.total || 1) - 1 : L(c.cumulative, k) + (E || 0)
            E !== null && (c.points[e].push(c.cumulative), (u[B] = c.cumulative), (c.hasValidPoints = !0))
          }
          f === 'percent' && (x.stacking.usePercentage = !0)
          f !== 'group' && (this.stackedYData = u)
      ...
      q.prototype.modifyStacks = function () {
        const a = this
        const f = a.stackKey
        const n = a.yAxis.stacking.stacks
        const q = a.processedXData
        let v
        const m = a.options.stacking
        a[m + 'Stacker'] &&
  ...
  O(
    ...
    function (f, a, n, y, D, G, C) {
      ...
      const l = C.isString
      const k = C.merge
      const g = C.objectEach
      const d = C.pick
      const x = C.relativeLength
      const r = C.setAnimation
      const A = C.splat
      y = n.Series
      const N = n.seriesTypes
      ...
      t(a.prototype, {
        ...
        createAxis: function (a, g) {
          ...
          const e = g.redraw
          const c = g.animation
          g = k(g.axis, { index: this[a].length, isX: a === 'xAxis' })
          const b = l ? new n.ColorAxis(this, g) : new f(this, g)
          h[a] = A(h[a] || {})
          h[a].push(g)
          l &&
        ...
        showLoading: function (a) {
          ...
          f ||
                        ((g.loadingDiv = f = L('div', { className: 'highcharts-loading highcharts-loading-hidden' }, null, g.container)),
        ...
        update: function (a, h, f, p) {
          ...
          if ((b = a.chart)) {
            ...
            'alignTicks' in b && (F = !0)
            g(b, function (b, a) {
              e.propsRequireUpdateSeries.indexOf('chart.' + a) !== -1 && (r = !0)
              e.propsRequireDirtyBox.indexOf(a) !== -1 && (e.isDirtyBox = !0)
              e.propsRequireReflow.indexOf(a) !== -1 && (t ? (e.isDirtyBox = !0) : (q = !0))
            })
          ...
          g(a, function (b, a) {
            if (e[a] && typeof e[a].update === 'function') e[a].update(b, !1)
            else if (typeof e[c[a]] === 'function') e[c[a]](b)
            a !== 'chart' && e.propsRequireUpdateSeries.indexOf(a) !== -1 && (r = !0)
          })
      ...
      t(D.prototype, {
        update: function (a, g, f, k) {
          function e () {
            c.applyOptions(a)
            let e = l && c.hasDummyGraphic
            e = c.y === null ? !e : e
            l && e && ((c.graphic = l.destroy()), delete c.hasDummyGraphic)
            h(a, !0) &&
                            (l && l.element && a && a.marker && typeof a.marker.symbol !== 'undefined' && (c.graphic = l.destroy()),
            ...
            r.legendType === 'point' && (p.isDirtyLegend = !0)
            g && p.redraw(f)
          }
          var c = this
          var b = c.series
      ...
      t(y.prototype, {
        ...
        update: function (a, g) {
          ...
          const f = h.chart
          let e = h.userOptions
          const c = h.initialType || h.type
          const b = a.type || e.type || f.options.chart.type
          const l = !(
            this.hasDerivedData ||
                            a.dataGrouping ||
                            (b && b !== this.type) ||
                            typeof a.pointStart !== 'undefined' ||
                            a.pointInterval ||
                            a.pointIntervalUnit ||
                            a.keys
          )
          ...
          let r
          let q = ['eventOptions', 'navigatorSeries', 'baseSeries']
          const x = h.finishedAnimating && { animation: !1 }
          const B = {}
          l &&
                        (q.push(
                          'data',
          ...
          a = k(
            ...
            x,
            {
              index: typeof e.index === 'undefined' ? h.index : e.index,
      ...
      t(f.prototype, {
        update: function (a, h) {
          ...
          g(f.options[this.coll].events, function (a, c) {
            typeof l[c] === 'undefined' && (l[c] = void 0)
          })
          this.destroy(!0)
      ...
      a(
        ...
        { threshold: 0 },
        {
          ...
          getStackPoints: function (a) {
            ...
            const q = this.xAxis
            const H = this.yAxis
            const E = H.stacking.stacks[this.stackKey]
            const p = {}
            const t = this.index
            const I = H.series
            const u = I.length
            const m = C(H.options.reversedStacks, !0) ? 1 : -1
            let h
            a = a || this.points
            if (this.options.stacking) {
              for (h = 0; h < a.length; h++) (a[h].leftNull = a[h].rightNull = void 0), (p[a[h].x] = a[h])
              G(E, function (a, g) {
                a.total !== null && n.push(g)
              })
              n.sort(function (a, g) {
                return a - g
              })
              const l = I.map(function (a) {
                return a.visible
              })
              n.forEach(function (a, g) {
                ...
                if (p[a] && !p[a].isNull) {
                  ...
                  [-1, 1].forEach(function (d) {
                    const f = d === 1 ? 'rightNull' : 'leftNull'
                    let q = 0
                    const x = E[n[g + d]]
                    if (x) {
                      for (h = t; h >= 0 && h < u;) {
                        (k = x.points[h]),
                        k ||
                                                            (h === t ? (p[a][f] = !0) : l[h] && (r = E[a].points[h]) && (q -= r[1] - r[0])),
                        (h += m)
                      }
                    }
          ...
          getGraphPath: function (a) {
            let f = J.prototype.getGraphPath
            let n = this.options
            const q = n.stacking
            const y = this.yAxis
            let E
            ...
            const t = []
            const I = this.index
            const u = y.stacking.stacks[this.stackKey]
            const m = n.threshold
            const h = Math.round(y.getThreshold(n.threshold))
            n = C(n.connectNulls, q === 'percent')
            const l = function (d, f, k) {
              let l = a[d]
              d = q && u[l.x].points[I]
              const r = l[k + 'Null'] || 0
              k = l[k + 'Cliff'] || 0
              ...
              typeof n !== 'undefined' &&
                                (t.push({
                                  plotX: g,
                                  plotY: n === null ? h : y.getThreshold(n),
                                  isNull: l,
                                  isCliff: !0
                                }),
                                p.push({
                                  plotX: g,
                                  plotY: x === null ? h : y.getThreshold(x),
                                  doCurve: !1
                                }))
            }
            a = a || this.points
          ...
          drawGraph: function () {
            ...
            const a = this
            const f = this.areaPath
            const n = this.options
            const q = [['area', 'highcharts-area', this.color, n.fillColor]]
      ...
      a(
        ...
        },
        {
          ...
          getColumnMetrics: function () {
            ...
            const n = a.xAxis
            const v = a.yAxis
            let m = n.options.reversedStacks
            ...
            !1 === f.grouping
              ...
              : a.chart.series.forEach(function (d) {
                ...
                if (
                  ...
                  if (f.stacking && f.stacking !== 'group') {
                    h = d.stackKey
                    typeof l[h] === 'undefined' && (l[h] = k++)
                    var m = l[h]
          ...
          translate: function () {
            ...
            const f = a.chart
            const n = a.options
            let u = (a.dense = a.closestPointRange * a.xAxis.transA < 2)
            u = a.borderWidth = q(n.borderWidth, u ? 0 : 1)
            const m = a.xAxis
            const h = a.yAxis
            const l = n.threshold
            let k = (a.translatedThreshold = h.getThreshold(l))
            const g = q(n.minPointLength, 5)
            const d = a.getColumnMetrics()
            const x = d.width
            let r = (a.barW = Math.max(x, 1 + 2 * u))
            const A = (a.pointXOffset = d.offset)
            const y = a.dataMin
            const B = a.dataMax
            f.inverted && (k -= 0.5)
            ...
            a.points.forEach(function (p) {
              const t = q(p.yBottom, k)
              let F = 999 + Math.abs(t)
              let e = x
              const c = p.plotX || 0
              ...
              let u = r
              let w = Math.min(F, t)
              let E = Math.max(F, t) - w
              if (g && Math.abs(E) < g) {
                E = g
                let M = (!h.reversed && !p.negative) || (h.reversed && p.negative)
          ...
          pointAttribs: function (a, f) {
            ...
            let m = n.stroke || 'borderColor'
            const h = n['stroke-width'] || 'borderWidth'
            let l = (a && a.color) || this.color
            let k = (a && a[m]) || p[m] || this.color || l
            let g = (a && a[h]) || p[h] || this[h] || 0
            n = (a && a.options.dashStyle) || p.dashStyle
            let d = q(a && a.opacity, p.opacity, 1)
            ...
            f &&
                            ...
                            (f = a.brightness),
                            (l = a.color || (typeof f !== 'undefined' && D(l).brighten(a.brightness).get()) || l),
                            (k = a[m] || k),
                            (g = a[h] || g),
                            (n = a.dashStyle || n),
                            (d = q(a.opacity, d)))
          ...
          drawPoints: function () {
            ...
            const n = a.options
            const q = f.renderer
            const m = n.animationLimit || 250
            let h
            a.points.forEach(function (l) {
              let k = l.graphic
              let g = !!k
              let d = k && f.pointCount < m ? 'animate' : 'attr'
              if (v(l.plotY) && l.y !== null) {
                h = l.shapeArgs
          ...
          animate: function (a) {
            ...
            const p = this.yAxis
            const n = f.options
            const m = this.chart.inverted
            const h = {}
            const l = m ? 'translateX' : 'translateY'
            if (a) {
              (h.scaleY = 0.001),
  ...
  O(n, 'Mixins/CenteredSeries.js', [n['Core/Globals.js'], n['Core/Utilities.js']], function (f, a) {
    const n = a.isNumber
    const y = a.pick
    const D = a.relativeLength
    const G = f.deg2rad
    return (f.CenteredSeriesMixin = {
      getCenter: function () {
        let a = this.options
        let n = this.chart
        const H = 2 * (a.slicedOffset || 0)
        const v = n.plotWidth - 2 * H
        const G = n.plotHeight - 2 * H
        let q = a.center
        const K = Math.min(v, G)
        let E = a.size
        let p = a.innerSize || 0
        ...
        a = [
          y(q[0], '50%'),
          y(q[1], '50%'),
          y(E && E < 0 ? void 0 : a.size, '100%'),
          y(p && p < 0 ? void 0 : a.innerSize || 0, '0%')
        ]
        !n.angular || this instanceof f.Series || (a[3] = 0)
        for (q = 0; q < 4; ++q) { (E = a[q]), (n = q < 2 || (q === 2 && /%$/.test(E))), (a[q] = D(E, [v, G, K, a[2]][q]) + (n ? H : 0)) }
        a[3] > a[2] && (a[3] = a[2])
        return a
      },
      getStartAndEndRadians: function (a, f) {
        a = n(a) ? a : 0
        f = n(f) && f > a && f - a < 360 ? f : a + 360
  ...
  O(
    ...
    function (f, a, n, y, D, G) {
      ...
      const q = D.merge
      const K = D.pick
      const E = D.relativeLength
      const p = D.seriesType
      const t = D.setAnimation
      const I = G.getStartAndEndRadians
      D = f.noop
      const u = f.Series
      p(
        'pie',
        ...
        },
        {
          ...
          updateTotals: function () {
            ...
            const l = this.points
            const k = l.length
            const g = this.options.ignoreHiddenPoint
            for (a = 0; a < k; a++) {
              var d = l[a]
              f += g && !d.visible ? 0 : d.isNull ? 0 : d.y
            }
            this.total = f
            for (a = 0; a < k; a++) { (d = l[a]), (d.percentage = f > 0 && (d.visible || !g) ? (d.y / f) * 100 : 0), (d.total = f) }
          },
          generatePoints: function () {
          ...
          getX: function (a, f, l) {
            const h = this.center
            const g = this.radii ? this.radii[l.index] : h[2] / 2
            a = Math.asin(J((a - h[1]) / (g + l.labelDistance), -1, 1))
            return (
              h[0] +
                            (f ? -1 : 1) * Math.cos(a) * (g + l.labelDistance) +
                            (l.labelDistance > 0 ? (f ? -1 : 1) * this.options.dataLabels.padding : 0)
            )
          },
          translate: function (a) {
            ...
            let f = 0
            let l = this.options
            const k = l.slicedOffset
            const g = k + (l.borderWidth || 0)
            let d = I(l.startAngle, l.endAngle)
            const m = (this.startAngleRad = d.start)
            d = (this.endAngleRad = d.end) - m
            const n = this.points
            const p = l.dataLabels.distance
            ...
            for (q = 0; q < t; q++) {
              ...
              const e = (Math.cos(F) * a[2]) / 2
              const c = (Math.sin(F) * a[2]) / 2
              ...
              u.labelPosition = {
                ...
                final: {},
                alignment: u.labelDistance < 0 ? 'center' : u.half ? 'right' : 'left',
                connectorPosition: {
                  breakAt: {
          ...
          drawEmpty: function () {
            const f = this.startAngleRad
            const h = this.endAngleRad
            const l = this.options
            if (this.total === 0 && this.center) {
              const k = this.center[0]
              const g = this.center[1]
              this.graph ||
          ...
          sortByAngle: function (a, f) {
            a.sort(function (a, h) {
              return typeof a.angle !== 'undefined' && (h.angle - a.angle) * f
            })
          },
          drawLegendSymbol: n.drawRectangle,
        ...
        },
        {
          ...
          isValid: function () {
            return L(this.y) && this.y >= 0
          },
          setVisible: function (a, f) {
            const h = this
            const k = h.series
            const g = k.chart
            const d = k.options.ignoreHiddenPoint
            f = K(f, d)
            a !== h.visible &&
                            ((h.visible = h.options.visible = a = typeof a === 'undefined' ? !h.visible : a),
          ...
          connectorShapes: {
            fixedOffset: function (a, f, l) {
              ...
              return [
                ['M', a.x, a.y],
                l.softConnector
                  ? ['C', a.x + (a.alignment === 'left' ? -5 : 5), a.y, 2 * h.x - f.x, 2 * h.y - f.y, h.x, h.y]
                  : ['L', h.x, h.y],
                ['L', f.x, f.y]
              ]
            },
            ...
            crookedLine: function (a, f, l) {
              ...
              let h = this.series
              let g = h.center[0]
              let d = h.chart.plotWidth
              const m = h.chart.plotLeft
              h = a.alignment
              const n = this.shapeArgs.r
              l = E(l.crookDistance, 1)
              d = h === 'left' ? g + n + (d + m - g - n) * (1 - l) : m + (g - n) * l
              l = ['L', d, a.y]
              g = !0
              if (h === 'left' ? d > a.x || d < f.x : d < a.x || d > f.x) g = !1
              a = [['M', a.x, a.y]]
              g && a.push(l)
              a.push(['L', f.x, f.y])
              return a
          ...
          getConnectorPath: function () {
            ...
            const f = this.series.options.dataLabels
            let l = f.connectorShape
            const k = this.connectorShapes
            k[l] && (l = k[l])
  ...
  O(n, 'Core/Series/DataLabels.js', [n['Core/Globals.js'], n['Core/Utilities.js']], function (f, a) {
    ...
    const H = a.fireEvent
    const v = a.format
    const L = a.getDeferredAnimation
    const q = a.isArray
    const K = a.merge
    const E = a.objectEach
    const p = a.pick
    const t = a.relativeLength
    const I = a.splat
    const u = a.stableSort
    const m = f.Series
      ...
      a.some(function (a) {
        ...
        if (
          a.targets.some(function () {
            m[d].pos = a.pos + g
            if (typeof k !== 'undefined' && Math.abs(m[d].pos - m[d].target) > k) {
              return (
    ...
    m.prototype.drawDataLabels = function () {
      ...
      if (q(m) || m.enabled || k._hasPointLabels) {
        const D = k.plotGroup('dataLabelsGroup', 'data-labels', u ? 'inherit' : 'hidden', m.zIndex || 6)
        D.attr({ opacity: +u })
        ...
        n.forEach(function (h) {
          ...
          t.forEach(function (e, c) {
            const b = e.enabled && (!h.isNull || h.dataLabelOnNull) && a(h, e)
            let f = h.dataLabels ? h.dataLabels[c] : h.dataLabel
            const l = h.connectors ? h.connectors[c] : h.connector
            const m = p(e.distance, h.labelDistance)
            const n = !f
            if (b) {
            ...
            !f || (b && C(r))
              ...
              : ((h.dataLabel = h.dataLabel && h.dataLabel.destroy()),
                h.dataLabels && (h.dataLabels.length === 1 ? delete h.dataLabels : delete h.dataLabels[c]),
                c || delete h.dataLabel,
                l &&
                                  ((h.connector = h.connector.destroy()),
                                  h.connectors && (h.connectors.length === 1 ? delete h.connectors : delete h.connectors[c])))
          })
        })
      }
    ...
    m.prototype.alignDataLabel = function (a, f, k, g, d) {
      const h = this
      const l = this.chart
      const m = this.isCartesian && l.inverted
      const n = this.enabledDataSorting
      let q = p(a.dlBox && a.dlBox.centerX, a.plotX, -9999)
      const t = p(a.plotY, -9999)
      const v = f.getBBox()
      const u = k.rotation
      const e = k.align
      const c = l.isInsidePlot(q, Math.round(t), m)
      let b = p(k.overflow, n ? 'none' : 'justify') === 'justify'
      let z =
                    this.visible &&
                    !1 !== a.visible &&
                    (a.series.forceDL || (n && !b) || c || (k.inside && g && l.isInsidePlot(q, m ? g.x + 1 : g.y + g.height - 1, m)))
      let w = function (e) {
        n && h.xAxis && !b && h.setDataLabelStartPos(a, f, d, c, e)
      }
      if (z) {
        const y = l.renderer.fontMetrics(l.styledMode ? void 0 : k.style.fontSize, f).b
        g = J(
          {
          ...
          ? ((b = !1),
            ...
            e === 'left'
              ...
              : e === 'center'
                ...
                : e === 'right' && ((q.x -= v.width), (q.y -= w ? 0 : v.height)),
            (f.placed = !0),
            (f.alignAttr = q))
    ...
    m.prototype.setDataLabelStartPos = function (a, f, k, g, d) {
      ...
      let m = this.xAxis
      const n = m.reversed
      const p = l ? f.height / 2 : f.width / 2
    ...
    m.prototype.justifyDataLabel = function (a, f, k, g, d, m) {
      const h = this.chart
      const l = f.align
      const n = f.verticalAlign
      const p = a.box ? 0 : a.padding || 0
      let q = f.x
      q = void 0 === q ? 0 : q
      let t = f.y
      let x = void 0 === t ? 0 : t
      t = k.x + p
      if (t < 0) {
        l === 'right' && q >= 0 ? ((f.align = 'left'), (f.inside = !0)) : (q -= t)
        var e = !0
      }
      t = k.x + g.width - p
      t > h.plotWidth && (l === 'left' && q <= 0 ? ((f.align = 'right'), (f.inside = !0)) : (q += h.plotWidth - t), (e = !0))
      t = k.y + p
      t < 0 && (n === 'bottom' && x >= 0 ? ((f.verticalAlign = 'top'), (f.inside = !0)) : (x -= t), (e = !0))
      t = k.y + g.height - p
      t > h.plotHeight &&
                (n === 'top' && x <= 0 ? ((f.verticalAlign = 'bottom'), (f.inside = !0)) : (x += h.plotHeight - t), (e = !0))
    ...
    y.pie &&
            ...
            (y.pie.prototype.drawDataLabels = function () {
              ...
              let k
              const g = a.chart
              const d = a.options.dataLabels || {}
              const n = d.connectorPadding
              let r
              const q = g.plotWidth
              const t = g.plotHeight
              const v = g.plotLeft
              const u = Math.round(g.chartWidth / 3)
              let y
              const F = a.center
              const e = F[2] / 2
              const c = F[1]
              ...
              let L
              const O = [0, 0, 0, 0]
              const S = a.dataLabelPositioners
              let V
              a.visible &&
                    ...
                    H.forEach(function (h, l) {
                      ...
                      if (m) {
                        ...
                        if (a.maxLabelDistance > 0) {
                          var u = Math.max(0, c - e - a.maxLabelDistance)
                          const A = Math.min(c + e + a.maxLabelDistance, g.plotHeight)
                        ...
                        for (L = 0; L < m; L++) {
                          ...
                          r &&
                                    C(k.distributeBox) &&
                                    (typeof k.distributeBox.pos === 'undefined'
                                      ? (J = 'hidden')
                          ...
                          p(d.crop, !0) &&
                                    ...
                                    G - z < n && l === 1
                                      ...
                                      : G + z > q - n && l === 0 && ((u = Math.round(G + z - q + n)), (O[1] = Math.max(u, O[1]))),
                                    I - E / 2 < 0
                    ...
                    this.points.forEach(function (c) {
                      ...
                      if ((r = p(V.connectorWidth, 1))) {
                        let e
                        y = c.connector
                        if ((b = c.dataLabel) && b._pos && c.visible && c.labelDistance > 0) {
            ...
            (y.pie.prototype.verifyDataLabelOverflow = function (a) {
              ...
              const h = this.options
              const g = h.center
              const d = h.minSize || 80
              let m = h.size !== null
              if (!m) {
                if (g[0] !== null) var n = Math.max(f[2] - Math.max(a[1], a[3]), d)
    ...
    y.column &&
            (y.column.prototype.alignDataLabel = function (a, f, k, g, d) {
              const h = this.chart.inverted
              const l = a.series
              let n = a.dlBox || a.shapeArgs
              const q = p(a.below, a.plotY > p(this.translatedThreshold, l.yAxis.len))
              const t = p(k.inside, !!this.options.stacking)
              n &&
                    ((g = K(n)),
                    g.y < 0 && ((g.height += g.y), (g.y = 0)),
                    (n = g.y + g.height - l.yAxis.len),
                    n > 0 && n < g.height && (g.height -= n),
                    h &&
                        (g = {
  ...
  O(n, 'Extensions/OverlappingDataLabels.js', [n['Core/Chart/Chart.js'], n['Core/Utilities.js']], function (f, a) {
    ...
    f.prototype.hideOverlappingLabels = function (a) {
      ...
      let D = function (a) {
        let f
        const h = a.box ? 0 : a.padding || 0
        let g = (f = 0)
        let d
        if (a && (!a.alignAttr || a.placed)) {
          const m = a.alignAttr || { x: a.attr('x'), y: a.attr('y') }
          const n = a.parentGroup
      ...
      for (E = 0; E < n; E++) {
        const u = (D = a[E]) && D.absoluteBox
        for (C = E + 1; C < n; ++C) {
          const m = (p = a[C]) && p.absoluteBox
          !u ||
                        !m ||
                        D === p ||
                        D.newOpacity === 0 ||
  ...
  O(
    ...
    function (f, a, n, y, D, G) {
      const C = y.defaultOptions
      const J = G.addEvent
      const H = G.createElement
      const v = G.css
      const L = G.defined
      const q = G.extend
      const K = G.fireEvent
      const E = G.isArray
      const p = G.isFunction
      const t = G.isNumber
      const I = G.isObject
      const u = G.merge
      const m = G.objectEach
      const h = G.pick
      const l = a.hasTouch
      y = a.Series
      G = a.seriesTypes
      const k = a.svg
      const g = (a.TrackerMixin = {
        drawTrackerPoint: function () {
          const a = this
          const f = a.chart
          const g = f.pointer
          const h = function (a) {
            const d = g.getPointFromEvent(a)
            typeof d !== 'undefined' && ((g.isDirectTouch = !0), d.onMouseOver(a))
          }
          let k
        ...
        drawTrackerGraph: function () {
          const a = this
          const f = a.options
          const g = f.trackByArea
          const h = [].concat(g ? a.areaPath : a.graphPath)
          const m = a.chart
          const n = m.pointer
          const p = m.renderer
          const q = m.options.tooltip.snap
          const t = a.tracker
          const e = function (b) {
            if (m.hoverSeries !== a) a.onMouseOver()
          }
          const c = 'rgba(192,192,192,' + (k ? 0.0001 : 0.002) + ')'
          t
            ? t.attr({ d: h })
            : a.graph &&
                          ((a.tracker = p
      ...
      q(n.prototype, {
        setItemEvents: function (a, f, g) {
          const d = this
          const h = d.chart.renderer.boxWrapper
          const k = a instanceof D
          const l = 'highcharts-legend-' + (k ? 'point' : 'series') + '-active'
          const m = d.chart.styledMode;
      ...
      q(f.prototype, {
        showResetZoom: function () {
          ...
          var f = this
          const g = C.lang
          const h = f.options.chart.resetZoomButton
          const k = h.theme
          const l = k.states
          const m = h.relativeTo === 'chart' || h.relativeTo === 'spaceBox' ? null : 'plotBox'
        ...
        zoom: function (a) {
          ...
          const g = d.pointer
          let k = !1
          const l = d.inverted ? g.mouseDownX : g.mouseDownY
          !a || a.resetSelection
            ...
            : a.xAxis.concat(a.yAxis).forEach(function (a) {
              const h = a.axis
              const e = d.inverted ? h.left : h.top
              const c = d.inverted ? e + h.width : e + h.height
              const b = h.isXAxis
              let m = !1
              if ((!b && l >= e && l <= c) || b || !L(l)) m = !0
              g[b ? 'zoomX' : 'zoomY'] && m && ((f = h.zoom(a.min, a.max)), h.displayBtn && (k = !0))
            })
          const m = d.resetZoomButton
          k && !m ? d.showResetZoom() : !k && I(m) && (d.resetZoomButton = m.destroy())
          f && d.redraw(h(d.options.chart.animation, a && a.animation, d.pointCount < 100))
        },
        pan: function (d, f) {
          const g = this
          const h = g.hoverPoints
          const k = g.options.chart
          const l = g.options.mapNavigation && g.options.mapNavigation.enabled
          let m
          f = typeof f === 'object' ? f : { enabled: f, type: 'x' }
          ...
          K(this, 'pan', { originalEvent: d }, function () {
            ...
            f.forEach(function (e) {
              const c = g[e ? 'xAxis' : 'yAxis'][0]
              let b = c.horiz
              const f = d[b ? 'chartX' : 'chartY']
              b = b ? 'mouseDownX' : 'mouseDownY'
              let h = g[b]
              let k = (c.pointRange || 0) / 2
              let p = (c.reversed && !g.inverted) || (!c.reversed && g.inverted) ? -1 : 1
              const q = c.getExtremes()
              let r = c.toValue(h - f, !0) + k * p
              p = c.toValue(h + c.len - f, !0) - k * p
              let u = p < r
              h = u ? p : r
              r = u ? r : p
              const v = c.hasVerticalPanning()
              let x = c.panningState
              c.series.forEach(function (a) {
                if (v && !e && (!x || x.isDirty)) {
                  const b = a.getProcessedData(!0)
              ...
              p = Math.min(
                a.pick(x === null || void 0 === x ? void 0 : x.startMin, q.dataMin),
                k ? q.min : c.toValue(c.toPixels(q.min) - c.minPixelPadding)
              )
              k = Math.max(
                a.pick(x === null || void 0 === x ? void 0 : x.startMax, q.dataMax),
      ...
      q(D.prototype, {
        ...
        importEvents: function () {
          if (!this.hasImportedEvents) {
            const a = this
            const f = u(a.series.options.point, a.options).events
            a.events = f
            m(f, function (d, f) {
              p(d) && J(a, f, d)
            })
        ...
        setState: function (a, f) {
          const d = this.series
          let g = this.state
          let k = d.options.states[a || 'normal'] || {}
          const l = C.plotOptions[d.type].marker && d.options.marker
          const m = l && !1 === l.enabled
          const n = (l && l.states && l.states[a || 'normal']) || {}
          const p = !1 === n.enabled
          let e = d.stateMarkerGraphic
          const c = this.marker || {}
          const b = d.chart
          let t = d.halo
          let u
          const v = l && d.markerAttribs
          a = a || ''
          if (
            !(
              (a === this.state && !f) ||
            ...
            if (this.graphic) {
              ...
              if (!b.styledMode) {
                const x = d.pointAttribs(this, a)
                const y = h(b.options.chart.animation, k.animation)
            ...
            a && a.size && e && k !== 'hidden' && !this.isCluster
      ...
      q(y.prototype, {
        ...
        setState: function (a, f) {
          ...
          let g = d.options
          const k = d.graph
          const l = g.inactiveOtherPoints
          let m = g.states
          let n = g.lineWidth
          let p = g.opacity
          const e = h(m[a || 'normal'] && m[a || 'normal'].animation, d.chart.options.chart.animation)
          g = 0
          a = a || ''
          if (
            d.state !== a &&
        ...
        setVisible: function (a, f) {
          const d = this
          const g = d.chart
          const h = d.legendItem
          const k = g.options.chart.ignoreHiddenSeries
          const l = d.visible
          const m = (d.visible = a = d.options.visible = d.userOptions.visible = typeof a === 'undefined' ? !l : a)
            ? 'show'
            : 'hide';
        ...
        select: function (a) {
          this.selected = a = this.options.selected = typeof a === 'undefined' ? !this.selected : a
  ...
  O(n, 'Core/Responsive.js', [n['Core/Chart/Chart.js'], n['Core/Utilities.js']], function (f, a) {
    ...
    f.prototype.setResponsive = function (a, f) {
      const q = this.options.responsive
      let y = []
      let p = this.currentResponsive
      !f &&
                q &&
                q.rules &&
                q.rules.forEach(function (a) {
                  typeof a._id === 'undefined' && (a._id = v())
    ...
    f.prototype.currentOptions = function (a) {
      function f (a, q, v, u) {
        let m
        C(a, function (a, l) {
          if (!u && n.collectionsWithUpdate.indexOf(l) > -1) {
