...
(function (T, O) {
  ...
  O(n, 'Core/Utilities.js', [n['Core/Globals.js']], function (f) {
    ...
    function C (b, c) {
      ...
      for (
        b = e.pop();
        typeof b !== 'undefined' && typeof c !== 'undefined' && c !== null;
      ...
      b.prototype.run = function (b, c, e) {
        ...
        b !== c || this.elem['forceAnimate:' + this.prop]
          ...
          : (delete z.curAnim[this.prop],
            z.complete &&
              Object.keys(z.curAnim).length === 0 &&
    ...
    var I = (f.isNumber = function (b) {
      return (
        typeof b === 'number' && !isNaN(b) && Infinity > b && -Infinity < b
      )
    })
    ...
    var X = (f.numberFormat = function (b, c, e, d) {
      ...
      if (c === -1) c = Math.min(w, 20)
        ...
        h >= 0
          ...
          : ((g[0] = g[0].split('.')[0] || 0),
            (b = c < 20 ? (g[0] * Math.pow(10, g[1])).toFixed(c) : 0),
            (g[1] = 0))
      }
      const k = (
    ...
    function (f, a, n) {
      ...
      n = (function () {
        ...
        F.prototype.destroy = function () {
          ...
          if (e.clipPath && w) {
            ...
            [].forEach.call(
              ...
              function (b) {
                b.getAttribute('clip-path').indexOf(g.element.id) > -1 &&
        ...
        F.prototype.init = function (e, c) {
          this.element =
            c === 'span' ? p(c) : D.createElementNS(this.SVG_NS, c)
          this.renderer = e
          h(this, 'afterInit')
        }
        ...
        F.prototype.removeTextOutline = function (e) {
          for (var c = e.length, b; c--;) {
            (b = e[c]),
            b.getAttribute('class') === 'highcharts-text-outline' &&
    ...
    function (f, a) {
      ...
      a = (function () {
        ...
        a.prototype.getLabelPosition = function (a, t, f, u, m, h, l, k) {
          ...
          const B =
              u || g.reserveSpaceDefault
                ? 0
                : -g.labelOffset * (g.labelAlign === 'center' ? 0.5 : 1)
          const M = {}
          D(I) ||
            (I =
              g.side === 0
        ...
        a.prototype.handleOverflow = function (a) {
          ...
          const d = { left: 0, center: 0.5, right: 1 }[
    ...
    function (f, a) {
      ...
      a = (function () {
        ...
        a.prototype.dateFormat = function (a, t, q) {
          ...
          if (!n(t) || isNaN(t)) {
            return (
              ((p = f.defaultOptions.lang) === null || void 0 === p
                ? void 0
                : p.invalidDate) || ''
            )
          }
          ...
          J(p, function (d, g) {
            for (; a.indexOf('%' + g) !== -1;) {
              a = a.replace(
                '%' + g,
                typeof d === 'function' ? d.call(m, t) : d
              )
            }
          })
          ...
          if (n(f)) {
            ...
            g <= q.hour &&
              ...
              h.forEach(function (d) {
                d % 18e5 === 0 &&
                  m.dateFormat('%H%M%S%L', d) === '000000000' &&
                  (l[d] = 'day')
              })
          }
    ...
    function (f, a, n, y, D) {
      ...
      y = (function () {
        ...
        e.prototype.defaultLabelFormatter = function () {
          ...
          typeof f === 'undefined' &&
            (f = Math.abs(b) >= 1e4 ? x(b, -1) : x(b, -1, void 0, ''))
          return f
        }
          ...
          this.isXAxis &&
            ...
            (q(c.min) || q(c.max)
              ...
              : (this.series.forEach(function (b) {
                  a = b.xData
                  for (k = l = b.xIncrement ? 1 : a.length - 1; k > 0; k--) {
                    if (
                      ((h = a[k] - a[k - 1]), typeof g === 'undefined' || h < g)
                    ) { g = h }
                  }
                }),
        ...
        e.prototype.setTickInterval = function (c) {
          ...
          g &&
            (b.positiveValuesOnly &&
              !c &&
              Math.min(b.min, r(b.dataMin, b.min)) <= 0 &&
              E(10, 1, e),
          ...
          b.dateTime ||
            ...
            (b.tickInterval = d(
              ...
              r(
                k.allowDecimals,
                b.tickInterval < 0.5 || void 0 !== this.tickAmount
              ),
              !!this.tickAmount
            ))
        ...
        e.prototype.setTickPositions = function () {
          ...
          this.tickmarkOffset =
            this.categories &&
            c.tickmarkPlacement === 'between' &&
            this.tickInterval === 1
              ? 0.5
              : 0
          this.minorTickInterval =
            e === 'auto' && this.tickInterval ? this.tickInterval / 5 : e
          this.single =
            this.min === this.max &&
            q(this.min) &&
            !this.tickAmount &&
          ...
          this.isLinked ||
            (this.single &&
              ...
              !this.series.some(function (b) {
                return (
                  b.is('heatmap') && b.options.pointPlacement === 'between'
                )
              }) &&
        ...
        e.prototype.setScale = function () {
          ...
          this.series.forEach(function (c) {
            ...
            e =
              e ||
              ((d = c.xAxis) === null || void 0 === d ? void 0 : d.isDirty) ||
              !1
          })
        ...
        e.prototype.tickSize = function (c) {
          ...
          const d = r(
            b[c === 'tick' ? 'tickWidth' : 'minorTickWidth'],
            c === 'tick' && this.isXAxis && !this.categories ? 1 : 0
          )
          if (d && e) {
        ...
        e.prototype.getSlotWidth = function (c) {
          ...
          if (!d) {
            c =
              (b = g === null || void 0 === g ? void 0 : g.style) === null ||
              void 0 === b
                ? void 0
                : b.width
            ...
            c &&
              ...
              b.shortenLabel
                ...
                : B &&
                  !e &&
                  h.whiteSpace !== 'nowrap' &&
                  (B < c.textPxLength || c.element.tagName === 'SPAN')
                  ? ((g.width = B + 'px'),
          ...
          if (c.hasData() || g) {
            ...
            B &&
                k.forEach(function (d, g) {
                  N =
                    typeof k[g + 1] !== 'undefined' ? k[g + 1] + A : c.max - A
                  g % 2 === 0 &&
                    d < c.max &&
                    N <= c.max + (b.polar ? -A : A) &&
        ...
        e.prototype.drawCrosshair = function (c, b) {
          ...
          if (this.crosshair && !1 !== (q(b) || !d)) {
            d
              ? q(b) &&
                (g = r(
                  this.coll !== 'colorAxis' ? b.crosshairPos : null,
        ...
        e.prototype.hasVerticalPanning = function () {
          ...
          return /y/.test(
            ((b =
                (c = this.chart.options.chart) === null || void 0 === c
                  ? void 0
                  : c.panning) ===
              null || void 0 === b
              ? void 0
    ...
    function (f, a) {
      ...
      const C = (function () {
        ...
        a.prototype.getLogTickPositions = function (a, f, n, q) {
          ...
          if (a >= 0.5) { (a = Math.round(a)), (t = v.getLinearTickPositions(a, f, n)) } else if (a >= 0.08) {
            p = Math.floor(f)
            let I, u
            for (
              E =
      ...
      const u = (function () {
        ...
        m.prototype.getAnchor = function (h, a) {
          ...
          this.followPointer && a
            ? (typeof a.chartX === 'undefined' && (a = g.normalize(a)),
            ...
            this.outside &&
              ...
              (this.renderer = g =
                new f.Renderer(
                  ...
                  0,
                  0,
                  (a = this.chart.options.chart) === null || void 0 === a
                    ? void 0
                    : a.style,
                  void 0,
                  void 0,
        ...
        m.prototype.move = function (h, l, k, g) {
          ...
          const m =
              ...
              !d.isHidden &&
              (Math.abs(h - f.x) > 1 || Math.abs(l - f.y) > 1)
      ...
      f = (function () {
          ...
          if (!e || !e.touch) {
            if (
              ...
              e &&
                l &&
                ((k -= c),
                e.attr({ width: Math.abs(k), x: (k > 0 ? 0 : k) + c }))
              e &&
                f &&
                ((k = h - b),
                e.attr({ height: Math.abs(k), y: (k > 0 ? 0 : k) + b }))
        ...
        l.prototype.findNearestKDPoint = function (a, g, d) {
          ...
          a.forEach(function (a) {
            let k =
              !(a.noSharedTooltip && g) &&
              a.options.findNearestPointBy.indexOf('y') < 0
            a = a.searchPoint(d, k)
            if ((k = t(a, !0)) && !(k = !t(l, !0))) {
              k = l.distX - a.distX
        ...
        l.prototype.onContainerMouseDown = function (k) {
          ...
          if (typeof k.button === 'undefined' || g) {
            this.zoomOption(k),
        ...
        a.prototype.getAllItems = function () {
          ...
          this.chart.series.forEach(function (d) {
            ...
            d &&
                ...
                (a = a.concat(
                  d.legendItems || (g.legendType === 'point' ? d.data : d)
                ))
          })
      ...
      const Y = (function () {
        ...
        D.prototype.isInsidePlot = function (b, c, e) {
          ...
          d = {
            ...
            y: b,
            isInsidePlot:
                d >= 0 && d <= this.plotWidth && b >= 0 && b <= this.plotHeight
          }
            ...
            this.axes.forEach(function (f) {
              C[f.side]
                ? (f.getPlotLinePath = function () {
                    ...
                    const p = a.Axis.prototype.getPlotLinePath.apply(
                      this,
                      arguments
                    )
                    this[q] = n
          ...
          ? ((this.fixedDiv = D(
            ...
            (this.fixedRenderer = f =
              new a.Renderer(
                ...
                this.chartWidth,
                this.chartHeight,
                (n = this.options.chart) === null || void 0 === n
                  ? void 0
                  : n.style
              )),
      ...
      a = (function () {
        ...
        a.prototype.applyOptions = function (f, m) {
          ...
          typeof this.x === 'undefined' &&
            h &&
            (this.x = typeof m === 'undefined' ? h.autoIncrement(this) : m)
          return this
        }
        a.prototype.destroy = function () {
          function a () {
        ...
        a.prototype.optionsToObject = function (f) {
          ...
          if (L(f) || f === null) m[k[0]] = f
            ...
            for (
              ...
              f.length > g &&
              ((h = typeof f[0]),
              h === 'string' ? (m.name = f[0]) : h === 'number' && (m.x = f[0]),
              d++);
              p < g;
        ...
        },
        {
          ...
          getProcessedData: function (e) {
            ...
            for (f = c.length || 1; --f;) {
              if (
                ...
                a > 0 && (typeof n === 'undefined' || a < n))
              ) { var n = a } else a < 0 && m && (t(15, !1, this.chart), (m = !1))
            }
            return {
              xData: c,
              yData: b,
          ...
          translate: function () {
            ...
            for (r = 0; r < k; r++) {
              ...
              u.plotX = F = K(
                q(
                  b.translate(I, 0, 0, 0, 1, t, this.type === 'flags'),
                  -1e5,
                  1e5
                )
              )
          ...
          drawPoints: function () {
            ...
            if (!1 !== d.enabled || this._hasPointMarkers) {
              for (b = 0; b < e.length; b++) {
                ...
                const p = !!k.marker
                if (
                  ((f && typeof m.enabled === 'undefined') || m.enabled) &&
                  !k.isNull &&
                  !1 !== k.visible
                ) {
    ...
    function (f, a, n, y, D) {
      ...
      const K = (function () {
        ...
        a.prototype.setOffset = function (a, f, n, u, m) {
          ...
          let l = h.chart
          u = h.translate(
            h.stacking.usePercentage ? 100 : u || this.total,
            0,
            0,
            0,
            1
      ...
      t(a.prototype, {
        ...
        update: function (a, h, f, p) {
          ...
          if ((b = a.chart)) {
            ...
            'alignTicks' in b && (F = !0)
            g(b, function (b, a) {
              e.propsRequireUpdateSeries.indexOf('chart.' + a) !== -1 &&
                (r = !0)
              e.propsRequireDirtyBox.indexOf(a) !== -1 && (e.isDirtyBox = !0)
              e.propsRequireReflow.indexOf(a) !== -1 &&
          ...
          g(a, function (b, a) {
            ...
            a !== 'chart' &&
              e.propsRequireUpdateSeries.indexOf(a) !== -1 &&
              (r = !0)
          })
          ...
          function e () {
            ...
            h(a, !0) &&
              (l &&
                ...
                a &&
                a.marker &&
                typeof a.marker.symbol !== 'undefined' &&
                (c.graphic = l.destroy()),
              a &&
                a.dataLabels &&
                c.dataLabel &&
          ...
          translate: function (a) {
            ...
            for (q = 0; q < t; q++) {
              ...
              u.labelPosition = {
                ...
                final: {},
                alignment:
                  u.labelDistance < 0 ? 'center' : u.half ? 'right' : 'left',
                connectorPosition: {
                  breakAt: {
          ...
          setVisible: function (a, f) {
            ...
            a !== h.visible &&
              ((h.visible =
                h.options.visible =
                a =
                  typeof a === 'undefined' ? !h.visible : a),
  ...
  O(
    ...
    function (f, a) {
      ...
      m.prototype.alignDataLabel = function (a, f, k, g, d) {
        ...
        if (z) {
          const y = l.renderer.fontMetrics(
    ...
    function (f, a, n, y, D, G) {
      ...
      q(f.prototype, {
        showResetZoom: function () {
          ...
          const l = k.states
          const m =
              h.relativeTo === 'chart' || h.relativeTo === 'spaceBox'
                ? null
                : 'plotBox'
        ...
        pan: function (d, f) {
          ...
          K(this, 'pan', { originalEvent: d }, function () {
            ...
            f.forEach(function (e) {
              ...
              p = Math.min(
                a.pick(
                  x === null || void 0 === x ? void 0 : x.startMin,
                  q.dataMin
                ),
              ...
              k = Math.max(
                a.pick(
                  x === null || void 0 === x ? void 0 : x.startMax,
                  q.dataMax
                ),
        ...
        select: function (a) {
          this.selected =
            ...
            this.options.selected =
              typeof a === 'undefined' ? !this.selected : a
