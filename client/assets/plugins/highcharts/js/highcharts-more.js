            ...
            h = (function () {
                ...
                a.init = function (a) {
                    ...
                    a.getPlotLinePath = function (k) {
                        ...
                        else if (((u = p.translate(u)) && (0 > u || u > g) && (u = 0), "circle" === p.options.gridLineInterpolation))
        ...
        g(
            ...
            },
            {
                ...
                getGraphPath: function (a) {
                    ...
                    for (b = a.length; b--; ) {
                        var u = a[b];
                        var A = p ? { plotX: u.rectPlotX, plotY: u.yBottom, doCurve: !1 } : { plotX: u.plotX, plotY: u.plotY, doCurve: !1 };
        ...
        function (d, a, g, h, b) {
            ...
            y(d.prototype, "drawChartBox", function (a, c, f) {
                ...
                if (n && n.options.enabled && n.bubbleLegend && n.options.bubbleLegend.autoRanges && b) {
                    ...
                    a.call(this, c, f), n && n.options.enabled && n.bubbleLegend && (n.render(), n.retranslateItems(n.getLinesHeights()));
            });
            g.BubbleLegend = v;
