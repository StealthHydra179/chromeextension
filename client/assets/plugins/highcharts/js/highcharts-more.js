        ...
        a.init = function (a) {
          ...
          a.getPosition = function (k, p) {
            ...
            return this.postTranslate(
              ...
              l(this.isCircular ? p : 0 > k ? 0 : k, this.center[2] / 2) -
                this.offset,
            );
          };
              ...
              if (p.isRadial) {
                ...
                if (
                  ...
                  15 > h || (180 <= h && 195 > h)
                    ...
                    : 215 < h &&
                      270 >= h &&
                      (v = "start" === b ? f.height : 0.25 * -f.height);
                  15 > g
      ...
      h.prototype.getLinesHeights = function () {
        ...
        for (n = 0; n < f; n++)
          if (
            ...
            var l = c[c.length - 1];
            for (b; b <= n; b++)
              a[b].itemHeight > l.height && (l.height = a[b].itemHeight);
            l.step = n;
          }
        return c;
      };
    ...
    function (d, a, g, h, b, r) {
      ...
      p.toXY = function (a) {
        ...
        h &&
          g &&
          !g.isRadialBar &&
          (a.plotY = e = "number" === typeof l ? d.translate(l) || 0 : 0);
        a.rectPlotX = f;
        a.rectPlotY = e;
            ...
            for (; f--; ) {
              ...
              if (d.inverted) {
                ...
                if (c && e.stacking) {
                  if (
                    ((y =
                      e.stacking.stacks[(0 > y ? "-" : "") + this.stackKey]),
