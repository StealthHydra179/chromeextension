    ...
    e.locale("en"),
        (t.fn[a] = function (e, a) {
            return (
                this.each(function () {
                    t.data(this, s)
                        ? ("function" == typeof t.data(this, s)[e] && t.data(this, s)[e](a), "destroy" === e && delete t.data(this, s))
        ...
        (i.prototype = {
            ...
            initMinutes: function () {
                ...
                for (var t = this.createSVGClock(!1), e = 0; 60 > e; e++) {
                    ...
                    this.toggleTime(e, !1) ? h.addEventListener("click", this._onSelectMinute.bind(this)) : (h.className += " disabled"),
                        t.appendChild(h);
                }
                for (var e = 0; 60 > e; e++)
                    if (e % 5 === 0) {
