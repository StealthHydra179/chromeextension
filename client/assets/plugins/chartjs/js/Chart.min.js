...
!(function (t, e) {
    ...
    function Kt(t, e, i, n) {
        ...
        if (c && "object" == typeof c && ((o = c.toString()), "[object HTMLImageElement]" === o || "[object HTMLCanvasElement]" === o))
            return (
                t.save(), t.translate(i, n), t.rotate(u), t.drawImage(c, -c.width / 2, -c.height / 2, c.width, c.height), void t.restore()
            );
        if (!(isNaN(d) || d <= 0)) {
                ...
                for (i = 0, n = t.length; i < n; ++i)
                    (a = s),
                        ...
                        s &&
                            ...
                            r && ((o.cp2x = _i(o.cp2x, e.left, e.right)), (o.cp2y = _i(o.cp2y, e.top, e.bottom))));
            })(t, i);
    }
    const vi = (t) => 0 === t || 1 === t,
        ...
        ki = {
            ...
            easeInOutExpo: (t) => (vi(t) ? t : t < 0.5 ? 0.5 * Math.pow(2, 10 * (2 * t - 1)) : 0.5 * (2 - Math.pow(2, -10 * (2 * t - 1)))),
            ...
            easeInOutBounce: (t) => (t < 0.5 ? 0.5 * ki.easeInBounce(2 * t) : 0.5 * ki.easeOutBounce(2 * t - 1) + 0.5),
        };
    function Si(t, e, i, n) {
                  ...
                  for (const c of e) {
                      ...
                      for (l = r + 1; l <= c.end; l++) {
                          ...
                          (e = Vi(
                              ...
                              Wi(e, h) && (a.push({ start: r, end: l - 1, loop: c.loop, style: h }), (h = e), (r = l - 1)),
                              (d = o),
                              (h = e);
                      }
    ...
    function Rn(t, e, i) {
        let o = n(t);
        return (
            ((i && "right" !== e) || (!i && "right" === e)) && (o = ((t) => ("left" === t ? "right" : "right" === t ? "left" : t))(o)), o
        );
    }
    class En extends Mn {
        constructor(t) {
        ...
        update(t, e, i) {
            ...
            n._convertTicksToLabels(a ? On(n.ticks, s) : n.ticks),
                ...
                o.display && (o.autoSkip || "auto" === o.source) && ((n.ticks = Pn(n, n.ticks)), (n._labelSizes = null)),
        ...
        fit() {
            ...
            if (a) {
                ...
                if (
                    (r ? ((e.width = t.maxWidth), (e.height = An(s) + a)) : ((e.height = t.maxHeight), (e.width = An(s) + a)),
        ...
        _getYAxisLabelAlignment(t) {
            ...
            return (
                "left" === i
                    ? o
                        ? ((c = e.right + s),
                          "near" === n ? (l = "left") : "center" === n ? ((l = "center"), (c += r / 2)) : ((l = "right"), (c += r)))
                        : ((c = e.right - a),
                          "near" === n ? (l = "right") : "center" === n ? ((l = "center"), (c -= r / 2)) : ((l = "left"), (c = e.left)))
                    : "right" === i
                    ? o
                        ? ((c = e.left + s),
                          "near" === n ? (l = "right") : "center" === n ? ((l = "center"), (c -= r / 2)) : ((l = "left"), (c -= r)))
                        : ((c = e.left + a),
        ...
        drawLabels(t) {
            ...
            for (s = 0, a = o.length; s < a; ++s) {
                const t = o[s],
                    ...
                    n = t.label;
                t.backdrop &&
                    ((i.fillStyle = t.backdrop.color), i.fillRect(t.backdrop.left, t.backdrop.top, t.backdrop.width, t.backdrop.height)),
    ...
    class oo {
        constructor(t, e) {
            ...
            if (r)
                throw new Error(
                    "Canvas is already in use. Chart with ID '" + r.id + "' must be destroyed before the canvas can be reused.",
                );
            ...
            (this.id = j()),
                ...
                (io[n.id] = n),
                c && h
                    ? (a.listen(n, "complete", Jn), a.listen(n, "progress", to), n._initialize(), n.attached && n.update())
        ...
        _updateVisibility(t, e, i) {
            ...
            ht(e)
                ...
                : (n.setDatasetVisibility(t, i), a.update(s, { visible: i }), n.update((e) => (e.datasetIndex === t ? o : void 0)));
        }
        hide(t, e) {
    ...
    function po(t, e, i, n) {
        ...
        const {
            ...
            let e, i, n, o, s;
            return (
                t.horizontal ? ((e = t.base > t.x), (i = "left"), (n = "right")) : ((e = t.base < t.y), (i = "bottom"), (n = "top")),
        ...
        "middle" === o &&
            ...
            (i._top || 0) === n ? (o = c) : (i._bottom || 0) === n ? (o = h) : ((s[mo(h, a, r, l)] = !0), (o = c))),
            (s[mo(o, a, r, l)] = !0),
            (t.borderSkipped = s);
    }
    function mo(t, e, i, n) {
    ...
    class bo extends wn {
        ...
        _calculateBarValuePixels(t) {
            ...
            g !== u && ((f = g - u), (g = u)),
                c && ((u = l.barStart), (g = l.barEnd - l.barStart), 0 !== u && Dt(u) !== Dt(l.barEnd) && (f = 0), (f += u));
            const p = $(o) || c ? f : o;
    ...
    class yo extends wn {
        ...
        _circumference(t, e) {
            ...
            return (e && n.animation.animateRotate) || !this.chart.getDataVisibility(t) || null === o._parsed[t] || o.data[t].hidden
                ? 0
        ...
        Vo && 1 === e.segments.length
            ...
            : (function (t, e, i, n) {
                  const { segments: o, options: s } = e,
                      a = Bo(e);
                  for (const r of o)
                      Ro(t, s, r.style), t.beginPath(), a(t, e, r, { start: i, end: i + n - 1 }) && t.closePath(), t.stroke();
              })(t, e, i, n);
    }
    class No extends Mn {
        constructor(t) {
        ...
        draw(t, e, i, n) {
            ...
            (o.points || []).length &&
                s.borderWidth &&
                (t.save(), Wo(t, o, i, n), t.restore(), o.animated && ((o._pointsUpdated = !1), (o._path = void 0)));
        }
    }
    function Ho(t, e, i, n) {
        const o = t.options,
    ...
    class jo extends Mn {
        ...
        draw(t, e) {
            ...
            i.skip ||
                n.radius < 0.1 ||
                !Gt(i, e, i.size(n) / 2) ||
                ((t.strokeStyle = n.borderColor), (t.lineWidth = n.borderWidth), (t.fillStyle = n.backgroundColor), Kt(t, n, i.x, i.y));
        }
        getRange() {
    ...
    class Go extends Mn {
        ...
        draw(t) {
            ...
            t.save(),
                (n.w === i.w && n.h === i.h) ||
                    (t.beginPath(), o(t, Ko(n, a, i)), t.clip(), o(t, Ko(i, -0.33, n)), (t.fillStyle = e.borderColor), t.fill("evenodd")),
                t.beginPath(),
                o(t, Ko(i, a, n)),
    ...
    class ys extends Mn {
        ...
        adjustHitBoxes() {
            ...
            if (this.isHorizontal()) {
                ...
                for (const c of i)
                    c.col !== a && ((a = c.col), (l = o(n, t.top + e + s, t.bottom - t.columnSizes[a].height))),
                        (c.top = l),
                        (c.left += t.left + s),
    ...
    class js extends En {
        ...
        handleTickRangeOptions() {
            ...
            if (o === s) {
                let t = 1;
                (s >= Number.MAX_SAFE_INTEGER || o <= Number.MIN_SAFE_INTEGER) && (t = Math.abs(0.05 * s)), r(s + t), e || a(o - t);
            }
            (t.min = o), (t.max = s);
        }
        getTickLimit() {
        ...
        buildTicks() {
            ...
            const o = (function (t, e) {
                ...
                for (
                    m &&
                    (d && v !== s
                        ? (i.push({ value: s }), v < s && P++, At(Math.round((v + P * k) * y) / y, s, Hs(s, _, t)) && P++)
                        : v < s && P++);
                    P < M;
                    ++P
                )
