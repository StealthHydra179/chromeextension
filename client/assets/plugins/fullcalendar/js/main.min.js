...
var FullCalendar = (function (e) {
    ...
    function P(e, t, n, r, o, i, a, s) {
        ...
        if (null == e) {
            ...
            (e = o ? document.createElementNS("http://www.w3.org/2000/svg", t.type) : document.createElement(t.type, g.is && { is: g.is })),
                (i = null),
                (s = !1);
        }
    ...
    var Xn = (function () {
            ...
            return (
                ...
                (e.prototype.diffWholeYears = function (e, t) {
                    ...
                    return _e(e) === _e(t) && n.getMarkerDay(e) === n.getMarkerDay(t) && n.getMarkerMonth(e) === n.getMarkerMonth(t)
        ...
        return (
            ...
            (e.prototype.adjustActiveRange = function (e) {
                var t = this.props,
                    ...
                    s = e.end;
                return (
                    r && (Je(o) < 0 && ((a = be(a)), (a = n.add(a, o))), Je(i) > 1 && ((s = ve((s = be(s)), -1)), (s = n.add(s, i)))),
                    { start: a, end: s }
                );
            }),
                ...
                if (m && m !== y)
                    for (var E in (m.timeZone !== y.timeZone &&
                        ((d.eventSources = v.eventSources =
                            ((a = v.eventSources), (s = d.dateProfile), (l = v), (u = s ? s.activeRange : null), xo(a, Io(a, l), u, l))),
        ...
        return (
            ...
            (t.prototype.renderSection = function (e, t, n) {
                return "outerContent" in e
                    ...
                    : Hr("tr", { key: e.key, className: Zi(e, this.props.liquid).join(" ") }, this.renderChunkTd(e, t, n, e.chunk));
            }),
            ...
            return (
                ...
                (e.prototype.isWithinClipping = function (e, t) {
                    for (var n, r, o = { left: e, top: t }, i = 0, a = this.scrollCaches; i < a.length; i++) {
                        var s = a[i];
                        if (((n = s.getEventTarget()), (r = void 0), "HTML" !== (r = n.tagName) && "BODY" !== r && !ir(o, s.clientRect)))
                            return !1;
                    }
                    return !0;
                }),
    ...
    var Us = (function (e) {
            ...
            return (
                ...
                (t.prototype.computeFgSegPositionCss = function (e) {
                    ...
                    return (
                        a && e.forwardPressure && (u[i ? "marginLeft" : "marginRight"] = 20), r(r({}, u), this.computeSegTopBottomCss(e))
                    );
                }),
