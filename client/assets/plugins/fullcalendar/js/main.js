...
const FullCalendar = (function (exports) {
  ...
  function h (n, l, u) {
    ...
    if ((u != null && (r.children = u), typeof n === 'function' && n.defaultProps != null)) { for (i in n.defaultProps) void 0 === r[i] && (r[i] = n.defaultProps[i]) }
      ...
      n.some(function (n) {
        ...
        n.__d &&
                        ...
                        (f = l.__P) &&
                            ((u = []),
                            ((i = a({}, r)).__v = i),
                            (t = A(f, r, i, l.__n, void 0 !== f.ownerSVGElement, null, u, o == null ? w(r) : o)),
                            T(u, r),
                            t != o && k(r)))
      })
    }
  ...
  function b (n, l, u, i, t, r, o, f, s) {
    ...
    if (
      ...
      (l.__k = x(l.__k, function (u) {
        if (u != null) {
          if (((u.__ = l), (u.__b = l.__b + 1), (p = g[a]) === null || (p && u.key == p.key && u.type === p.type))) g[a] = void 0
          else {
            for (h = 0; h < _; h++) {
          ...
          if (
            ...
            let c
            if ((m == null && (m = y), void 0 !== u.__d)) (c = u.__d), (u.__d = void 0)
            else if (r == p || y != f || y.parentNode == null) {
              n: if (f == null || f.parentNode !== n) n.appendChild(y), (c = null)
              else {
            ...
            (f = void 0 !== c ? c : y.nextSibling), typeof l.type === 'function' && (l.__d = f)
  ...
  function x (n, l, u) {
    if ((u == null && (u = []), n == null || typeof n === 'boolean')) l && u.push(l(null))
    else if (Array.isArray(n)) for (let i = 0; i < n.length; i++) x(n[i], l, u)
    else {
      u.push(
        l
          ? l(
  ...
  function C (n, l, u) {
    l[0] === '-' ? n.setProperty(l, u) : (n[l] = typeof u === 'number' && !1 === s.test(l) ? u + 'px' : u == null ? '' : u)
  }

  function N (n, l, u, i, t) {
    let r, o, f, e, c
    if ((t ? l === 'className' && (l = 'class') : l === 'class' && (l = 'className'), l === 'style')) {
      ...
      l[0] === 'o' && l[1] === 'n'
        ...
        : l !== 'list' && l !== 'tagName' && l !== 'form' && l !== 'type' && l !== 'size' && !t && l in n
          ? (n[l] = u == null ? '' : u)
          : typeof u !== 'function' &&
    ...
    try {
      n: if (typeof P === 'function') {
        if (
          ...
          P.getDerivedStateFromProps == null && v.componentWillMount != null && v.componentWillMount(),
          ...
          if (
            ...
            (!v.__e && v.shouldComponentUpdate != null && !1 === v.shouldComponentUpdate(g, v.__s, x)) ||
                            (u.__v === i.__v && !v.__))
          ) {
            for (
              v.props = g,
        ...
        (u.__k = s != null && s.type == d && s.key == null ? s.props.children : Array.isArray(s) ? s : [s]),
        v.getChildContext != null && (t = a(a({}, t), v.getChildContext())),
        h || v.getSnapshotBeforeUpdate == null || (w = v.getSnapshotBeforeUpdate(p, y)),
        b(l, u, i, t, r, o, f, e, c),
        (v.base = u.__e),
        v.__h.length && f.push(v),
        k && (v.__E = v.__ = null),
        (v.__e = !1)
      } else o == null && u.__v === i.__v ? ((u.__k = i.__k), (u.__e = i.__e)) : (u.__e = $(i.__e, u, i, t, r, o, f, c));
      (s = n.diffed) && s(u)
    } catch (l) {
  ...
  function $ (n, l, u, i, t, r, o, f) {
    ...
    if (((t = l.type === 'svg' || t), r != null)) {
      for (s = 0; s < r.length; s++) {
        if ((a = r[s]) != null && ((l.type === null ? a.nodeType === 3 : a.localName === l.type) || n == a)) {
          (n = a), (r[s] = null)
          break
        }
      }
    ...
    if (n == null) {
      ...
      (n = t ? document.createElementNS('http://www.w3.org/2000/svg', l.type) : document.createElement(l.type, d.is && { is: d.is })),
      (r = null),
      (f = !1)
    }
    if (l.type === null) y !== d && n.data != d && (n.data = d)
      ...
      P(n, d, y, t, f),
      h ? (l.__k = []) : ((l.__k = l.props.children), b(n, l, u, i, l.type !== 'foreignObject' && t, r, o, e, f)),
      f ||
  ...
  function sliceEventStore (eventStore, eventUiBases, framingRange, nextDayThreshold) {
    ...
    for (const instanceId in eventStore.instances) {
      ...
      const normalRange = !def.allDay && nextDayThreshold ? computeVisibleDayRange(origRange, nextDayThreshold) : origRange
  ...
  function buildViewSpec (viewDef, overrideConfigs, optionOverrides, dynamicOptionOverrides, localeDefaults) {
    const durationInput =
            viewDef.overrides.duration || viewDef.defaults.duration || dynamicOptionOverrides.duration || optionOverrides.duration
    let duration = null
    let durationUnit = ''
    let singleUnit = ''
    ...
    return {
      ...
      buttonTextDefault:
                queryButtonText(localeDefaults) || viewDef.defaults.buttonText || queryButtonText(BASE_OPTION_DEFAULTS) || viewDef.type // fall back to given view name
    }
  }
  ...
  const DateProfileGenerator = /** @class */ (function () {
    ...
    DateProfileGenerator.prototype.buildValidRange = function () {
      ...
      const simpleInput = typeof input === 'function' ? input.call(this.props.calendarApi, this.nowDate) : input
    ...
    DateProfileGenerator.prototype.buildCustomVisibleRange = function (date) {
      ...
      const simpleInput = typeof input === 'function' ? input.call(props.calendarApi, props.dateEnv.toDate(date)) : input
  ...
  function handleDateProfile (dateProfile, context) {
    context.emitter.trigger(
      'datesSet',
      __assign(__assign({}, buildRangeApiWithTimeZone(dateProfile.activeRange, context.dateEnv)), { view: context.viewApi })
    )
  }
  ...
  const CalendarDataManager = /** @class */ (function () {
    ...
    CalendarDataManager.prototype._computeOptionsData = function (optionOverrides, dynamicOptionOverrides, calendarApi) {
      ...
      const _a = this.processRawCalendarOptions(optionOverrides, dynamicOptionOverrides)
    ...
    CalendarDataManager.prototype.processRawCalendarOptions = function (optionOverrides, dynamicOptionOverrides) {
      const _a = mergeRawOptions([BASE_OPTION_DEFAULTS, optionOverrides, dynamicOptionOverrides])
      ...
      const extra = {}
      const raw = mergeRawOptions([BASE_OPTION_DEFAULTS, localeDefaults, optionOverrides, dynamicOptionOverrides])
      const refined = {}
  ...
  function sliceEvents (props, allDay) {
    return sliceEventStore(props.eventStore, props.eventUiBases, props.dateProfile.activeRange, allDay ? props.nextDayThreshold : null)
      .fg
  }
  ...
  const Toolbar = /** @class */ (function (_super) {
    ...
    Toolbar.prototype.render = function () {
      ...
      const classNames = [extraClassName || '', 'fc-toolbar', forceLtr ? 'fc-toolbar-ltr' : '']
      return createElement(
        'div',
  ...
  const CalendarContent = /** @class */ (function (_super) {
    ...
    CalendarContent.prototype._handleNavLinkClick = function (ev, anchorEl) {
      ...
      const customAction = viewType === 'day' ? options.navLinkDayClick : viewType === 'week' ? options.navLinkWeekClick : null
    ...
    CalendarContent.prototype.buildAppendContent = function () {
      const props = this.props
      const children = props.pluginHooks.viewContainerAppends.map(function (buildAppendContent) {
  ...
  const TableDateCell = /** @class */ (function (_super) {
    ...
    TableDateCell.prototype.render = function () {
      ...
      const navLinkAttrs =
                options.navLinks && !dayMeta.isDisabled && props.colCnt > 1 ? { 'data-navlink': buildNavLinkData(date), tabIndex: 0 } : {}
  ...
  const SimpleScrollGrid = /** @class */ (function (_super) {
    ...
    SimpleScrollGrid.prototype.renderChunkTd = function (sectionConfig, sectionI, microColGroupNode, chunkConfig) {
      ...
      const overflowY = !props.liquid ? 'visible' : forceYScrollbars ? 'scroll' : !needsYScrolling ? 'hidden' : 'auto'
      ...
      _this.handleDragEnd = function (ev) {
        ...
        if (!pointer.wasTouchScroll) {
          ...
          if (initialHit && finalHit && isHitsEqual(initialHit, finalHit)) {
            const context = component.context
            const arg = __assign(__assign({}, buildDatePointApiWithContext(initialHit.dateSpan, context)), {
  ...
  const DateSelecting = /** @class */ (function (_super) {
    ...
    function DateSelecting (settings) {
      ...
      _this.handlePointerDown = function (ev) {
        ...
        const canSelect = options.selectable && component.isValidDateDownEl(ev.origEvent.target)
  ...
  function joinHitsIntoSelection (hit0, hit1, dateSelectionTransformers) {
    ...
    const ms = [dateSpan0.range.start, dateSpan0.range.end, dateSpan1.range.start, dateSpan1.range.end]
  ...
  const EventDragging = /** @class */ (function (_super) {
    ...
    function EventDragging (settings) {
      ...
      _this.handlePointerDown = function (ev) {
        ...
        const isValid = component.isValidSegDownEl(origTarget) && !elementClosest(origTarget, '.fc-event-resizer') // NOT on a resizer
        ...
        if (_this.isDragging) {
          ...
          if (validMutation) {
            ...
            if (receivingContext_1 === initialContext_1) {
              ...
              const transformed = {}
              for (
                let _i = 0, _b = initialContext_1.getCurrentData().pluginHooks.eventDropTransformers;
                _i < _b.length;
                _i++
              ) {
  ...
  function computeEventForDateSpan (dateSpan, dragMeta, context) {
    ...
    const end = dragMeta.duration ? context.dateEnv.add(start, dragMeta.duration) : getDefaultEventEnd(dateSpan.allDay, start, context)
  ...
  const InferredElementDragging = /** @class */ (function (_super) {
    ...
    InferredElementDragging.prototype.setMirrorIsVisible = function (bool) {
      if (bool) {
        ...
        const mirrorEl = this.mirrorSelector ? document.querySelector(this.mirrorSelector) : null
        if (mirrorEl) {
  ...
  const TableCell = /** @class */ (function (_super) {
    ...
    TableCell.prototype.render = function () {
      ...
      const navLinkAttrs = options.navLinks ? { 'data-navlink': buildNavLinkData(date, 'week'), tabIndex: 0 } : {}
      return createElement(
        DayCellRoot,
        {
          date,
  ...
  var TableCellTop = /** @class */ (function (_super) {
    ...
    TableCellTop.prototype.render = function () {
      const props = this.props
      const navLinkAttrs = this.context.options.navLinks ? { 'data-navlink': buildNavLinkData(props.date), tabIndex: 0 } : {}
      return createElement(
        DayCellContent,
        {
          date: props.date,
  ...
  const Popover = /** @class */ (function (_super) {
    ...
    Popover.prototype.render = function () {
      const theme = this.context.theme
      const props = this.props
      const classNames = ['fc-popover', theme.getClass('popover')].concat(props.extraClassNames || [])
      return createElement(
        'div',
    ...
    TimeColsSlatsBody.prototype.render = function () {
      ...
      return createElement(
        ...
        props.slatMetas.map(function (slatMeta, i) {
          ...
          const classNames = ['fc-timegrid-slot', 'fc-timegrid-slot-lane', slatMeta.isLabeled ? '' : 'fc-timegrid-slot-minor']
          return createElement(
            'tr',
            ...
            content: function (arg) {
              ...
              return createElement(
                ...
                createElement(
                  ...
                  arg.tableColGroupNode,
                  createElement('tbody', null, createElement(TimeBodyAxis, { slatMetas }))
                ),
                createElement(
                  'div',
                  { className: 'fc-timegrid-now-indicator-container' },
                  createElement(NowTimer, { unit: isNowIndicator ? 'minute' : 'day' /* hacky */ }, function (nowDate) {
                    const nowIndicatorTop = isNowIndicator && slatCoords && slatCoords.safeComputeTop(nowDate) // might return void
  ...
  const TimeColsContent = /** @class */ (function (_super) {
    ...
    TimeColsContent.prototype.render = function () {
      ...
      const props = _a.props
      const context = _a.context
      const nowIndicatorTop = context.options.nowIndicator && props.slatCoords && props.slatCoords.safeComputeTop(props.nowDate) // might return void
      const colCnt = props.cells.length
  ...
  const TimeCols = /** @class */ (function (_super) {
    ...
    TimeCols.prototype.positionToHit = function (positionLeft, positionTop) {
      ...
      const _b = this.processSlotOptions(this.props.slotDuration, options.snapDuration)
              ...
              innerNodes.push(
                createElement(
                  ...
                  __assign(
                    {
                      key:
                                                dayStr + ':' + seg.eventRange.instance.instanceId /* are multiple segs for an instanceId */,
                      seg,
                      isDragging: false,
                      isResizing: false,
                      isDateSelecting: false,
