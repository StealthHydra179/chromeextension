    ...
    var myChart = new Chart(ctx, {
        type: 'line', data: {
            ...
            maintainAspectRatio: false, legend: {
                ...
                xAxes: [{
                    ticks: {
                        beginAtZero: true, fontColor: '#585757'
                    }, gridLines: {
                        display: true, color: "rgba(0, 0, 0, 0.07)"
                    },
                }], yAxes: [{
                    ticks: {
                        beginAtZero: true, fontColor: '#585757'
...
// chart 2
    ...
    var myChart = new Chart(ctx, {
        type: 'doughnut', data: {
            labels: ["Jeans", "T-Shirts", "Shoes", "Lingerie"], datasets: [{
...
// chart3
    ...
    var myChart = new Chart(ctx, {
        type: 'line', data: {
            labels: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'], datasets: [{
                ...
                fill: {
                    target: 'origin', above: 'rgb(20 201 32 / 15%)',   // Area will be red above the origin
            ...
            maintainAspectRatio: false, plugins: {
                ...
                x: {
                    stacked: false, beginAtZero: true, display: false,
                }, y: {
                    stacked: false, beginAtZero: true, display: false,
                }
            }
    ...
    $('#chart4').sparkline([5, 8, 7, 10, 9, 10, 8, 6, 4, 6, 8, 7, 6, 8, 9, 10, 8, 6, 4, 5, 8, 7, 10, 9, 5, 8, 7, 9, 5, 4], {
        type: 'bar', height: '30', barWidth: '2', resize: true, barSpacing: '3', barColor: '#008cff'
    });


    $('#chart5').sparkline([5, 8, 7, 10, 9, 10, 8, 6, 4, 6, 8, 7, 6, 8, 9, 10, 8, 6, 4, 5, 8, 7, 10, 9, 5, 8, 7, 9, 5, 4], {
        type: 'bar', height: '30', barWidth: '2', resize: true, barSpacing: '3', barColor: '#fd3550'
    });


    $('#chart6').sparkline([5, 8, 7, 10, 9, 10, 8, 6, 4, 6, 8, 7, 6, 8, 9, 10, 8, 6, 4, 5, 8, 7, 10, 9, 5, 8, 7, 9, 5, 4], {
        type: 'bar', height: '30', barWidth: '2', resize: true, barSpacing: '3', barColor: '#009688'
    });

    $('#chart7').sparkline([5, 8, 7, 10, 9, 10, 8, 6, 4, 6, 8, 7, 6, 8, 9, 10, 8, 6, 4, 5, 8, 7, 10, 9, 5, 8, 7, 9, 5, 4], {
        type: 'bar', height: '30', barWidth: '2', resize: true, barSpacing: '3', barColor: '#ffc107'
    });
...
// worl map
    ...
    jQuery('#geographic-map-2').vectorMap({
        ...
        markerStyle: {
            initial: {
                r: 9, 'fill': '#fff', 'fill-opacity': 1, 'stroke': '#000', 'stroke-width': 5, 'stroke-opacity': 0.4
            },
        },
        enableZoom: true,
        hoverColor: '#009efb',
        markers: [{
            latLng: [21.00, 78.00], name: 'Lorem Ipsum Dollar'
