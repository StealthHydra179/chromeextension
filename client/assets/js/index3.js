$(function () {
  ...
  const gradientStroke9 = ctx.createLinearGradient(0, 0, 0, 300)
  gradientStroke9.addColorStop(0, '#4776e6')
  gradientStroke9.addColorStop(1, '#8e54e9')

  const gradientStroke10 = ctx.createLinearGradient(0, 0, 0, 300)
  ...
  const gradientStroke11 = ctx.createLinearGradient(0, 0, 0, 300)
  gradientStroke11.addColorStop(0, '#ba8b02')
  gradientStroke11.addColorStop(1, '#181818')

  const gradientStroke12 = ctx.createLinearGradient(0, 0, 0, 300)
  gradientStroke12.addColorStop(0, '#2c3e50')
  gradientStroke12.addColorStop(1, '#fd746c')

  const gradientStroke13 = ctx.createLinearGradient(0, 0, 0, 300)
